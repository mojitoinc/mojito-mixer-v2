  ...
  return (
    <Box margin="8px 0px">
      ...
      >
        ...
        >
          <img src={Icons.gpay} width={"50px"} height={"20px"} />
        </Button>
        <Button
          backgroundColor={theme.global?.black}
          sx={{
        ...
        >
          <img src={Icons.applepay} width={"50px"} height={"20px"} />
        </Button>
        <Button
          ...
          title={'Walletconnect'}
        >
          <img src={Icons.walletConnect} width={"16px"} height={"16px"} 
            style={{
              marginRight:'8px'
            }}
          />
        ...
        <Button
          ...
          title={'Metamask'}
        >
          <img src={Icons.metamask} width={"16px"} height={"16px"} 
            style={{
              marginRight:'8px'
            }}
          />
