    ...
    <Card sx={{ padding: 2, marginTop: 2, border: `1px solid ${ isSelected === name ? theme.global?.highlightedText : theme.global?.cardBorder }` }}>
      <Box display="flex" alignItems="center" justifyContent="space-between">
        <Box display="flex" alignItems="center">
          ...
          { !isCreditCard && <Box sx={{ border: `1px solid ${ theme.global?.cardBorder }` }} width="48px" height="24px" display="flex" justifyContent="center"><img src={ logo ?? Icons.item } width={ 32 } /></Box> }
