...
export const CreditCardForm =  ()=> {
    ...
    return (<>
        { isNewCard && <Box display={'flex'} justifyContent={'space-between'}>
            <TextInput
                value={ '' }
                onChange={ ()=> undefined }
                title="First name"
        ...
        <Typography variant="body2" sx={{
            ...
            borderRadius: '4px'
        }}>NFTs purchased by credit card can only be transferred to your multi-sig wallet and cannot be transferred out for 14 days.</Typography>
        {
          isNewCard &&
