...
import { BillingFormData, ShowPaymentMethods } from '../../providers';
...
interface PaymentContainerProps {
  ...
  showPaymentMethods: ShowPaymentMethods | undefined;
}
  ...
  return (
    <>
      ...
      <Card
        ...
        { config?.creditCard && showPaymentMethods?.showCreditCard && (
          <PaymentMethodView
        ...
        { config?.wire && showPaymentMethods?.showWire && (
          <PaymentMethodView
