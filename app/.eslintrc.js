...
module.exports = {
  root: true,
  extends: ["airbnb", "airbnb/hooks", "plugin:import/typescript", "plugin:@typescript-eslint/recommended", "plugin:@next/next/recommended", "plugin:storybook/recommended"],
  ...
  rules: {
    ...
    "import/no-extraneous-dependencies": ["error", {
      devDependencies: ["**/*.test.ts", "**/*.test.tsx", "jest.setup.ts", "jest.config.js", "**/*.stories.*",]
    }],
