...
const useCreatePayment = (paymentInfo, orgId) => {
    ...
    const { successURL, errorURL } = CheckoutProvider.useCheckout();
    const [getInvoiceDetails] = useLazyQuery.useLazyQuery(invoiceDetails.invoiceDetailsQuery);
    const [onCompleteChain] = useMutation.useMutation(Payment.completeOnChainPaymentQuery);
    ...
    const makeCoinbasePurchase = React.useCallback((options) => tslib_es6.__awaiter(void 0, void 0, void 0, function* () {
    ...
    const makeOnChainPurchase = React.useCallback((options) => tslib_es6.__awaiter(void 0, void 0, void 0, function* () {
    ...
    const completeOnChainPayment = React.useCallback((options, receipt, txHash = '') => tslib_es6.__awaiter(void 0, void 0, void 0, function* () {
