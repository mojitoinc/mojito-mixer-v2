...
var CardContent = require('../../../node_modules/@mui/material/CardContent/CardContent.js');
...
const PaymentMethodView = ({ isSelected = '', name, logo, bodyContent, onChoosePaymentType, type, }) => {
    ...
    return (React__default["default"].createElement(Card["default"], { sx: {
            padding: 2,
            marginTop: 2,
            border: `1px solid ${isSelected === type
                ? (_a = theme.global) === null || _a === void 0 ? void 0 : _a.highlightedText
                : (_b = theme.global) === null || _b === void 0 ? void 0 : _b.cardBorder}`,
        } },
...
//# sourceMappingURL=PaymentMethodView.js.map
