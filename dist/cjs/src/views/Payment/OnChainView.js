...
const OnChainView = ({ values, setFieldValue, errors }) => {
    ...
    const onClickMetaMask = React.useCallback(() => tslib_es6.__awaiter(void 0, void 0, void 0, function* () {
        yield onDisconnect();
        yield onWalletConnect();
    }), [onDisconnect, onWalletConnect]);
    const theme = useTheme["default"]();
    return (React__default["default"].createElement(React__default["default"].Fragment, null, !(values === null || values === void 0 ? void 0 : values.walletAddress) ? (React__default["default"].createElement(Box["default"], { display: "flex", flexDirection: "column" },
        React__default["default"].createElement(Button["default"], { backgroundColor: (_a = theme.global) === null || _a === void 0 ? void 0 : _a.black, onClick: onClickMetaMask, sx: {
                width: { xs: '100%', md: '180px' },
                margin: '16px 0px',
                border: `1px solid ${(_b = theme.global) === null || _b === void 0 ? void 0 : _b.black}`,
                alignSelf: 'center',
            }, title: "Walletconnect" },
            React__default["default"].createElement("img", { src: index.Icons.walletConnect, alt: "wallet connect", style: {
                    width: '20px',
                    height: '20px',
                    marginRight: '8px',
                } })),
        (errors === null || errors === void 0 ? void 0 : errors.walletAddress) &&
            React__default["default"].createElement(FormHelperText["default"], { error: true }, errors === null || errors === void 0 ? void 0 : errors.walletAddress))) : (React__default["default"].createElement(React__default["default"].Fragment, null,
        React__default["default"].createElement(Box["default"], { display: "flex", flexDirection: "row", alignItems: "center", justifyContent: "space-between", border: `1px solid ${(_c = theme.global) === null || _c === void 0 ? void 0 : _c.cardBorder}`, padding: "16px", sx: {
                background: (_d = theme.global) === null || _d === void 0 ? void 0 : _d.background,
                margin: '16px 0px',
            } },
            React__default["default"].createElement(Box["default"], { display: "flex", flexDirection: "row", alignItems: "center" },
                React__default["default"].createElement("img", { src: index.Icons.walletAddress, alt: "wallet address" }),
                React__default["default"].createElement(Typography["default"], { fontSize: "16px", marginLeft: "12px", width: "150px", sx: {
                        overflow: 'hidden',
                        textOverflow: 'ellipsis',
                    } }, values === null || values === void 0 ? void 0 : values.walletAddress),
                React__default["default"].createElement(CopyButton["default"], { copyValue: values === null || values === void 0 ? void 0 : values.walletAddress, sx: {
                        alignSelf: 'center',
                    } })),
            React__default["default"].createElement(Button["default"], { title: "Change", textColor: (_e = theme.global) === null || _e === void 0 ? void 0 : _e.highlightedText, backgroundColor: (_f = theme.global) === null || _f === void 0 ? void 0 : _f.white, variant: "outlined", sx: {
                    justifySelf: 'flex-end',
                }, onClick: onClickMetaMask })),
        React__default["default"].createElement(Typography["default"], { fontSize: 16 }, "NFT will be delivered to same address")))));
};

exports["default"] = OnChainView;
//# sourceMappingURL=OnChainView.js.map
