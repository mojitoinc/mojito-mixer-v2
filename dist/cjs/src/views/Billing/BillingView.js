...
const BillingView = ({ isEditing, onClickEdit, onClickContinue, pincodeError, billingInfo, paymentItem, onChangeValues, }) => {
    ...
    const { user } = auth0React_esm.useAuth0();
    ...
    return (React__default["default"].createElement(Box["default"], { width: "100%" },
        !((_1 = uiConfiguration === null || uiConfiguration === void 0 ? void 0 : uiConfiguration.billing) === null || _1 === void 0 ? void 0 : _1.isEnableExpressCheckout) && (React__default["default"].createElement(ExpressCheckout["default"], { config: uiConfiguration === null || uiConfiguration === void 0 ? void 0 : uiConfiguration.billing })),
        React__default["default"].createElement(Card["default"], { sx: {
            ...
            React__default["default"].createElement(Typography["default"], { color: (_6 = (_5 = theme.palette) === null || _5 === void 0 ? void 0 : _5.text) === null || _6 === void 0 ? void 0 : _6.primary, fontWeight: "500", fontSize: "20px" }, "Contact info"),
        ...
        React__default["default"].createElement(Box["default"], { display: "flex", justifyContent: "flex-end" },
            React__default["default"].createElement(Button["default"], { title: "Continue to Payment", backgroundColor: (_8 = (_7 = theme.global) === null || _7 === void 0 ? void 0 : _7.checkout) === null || _8 === void 0 ? void 0 : _8.continueButtonBackground, textColor: (_10 = (_9 = theme.global) === null || _9 === void 0 ? void 0 : _9.checkout) === null || _10 === void 0 ? void 0 : _10.continueButtonTextColor, onClick: handleSubmit, sx: {
                    margin: '24px 0px',
                    '&: hover': {
