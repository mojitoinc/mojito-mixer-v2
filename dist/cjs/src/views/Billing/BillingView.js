...
var UserInfoProvider = require('../../providers/UserInfoProvider.js');
...
const schema = object.create().shape({
    ...
    phoneNumber: string.create().matches(/^\+[1-9]{1}[0-9]{3,14}$/, 'Invalid mobile number').required('Please enter a mobile number'),
...
const BillingView = ({ isEditing, onClickEdit, onClickContinue, pincodeError, billingInfo, paymentItem, onChangeValues, }) => {
    ...
    const { email } = UserInfoProvider.useUserInfo();
    const { values, errors, handleChange: onChange, isValid, handleSubmit, setFieldValue } = formik_esm.useFormik({
        initialValues: {
            email,
    ...
    return (React__default["default"].createElement(Box["default"], { width: "100%" },
        !((_y = uiConfiguration === null || uiConfiguration === void 0 ? void 0 : uiConfiguration.billing) === null || _y === void 0 ? void 0 : _y.isEnableExpressCheckout) && (React__default["default"].createElement(ExpressCheckout["default"], { config: uiConfiguration === null || uiConfiguration === void 0 ? void 0 : uiConfiguration.billing })),
        React__default["default"].createElement(Card["default"], { sx: {
            ...
            React__default["default"].createElement(Typography["default"], { color: (_3 = (_2 = theme.palette) === null || _2 === void 0 ? void 0 : _2.text) === null || _3 === void 0 ? void 0 : _3.primary, fontWeight: "500", fontSize: "20px" }, "Contact info"),
            React__default["default"].createElement(TextInput["default"], { value: values === null || values === void 0 ? void 0 : values.email, onChange: onChange('email'), error: errors === null || errors === void 0 ? void 0 : errors.email, placeholder: "Email", inputProps: {
                    readOnly: true,
                }, disabled: true, sx: {
                    marginTop: '16px',
                } })),
        isEditing ? (React__default["default"].createElement(BillingForm["default"], { values: values, setFieldValue: setFieldValue, errors: errors, onChange: onChange, isValid: isValidBillingForm })) : (React__default["default"].createElement(BillingDetails["default"], { values: values, onClickEdit: onClickEdit })),
        React__default["default"].createElement(Box["default"], { display: "flex", justifyContent: "flex-end" },
            React__default["default"].createElement(Button["default"], { title: "Continue to Payment", backgroundColor: (_5 = (_4 = theme.global) === null || _4 === void 0 ? void 0 : _4.checkout) === null || _5 === void 0 ? void 0 : _5.continueButtonBackground, textColor: (_7 = (_6 = theme.global) === null || _6 === void 0 ? void 0 : _6.checkout) === null || _7 === void 0 ? void 0 : _7.continueButtonTextColor, onClick: handleSubmit, sx: {
                    margin: '24px 0px',
                    '&: hover': {
