...
const BillingDetails = ({ values, onClickEdit }) => {
    ...
    return (React__default["default"].createElement(Card["default"], { sx: {
        ...
        React__default["default"].createElement(Box["default"], { padding: "14px", display: "flex", flexDirection: "row", justifyContent: "space-between", alignItems: "center" },
            React__default["default"].createElement(Box["default"], null,
                ...
                React__default["default"].createElement(Typography["default"], { color: (_g = (_f = theme.palette) === null || _f === void 0 ? void 0 : _f.text) === null || _g === void 0 ? void 0 : _g.primary, fontWeight: "500", fontSize: "16px", marginTop: "16px" },
                    ...
                    React__default["default"].createElement("br", null), values === null || values === void 0 ? void 0 :
                    values.street1,
                    React__default["default"].createElement("br", null), values === null || values === void 0 ? void 0 :
                    values.phoneNumber)),
            React__default["default"].createElement(Box["default"], { padding: "5px", sx: {
                    cursor: 'pointer',
                }, onClick: onClickEdit },
                React__default["default"].createElement(Typography["default"], { color: (_h = theme.global) === null || _h === void 0 ? void 0 : _h.linksText, fontWeight: "700" }, "Edit")))));
};

exports["default"] = BillingDetails;
