...
const Delivery = ({ onWalletChange, walletOptions, selectedDeliveryAddress, onClickConfirmPurchase, organizationName, billingInfo, paymentInfo, onClickConnectWallet, onDisconnect, error, isLoading, connectedWalletAddress, }) => {
    ...
    const showMultiSig = React.useMemo(() => {
        if ((paymentInfo === null || paymentInfo === void 0 ? void 0 : paymentInfo.paymentType) === index.PaymentTypes.CREDIT_CARD)
            return delivery.creditCard.enableMultiSig;
        if ((paymentInfo === null || paymentInfo === void 0 ? void 0 : paymentInfo.paymentType) === index.PaymentTypes.WIRE_TRANSFER)
            return delivery.wire.enableMultiSig;
        if ((paymentInfo === null || paymentInfo === void 0 ? void 0 : paymentInfo.paymentType) === index.PaymentTypes.COIN_BASE)
            return delivery.coinbase.enableMultiSig;
        if ((paymentInfo === null || paymentInfo === void 0 ? void 0 : paymentInfo.paymentType) === index.PaymentTypes.GOOGLE_PAY)
            return delivery.gpay.enableMultiSig;
        if ((paymentInfo === null || paymentInfo === void 0 ? void 0 : paymentInfo.paymentType) === index.PaymentTypes.APPLE_PAY)
            return delivery.applepay.enableMultiSig;
        if ((paymentInfo === null || paymentInfo === void 0 ? void 0 : paymentInfo.paymentType) === index.PaymentTypes.WALLET_CONNECT)
            return delivery.walletConnect.enableMultiSig;
        return true;
    }, [delivery, paymentInfo]);
    const showConnectWallet = React.useMemo(() => {
        if ((paymentInfo === null || paymentInfo === void 0 ? void 0 : paymentInfo.paymentType) === index.PaymentTypes.CREDIT_CARD)
            return delivery.creditCard.enableConnectWallet;
        if ((paymentInfo === null || paymentInfo === void 0 ? void 0 : paymentInfo.paymentType) === index.PaymentTypes.WIRE_TRANSFER)
            return delivery.wire.enableConnectWallet;
        if ((paymentInfo === null || paymentInfo === void 0 ? void 0 : paymentInfo.paymentType) === index.PaymentTypes.COIN_BASE)
            return delivery.coinbase.enableConnectWallet;
        if ((paymentInfo === null || paymentInfo === void 0 ? void 0 : paymentInfo.paymentType) === index.PaymentTypes.GOOGLE_PAY)
            return delivery.gpay.enableConnectWallet;
        if ((paymentInfo === null || paymentInfo === void 0 ? void 0 : paymentInfo.paymentType) === index.PaymentTypes.APPLE_PAY)
            return delivery.applepay.enableConnectWallet;
        if ((paymentInfo === null || paymentInfo === void 0 ? void 0 : paymentInfo.paymentType) === index.PaymentTypes.WALLET_CONNECT)
            return delivery.walletConnect.enableConnectWallet;
        return false;
    }, [delivery, paymentInfo]);
    return (React__default["default"].createElement(React__default["default"].Fragment, null,
        ...
        React__default["default"].createElement(Card["default"], { sx: {
            ...
            !connectedWalletAddress ? (React__default["default"].createElement(React__default["default"].Fragment, null,
                showMultiSig && (React__default["default"].createElement(React__default["default"].Fragment, null,
                    React__default["default"].createElement(Dropdown["default"], { value: selectedDeliveryAddress, onChange: onWalletChange, placeholder: "Select Wallet Address", sx: { marginRight: '8px' }, options: walletOptions }),
                ...
                showConnectWallet && (React__default["default"].createElement(Stack["default"], { flexDirection: "row", alignItems: "flex-end", justifyContent: "flex-end" },
                ...
                React__default["default"].createElement(Box["default"], { display: "flex", flexDirection: "row", alignItems: "center" },
                    ...
                    React__default["default"].createElement(CopyButton["default"], { copyValue: connectedWalletAddress, sx: {
                            alignSelf: 'center',
                        } })),
                (paymentInfo === null || paymentInfo === void 0 ? void 0 : paymentInfo.paymentType) !== index.PaymentTypes.WALLET_CONNECT && (React__default["default"].createElement(Button["default"], { title: "Disconnect", textColor: (_j = theme.global) === null || _j === void 0 ? void 0 : _j.highlightedText, backgroundColor: (_k = theme.global) === null || _k === void 0 ? void 0 : _k.white, variant: "outlined", sx: {
        ...
        React__default["default"].createElement(Box["default"], { display: "flex", flexDirection: "row", justifyContent: "space-between" },
            ...
            React__default["default"].createElement(Button["default"], { title: "Confirm purchase", backgroundColor: (_m = (_l = theme.global) === null || _l === void 0 ? void 0 : _l.checkout) === null || _m === void 0 ? void 0 : _m.continueButtonBackground, textColor: (_p = (_o = theme.global) === null || _o === void 0 ? void 0 : _o.checkout) === null || _p === void 0 ? void 0 : _p.continueButtonTextColor, disabled: !(connectedWalletAddress || selectedDeliveryAddress), onClick: onClickConfirmPurchase, sx: {
                    '&: hover': {
