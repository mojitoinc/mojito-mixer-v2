...
var index$5 = require('./Delivery/index.js');
...
var useSardine = require('../hooks/useSardine.js');
require('../queries/invoiceDetails.js');
require('../queries/Payment.js');
var index$2 = require('./Billing/index.js');
...
const MojitoCheckoutLayout = ({ sardineEnvironment, enableSardine }) => {
    ...
    const setupSardine = useSardine.useSardine(sardineEnvironment, enableSardine);
    React.useEffect(() => {
        setupSardine();
    }, [setupSardine]);
    if (error) {
...
exports["default"] = MojitoCheckoutLayout;
