...
var MenuItem = require('../../../node_modules/@mui/material/MenuItem/MenuItem.js');
...
var Select = require('../../../node_modules/@mui/material/Select/Select.js');
...
const CreditCardDropdown = ({ value = '', title, onChange, options = [], sx, error, required, placeholder, }) => {
    ...
    const getCreditCardType = React.useCallback((item) => {
    ...
    const renderOption = React.useCallback((item) => {
        ...
        return (React__default["default"].createElement(Stack["default"], { flexDirection: "row" },
            (item === null || item === void 0 ? void 0 : item.network) && (React__default["default"].createElement("img", { src: creditCardType, width: "49px", height: "24px", alt: "Creditcard" })),
            React__default["default"].createElement(Typography["default"], { variant: "body1", sx: { marginLeft: '4px' } },
                "Card ending ",
                item.last4Digit)));
    }, [getCreditCardType]);
    return (React__default["default"].createElement(Box["default"], { sx: Object.assign({ width: '100%' }, sx) },
        ...
        React__default["default"].createElement(FormControl["default"], { fullWidth: true, sx: {
            ...
            React__default["default"].createElement(Select["default"], { value: value, displayEmpty: true, fullWidth: true, error: Boolean(error), size: "small", MenuProps: {
                ...
                options.map((item) => {
                    return (React__default["default"].createElement(MenuItem["default"], { value: item === null || item === void 0 ? void 0 : item.id, key: item === null || item === void 0 ? void 0 : item.id }, renderOption(item)));
                }),
                React__default["default"].createElement(MenuItem["default"], { value: "true" }, "Add new card info")),
            error && React__default["default"].createElement(FormHelperText["default"], { error: true }, error))));
};

exports["default"] = CreditCardDropdown;
