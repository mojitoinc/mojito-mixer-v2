...
const Stepper = ({ currentState, }) => {
    ...
    return (React__default["default"].createElement(Box["default"], { sx: {
        ...
        return (React__default["default"].createElement(Box["default"], { display: "flex", flexDirection: "row", alignItems: "center", key: item.value },
            React__default["default"].createElement(Typography["default"], { fontWeight: "700", fontSize: "12px", color: item.value === currentState
                    ? (_a = theme.global) === null || _a === void 0 ? void 0 : _a.highlightedText
                    : (_b = theme.global) === null || _b === void 0 ? void 0 : _b.unHighlightedText }, item.title),
            index$1 !== steps.length - 1 && (React__default["default"].createElement("img", { src: index.Icons.rightArrow, width: "14px", height: "14px", style: {
                    margin: '0px 10px',
                }, alt: "arrow", color: item.value === currentState
                    ? (_c = theme.global) === null || _c === void 0 ? void 0 : _c.highlightedText
                    : (_d = theme.global) === null || _d === void 0 ? void 0 : _d.unHighlightedText }))));
    })));
};
