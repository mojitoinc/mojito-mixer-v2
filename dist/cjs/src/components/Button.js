...
var Button$1 = require('../../node_modules/@mui/material/Button/Button.js');
...
const Button = ({ title, onClick, backgroundColor, textColor, sx, children, variant, disabled, }) => {
    var _a, _b, _c, _d, _e, _f;
    const theme = useTheme["default"]();
    return (React__default["default"].createElement(Button$1["default"], { title: title, autoCapitalize: "none", size: "small", disabled: disabled, variant: variant, sx: Object.assign({ backgroundColor: disabled ? (_b = (_a = theme.palette) === null || _a === void 0 ? void 0 : _a.secondary) === null || _b === void 0 ? void 0 : _b.main : backgroundColor !== null && backgroundColor !== void 0 ? backgroundColor : (_d = (_c = theme.palette) === null || _c === void 0 ? void 0 : _c.primary) === null || _d === void 0 ? void 0 : _d.main, color: textColor !== null && textColor !== void 0 ? textColor : (_f = (_e = theme.palette) === null || _e === void 0 ? void 0 : _e.secondary) === null || _f === void 0 ? void 0 : _f.main, textTransform: 'none', fontWeight: '700', fontSize: '16px', borderRadius: '4px', padding: '0px 22px', height: '40px', display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'center' }, sx), onClick: onClick },
        children,
        title));
};
