...
var TextField = require('../../node_modules/@mui/material/TextField/TextField.js');
...
const TextInput = ({ value, title, onChange, placeholder, sx, error, required, type, inputProps, }) => {
    ...
    return (React__default["default"].createElement(Box["default"], { sx: Object.assign({ width: '100%' }, sx) },
        title && (React__default["default"].createElement(Box["default"], { display: "flex", flexDirection: "row", sx: {
                marginBottom: '6px',
            } },
