...
var leaveRenders = (_leaveRenders = {}, _leaveRenders[modes.out] = function (_ref) {
  ...
  return React__default["default"].cloneElement(current, {
    ...
    onExited: callHook(current, 'onExited', function () {
      changeState(Transition.ENTERING, null);
    })
  });
  ...
  return [current, React__default["default"].cloneElement(children, {
    ...
    onEntered: callHook(children, 'onEntered', function () {
      changeState(Transition.ENTERING);
    })
  })];
}, _leaveRenders);
var enterRenders = (_enterRenders = {}, _enterRenders[modes.out] = function (_ref3) {
  ...
  return React__default["default"].cloneElement(children, {
    in: true,
    onEntered: callHook(children, 'onEntered', function () {
      changeState(Transition.ENTERED, React__default["default"].cloneElement(children, {
        in: true
      }));
    })
  });
...
var SwitchTransition = /*#__PURE__*/function (_React$Component) {
  inheritsLoose["default"](SwitchTransition, _React$Component);
  ...
  SwitchTransition.getDerivedStateFromProps = function getDerivedStateFromProps(props, state) {
    ...
    if (state.status === Transition.ENTERING && props.mode === modes.in) {
      return {
...
SwitchTransition.propTypes = process.env.NODE_ENV !== "production" ? {
   ...
   * @type {'out-in'|'in-out'}
   */
  mode: PropTypes__default["default"].oneOf([modes.in, modes.out]),

  /**
   * Any `Transition` or `CSSTransition` component.
   */
  children: PropTypes__default["default"].oneOfType([PropTypes__default["default"].element.isRequired])
} : {};
