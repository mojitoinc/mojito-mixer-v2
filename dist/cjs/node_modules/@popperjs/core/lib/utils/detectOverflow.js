...
function detectOverflow(state, options) {
  ...
  var paddingObject = mergePaddingObject["default"](typeof padding !== 'number' ? padding : expandToHashMap["default"](padding, enums.basePlacements));
  var altContext = elementContext === enums.popper ? enums.reference : enums.popper;
  var popperRect = state.rects.popper;
  var element = state.elements[altBoundary ? altContext : elementContext];
  var clippingClientRect = getClippingRect["default"](instanceOf.isElement(element) ? element : element.contextElement || getDocumentElement["default"](state.elements.popper), boundary, rootBoundary, strategy);
  var referenceClientRect = getBoundingClientRect["default"](state.elements.reference);
  var popperOffsets = computeOffsets["default"]({
    reference: referenceClientRect,
    element: popperRect,
    strategy: 'absolute',
    placement: placement
  });
  var popperClientRect = rectToClientRect["default"](Object.assign({}, popperRect, popperOffsets));
