...
var directiveLocation = require('./directiveLocation.mjs.js');
var kinds = require('./kinds.mjs.js');
var lexer = require('./lexer.mjs.js');
var source = require('./source.mjs.js');
...
class Parser {
  ...
  parseVariableDefinition() {
    return this.node(this._lexer.token, {
      ...
      defaultValue: this.expectOptionalToken(tokenKind.TokenKind.EQUALS)
  ...
  parseSelection() {
    return this.peek(tokenKind.TokenKind.SPREAD)
      ? this.parseFragment()
      : this.parseField();
  }
  /**
  ...
  parseField() {
    ...
    return this.node(start, {
      ...
      directives: this.parseDirectives(false),
      selectionSet: this.peek(tokenKind.TokenKind.BRACE_L)
  ...
  parseImplementsInterfaces() {
    return this.expectOptionalKeyword('implements')
      ? this.delimitedMany(tokenKind.TokenKind.AMP, this.parseNamedType)
      : [];
  }
  /**
   * ```
  ...
  parseUnionMemberTypes() {
    return this.expectOptionalToken(tokenKind.TokenKind.EQUALS)
      ? this.delimitedMany(tokenKind.TokenKind.PIPE, this.parseNamedType)
      : [];
  }
  /**
   * EnumTypeDefinition :
...
exports.parse = parse;
//# sourceMappingURL=parser.mjs.js.map
