...
require('../Tooltip/tooltipClasses.js');
var speedDialActionClasses = require('./speedDialActionClasses.js');
...
const useUtilityClasses = ownerState => {
  ...
  const slots = {
    ...
    staticTooltip: ['staticTooltip', `tooltipPlacement${capitalize["default"](tooltipPlacement)}`, !open && 'staticTooltipClosed'],
    staticTooltipLabel: ['staticTooltipLabel']
  };
  return composeClasses["default"](slots, speedDialActionClasses.getSpeedDialActionUtilityClass, classes);
};
const SpeedDialActionFab = styled["default"](Fab["default"], {
  ...
  '&:hover': {
    backgroundColor: theme.vars ? theme.vars.palette.SpeedDialAction.fabHoverBg : colorManipulator.emphasize(theme.palette.background.paper, 0.15)
  },
...
const SpeedDialActionStaticTooltip = styled["default"]('span', {
  name: 'MuiSpeedDialAction',
  slot: 'StaticTooltip',
  overridesResolver: (props, styles) => {
    const {
    ...
    return [styles.staticTooltip, !ownerState.open && styles.staticTooltipClosed, styles[`tooltipPlacement${capitalize["default"](ownerState.tooltipPlacement)}`]];
  }
})(({
  theme,
  ownerState
  ...
  display: 'flex',
  alignItems: 'center',
  [`& .${speedDialActionClasses["default"].staticTooltipLabel}`]: _extends["default"]({
...
const SpeedDialActionStaticTooltipLabel = styled["default"]('span', {
  name: 'MuiSpeedDialAction',
...
const SpeedDialAction = /*#__PURE__*/React__namespace.forwardRef(function SpeedDialAction(inProps, ref) {
  ...
  const fab = /*#__PURE__*/jsxRuntime.jsx(SpeedDialActionFab, _extends["default"]({
    size: "small",
    className: clsx_m.clsx(classes.fab, className),
    tabIndex: -1,
    role: "menuitem",
    ownerState: ownerState
  }, FabProps, {
    style: _extends["default"]({}, transitionStyle, FabProps.style),
    children: icon
  }));
  if (tooltipOpenProp) {
    return /*#__PURE__*/jsxRuntime.jsxs(SpeedDialActionStaticTooltip, _extends["default"]({
      id: id,
      ref: ref,
      className: classes.staticTooltip,
      ownerState: ownerState
    }, other, {
      children: [/*#__PURE__*/jsxRuntime.jsx(SpeedDialActionStaticTooltipLabel, {
  ...
  return /*#__PURE__*/jsxRuntime.jsx(Tooltip["default"], _extends["default"]({
    id: id,
    ref: ref,
    title: tooltipTitle,
...
process.env.NODE_ENV !== "production" ? SpeedDialAction.propTypes /* remove-proptypes */ = {
   ...
   */
  TooltipClasses: PropTypes__default["default"].object,
  /**
   * Make the tooltip always visible when the SpeedDial is open.
   * @default false
   */
  tooltipOpen: PropTypes__default["default"].bool,
  /**
   * Placement of the tooltip.
   * @default 'left'
   */
  tooltipPlacement: PropTypes__default["default"].oneOf(['bottom-end', 'bottom-start', 'bottom', 'left-end', 'left-start', 'left', 'right-end', 'right-start', 'right', 'top-end', 'top-start', 'top']),
  /**
   * Label to display in the tooltip.
   */
  tooltipTitle: PropTypes__default["default"].node
} : void 0;
