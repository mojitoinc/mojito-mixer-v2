...
var dividerClasses = require('../Divider/dividerClasses.js');
require('../ListItemIcon/ListItemIcon.js');
var listItemIconClasses = require('../ListItemIcon/listItemIconClasses.js');
require('../ListItemText/ListItemText.js');
var listItemTextClasses = require('../ListItemText/listItemTextClasses.js');
var menuItemClasses = require('./menuItemClasses.js');
...
const useUtilityClasses = ownerState => {
  ...
  const composedClasses = composeClasses["default"](slots, menuItemClasses.getMenuItemUtilityClass, classes);
  return _extends["default"]({}, classes, composedClasses);
};
const MenuItemRoot = styled["default"](ButtonBase["default"], {
  ...
  [`&.${menuItemClasses["default"].selected}`]: {
    ...
    [`&.${menuItemClasses["default"].focusVisible}`]: {
  ...
  [`&.${menuItemClasses["default"].selected}:hover`]: {
  ...
  [`&.${menuItemClasses["default"].disabled}`]: {
    opacity: (theme.vars || theme).palette.action.disabledOpacity
  },
  [`& + .${dividerClasses["default"].root}`]: {
    marginTop: theme.spacing(1),
    marginBottom: theme.spacing(1)
  },
  [`& + .${dividerClasses["default"].inset}`]: {
    marginLeft: 52
  },
  [`& .${listItemTextClasses["default"].root}`]: {
    marginTop: 0,
    marginBottom: 0
  },
  [`& .${listItemTextClasses["default"].inset}`]: {
    paddingLeft: 36
  },
  [`& .${listItemIconClasses["default"].root}`]: {
    minWidth: 36
  }
}, !ownerState.dense && {
...
}, ownerState.dense && _extends["default"]({
  minHeight: 32,
  // https://m2.material.io/components/menus#specs > Dense
  paddingTop: 4,
  paddingBottom: 4
}, theme.typography.body2, {
  [`& .${listItemIconClasses["default"].root} svg`]: {
    fontSize: '1.25rem'
  }
})));
const MenuItem = /*#__PURE__*/React__namespace.forwardRef(function MenuItem(inProps, ref) {
  ...
  const handleRef = useForkRef["default"](menuItemRef, ref);
  let tabIndex;
  if (!props.disabled) {
  ...
  return /*#__PURE__*/jsxRuntime.jsx(ListContext["default"].Provider, {
    value: childContext,
    children: /*#__PURE__*/jsxRuntime.jsx(MenuItemRoot, _extends["default"]({
      ref: handleRef,
      role: role,
      tabIndex: tabIndex,
      component: component,
...
process.env.NODE_ENV !== "production" ? MenuItem.propTypes /* remove-proptypes */ = {
   ...
   * @ignore
   */
  role: PropTypes__default["default"] /* @typescript-to-proptypes-ignore */.string,
  /**
   * @ignore
   */
