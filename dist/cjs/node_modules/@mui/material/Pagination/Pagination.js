...
var paginationClasses = require('./paginationClasses.js');
var usePagination = require('../usePagination/usePagination.js');
var PaginationItem = require('../PaginationItem/PaginationItem.js');
require('../PaginationItem/paginationItemClasses.js');
...
const useUtilityClasses = ownerState => {
  ...
  return composeClasses["default"](slots, paginationClasses.getPaginationUtilityClass, classes);
};
const PaginationRoot = styled["default"]('nav', {
  name: 'MuiPagination',
  slot: 'Root',
...
const PaginationUl = styled["default"]('ul', {
  name: 'MuiPagination',
  slot: 'Ul',
...
const Pagination = /*#__PURE__*/React__namespace.forwardRef(function Pagination(inProps, ref) {
  ...
  const {
      ...
      renderItem = item => /*#__PURE__*/jsxRuntime.jsx(PaginationItem["default"], _extends["default"]({}, item)),
      shape = 'circular',
  ...
  const {
    items
  } = usePagination["default"](_extends["default"]({}, props, {
  ...
  return /*#__PURE__*/jsxRuntime.jsx(PaginationRoot, _extends["default"]({
    ...
    children: /*#__PURE__*/jsxRuntime.jsx(PaginationUl, {
      ...
      children: items.map((item, index) => /*#__PURE__*/jsxRuntime.jsx("li", {
        children: renderItem(_extends["default"]({}, item, {
          color,
...
process.env.NODE_ENV !== "production" ? Pagination.propTypes /* remove-proptypes */ = {
   ...
   * @default 1
   */
  boundaryCount: integerPropType["default"],
  /**
   ...
   * @default 1
   */
  count: integerPropType["default"],
  /**
   * The page selected by default when the component is uncontrolled.
   * @default 1
   */
  defaultPage: integerPropType["default"],
  /**
   ...
   * @default false
   */
  hideNextButton: PropTypes__default["default"].bool,
  /**
   * If `true`, hide the previous-page button.
   * @default false
   */
  hidePrevButton: PropTypes__default["default"].bool,
  /**
   ...
   * @default 1
   */
  siblingCount: integerPropType["default"],
  /**
