...
var fabClasses = require('./fabClasses.js');
...
const useUtilityClasses = ownerState => {
  ...
  const slots = {
    root: ['root', variant, `size${capitalize["default"](size)}`, color === 'inherit' ? 'colorInherit' : color]
  };
  const composedClasses = composeClasses["default"](slots, fabClasses.getFabUtilityClass, classes);
  return _extends["default"]({}, classes, composedClasses);
};
const FabRoot = styled["default"](ButtonBase["default"], {
  name: 'MuiFab',
  slot: 'Root',
  ...
  overridesResolver: (props, styles) => {
    ...
    return [styles.root, styles[ownerState.variant], styles[`size${capitalize["default"](ownerState.size)}`], ownerState.color === 'inherit' && styles.colorInherit, styles[capitalize["default"](ownerState.size)], styles[ownerState.color]];
  }
})(({
  theme,
  ownerState
  ...
  return _extends["default"]({}, theme.typography.button, {
    ...
    [`&.${fabClasses["default"].focusVisible}`]: {
      boxShadow: (theme.vars || theme).shadows[6]
    }
  ...
  theme,
  ownerState
}) => _extends["default"]({}, ownerState.color !== 'inherit' && ownerState.color !== 'default' && (theme.vars || theme).palette[ownerState.color] != null && {
...
const Fab = /*#__PURE__*/React__namespace.forwardRef(function Fab(inProps, ref) {
  ...
  return /*#__PURE__*/jsxRuntime.jsx(FabRoot, _extends["default"]({
...
process.env.NODE_ENV !== "production" ? Fab.propTypes /* remove-proptypes */ = {
   ...
   * @default 'default'
   */
  color: PropTypes__default["default"] /* @typescript-to-proptypes-ignore */.oneOfType([PropTypes__default["default"].oneOf(['default', 'error', 'info', 'inherit', 'primary', 'secondary', 'success', 'warning']), PropTypes__default["default"].string]),
  /**
   ...
   * @default 'circular'
   */
  variant: PropTypes__default["default"] /* @typescript-to-proptypes-ignore */.oneOfType([PropTypes__default["default"].oneOf(['circular', 'extended']), PropTypes__default["default"].string])
} : void 0;
