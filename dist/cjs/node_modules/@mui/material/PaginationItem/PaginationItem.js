...
var paginationItemClasses = require('./paginationItemClasses.js');
...
var NavigateBefore = require('../internal/svg-icons/NavigateBefore.js');
var NavigateNext = require('../internal/svg-icons/NavigateNext.js');
...
const overridesResolver = (props, styles) => {
  ...
  return [styles.root, styles[ownerState.variant], styles[`size${capitalize["default"](ownerState.size)}`], ownerState.variant === 'text' && styles[`text${capitalize["default"](ownerState.color)}`], ownerState.variant === 'outlined' && styles[`outlined${capitalize["default"](ownerState.color)}`], ownerState.shape === 'rounded' && styles.rounded, ownerState.type === 'page' && styles.page, (ownerState.type === 'start-ellipsis' || ownerState.type === 'end-ellipsis') && styles.ellipsis, (ownerState.type === 'previous' || ownerState.type === 'next') && styles.previousNext, (ownerState.type === 'first' || ownerState.type === 'last') && styles.firstLast];
};
const useUtilityClasses = ownerState => {
  ...
  const slots = {
    root: ['root', `size${capitalize["default"](size)}`, variant, shape, color !== 'standard' && `${variant}${capitalize["default"](color)}`, disabled && 'disabled', selected && 'selected', {
      page: 'page',
      first: 'firstLast',
      last: 'firstLast',
  ...
  return composeClasses["default"](slots, paginationItemClasses.getPaginationItemUtilityClass, classes);
};
const PaginationItemEllipsis = styled["default"]('div', {
  ...
  height: 'auto',
  [`&.${paginationItemClasses["default"].disabled}`]: {
...
const PaginationItemPage = styled["default"](ButtonBase["default"], {
  name: 'MuiPaginationItem',
  slot: 'Root',
  overridesResolver
})(({
  ...
  margin: '0 3px',
  color: (theme.vars || theme).palette.text.primary,
  [`&.${paginationItemClasses["default"].focusVisible}`]: {
  ...
  [`&.${paginationItemClasses["default"].selected}`]: {
    backgroundColor: (theme.vars || theme).palette.action.selected,
    '&:hover': {
      backgroundColor: theme.vars ? `rgba(${theme.vars.palette.action.selected} / calc(${theme.vars.palette.action.selectedOpacity} + ${theme.vars.palette.action.hoverOpacity}))` : colorManipulator.alpha(theme.palette.action.selected, theme.palette.action.selectedOpacity + theme.palette.action.hoverOpacity),
      // Reset on touch devices, it doesn't add specificity
      '@media (hover: none)': {
        backgroundColor: (theme.vars || theme).palette.action.selected
      }
    ...
    [`&.${paginationItemClasses["default"].focusVisible}`]: {
      backgroundColor: theme.vars ? `rgba(${theme.vars.palette.action.selected} / calc(${theme.vars.palette.action.selectedOpacity} + ${theme.vars.palette.action.focusOpacity}))` : colorManipulator.alpha(theme.palette.action.selected, theme.palette.action.selectedOpacity + theme.palette.action.focusOpacity)
    },
    [`&.${paginationItemClasses["default"].disabled}`]: {
      opacity: 1,
  ...
  theme,
  ownerState
}) => _extends["default"]({}, ownerState.variant === 'text' && {
  [`&.${paginationItemClasses["default"].selected}`]: _extends["default"]({}, ownerState.color !== 'standard' && {
  ...
  [`&.${paginationItemClasses["default"].selected}`]: _extends["default"]({}, ownerState.color !== 'standard' && {
    ...
    border: `1px solid ${theme.vars ? `rgba(${theme.vars.palette[ownerState.color].mainChannel} / 0.5)` : colorManipulator.alpha(theme.palette[ownerState.color].main, 0.5)}`,
    backgroundColor: theme.vars ? `rgba(${theme.vars.palette[ownerState.color].mainChannel} / ${theme.vars.palette.action.activatedOpacity})` : colorManipulator.alpha(theme.palette[ownerState.color].main, theme.palette.action.activatedOpacity),
    '&:hover': {
      backgroundColor: theme.vars ? `rgba(${theme.vars.palette[ownerState.color].mainChannel} / calc(${theme.vars.palette.action.activatedOpacity} + ${theme.vars.palette.action.focusOpacity}))` : colorManipulator.alpha(theme.palette[ownerState.color].main, theme.palette.action.activatedOpacity + theme.palette.action.focusOpacity),
      // Reset on touch devices, it doesn't add specificity
      '@media (hover: none)': {
        backgroundColor: 'transparent'
      }
...
const PaginationItemPageIcon = styled["default"]('div', {
  name: 'MuiPaginationItem',
  slot: 'Icon',
...
const PaginationItem = /*#__PURE__*/React__namespace.forwardRef(function PaginationItem(inProps, ref) {
  ...
  const normalizedIcons = theme.direction === 'rtl' ? {
    previous: slots.next || components.next || NavigateNext["default"],
    next: slots.previous || components.previous || NavigateBefore["default"],
    last: slots.first || components.first || FirstPage["default"],
    first: slots.last || components.last || LastPage["default"]
  } : {
    previous: slots.previous || components.previous || NavigateBefore["default"],
    next: slots.next || components.next || NavigateNext["default"],
    first: slots.first || components.first || FirstPage["default"],
    last: slots.last || components.last || LastPage["default"]
  };
  ...
  return type === 'start-ellipsis' || type === 'end-ellipsis' ? /*#__PURE__*/jsxRuntime.jsx(PaginationItemEllipsis, {
    ...
    children: "\u2026"
  }) : /*#__PURE__*/jsxRuntime.jsxs(PaginationItemPage, _extends["default"]({
    ref: ref,
    ownerState: ownerState,
    component: component,
    disabled: disabled,
...
process.env.NODE_ENV !== "production" ? PaginationItem.propTypes /* remove-proptypes */ = {
   ...
   * @default 'standard'
   */
  color: PropTypes__default["default"] /* @typescript-to-proptypes-ignore */.oneOfType([PropTypes__default["default"].oneOf(['primary', 'secondary', 'standard']), PropTypes__default["default"].string]),
  /**
  ...
  components: PropTypes__default["default"].shape({
    first: PropTypes__default["default"].elementType,
    last: PropTypes__default["default"].elementType,
    next: PropTypes__default["default"].elementType,
    previous: PropTypes__default["default"].elementType
  }),
  /**
   ...
   */
  page: PropTypes__default["default"].node,
  /**
   ...
   * @default 'circular'
   */
  shape: PropTypes__default["default"].oneOf(['circular', 'rounded']),
  /**
   ...
   * @default 'page'
   */
  type: PropTypes__default["default"].oneOf(['end-ellipsis', 'first', 'last', 'next', 'page', 'previous', 'start-ellipsis']),
  /**
   * The variant to use.
   * @default 'text'
   */
  variant: PropTypes__default["default"] /* @typescript-to-proptypes-ignore */.oneOfType([PropTypes__default["default"].oneOf(['outlined', 'text']), PropTypes__default["default"].string])
} : void 0;
