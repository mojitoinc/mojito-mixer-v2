...
var Person = require('../internal/svg-icons/Person.js');
var avatarClasses = require('./avatarClasses.js');
...
const useUtilityClasses = ownerState => {
  ...
  return composeClasses["default"](slots, avatarClasses.getAvatarUtilityClass, classes);
};
const AvatarRoot = styled["default"]('div', {
  name: 'MuiAvatar',
  slot: 'Root',
  ...
  borderRadius: 0
}, ownerState.colorDefault && _extends["default"]({
...
const AvatarImg = styled["default"]('img', {
  name: 'MuiAvatar',
  slot: 'Img',
...
const AvatarFallback = styled["default"](Person["default"], {
  name: 'MuiAvatar',
  slot: 'Fallback',
...
const Avatar = /*#__PURE__*/React__namespace.forwardRef(function Avatar(inProps, ref) {
  ...
  const loaded = useLoaded(_extends["default"]({}, imgProps, {
    src,
    srcSet
  }));
  ...
  if (hasImgNotFailing) {
    children = /*#__PURE__*/jsxRuntime.jsx(AvatarImg, _extends["default"]({
      alt: alt,
      src: src,
      srcSet: srcSet,
      sizes: sizes,
  ...
  return /*#__PURE__*/jsxRuntime.jsx(AvatarRoot, _extends["default"]({
    as: component,
    ownerState: ownerState,
...
process.env.NODE_ENV !== "production" ? Avatar.propTypes /* remove-proptypes */ = {
   ...
   */
  imgProps: PropTypes__default["default"].object,
  /**
   * The `sizes` attribute for the `img` element.
   */
  sizes: PropTypes__default["default"].string,
  /**
   ...
   */
  srcSet: PropTypes__default["default"].string,
  /**
