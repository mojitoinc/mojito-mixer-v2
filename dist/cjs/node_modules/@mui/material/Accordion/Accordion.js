...
var accordionClasses = require('./accordionClasses.js');
...
const useUtilityClasses = ownerState => {
  ...
  return composeClasses["default"](slots, accordionClasses.getAccordionUtilityClass, classes);
};
const AccordionRoot = styled["default"](Paper["default"], {
  name: 'MuiAccordion',
  slot: 'Root',
  overridesResolver: (props, styles) => {
    ...
    return [{
      [`& .${accordionClasses["default"].region}`]: styles.region
  ...
  return {
    ...
    [`&.${accordionClasses["default"].expanded}`]: {
      '&:before': {
        opacity: 0
      },
      '&:first-of-type': {
    ...
    [`&.${accordionClasses["default"].disabled}`]: {
  ...
  theme,
  ownerState
}) => _extends["default"]({}, !ownerState.square && {
  borderRadius: 0,
  '&:first-of-type': {
...
const Accordion = /*#__PURE__*/React__namespace.forwardRef(function Accordion(inProps, ref) {
  ...
  const [expanded, setExpandedState] = useControlled["default"]({
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(AccordionRoot, _extends["default"]({
    className: clsx_m.clsx(classes.root, className),
    ref: ref,
    ownerState: ownerState,
    square: square
  }, other, {
    children: [/*#__PURE__*/jsxRuntime.jsx(AccordionContext["default"].Provider, {
      value: contextValue,
      children: summary
...
process.env.NODE_ENV !== "production" ? Accordion.propTypes /* remove-proptypes */ = {
   ...
   */
  children: chainPropTypes["default"](PropTypes__default["default"].node.isRequired, props => {
    const summary = React__namespace.Children.toArray(props.children)[0];
    if (reactIs.isFragment(summary)) {
