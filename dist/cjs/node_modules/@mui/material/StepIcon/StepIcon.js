...
var CheckCircle = require('../internal/svg-icons/CheckCircle.js');
var Warning = require('../internal/svg-icons/Warning.js');
var SvgIcon = require('../SvgIcon/SvgIcon.js');
require('../SvgIcon/svgIconClasses.js');
var stepIconClasses = require('./stepIconClasses.js');
...
const useUtilityClasses = ownerState => {
  ...
  return composeClasses["default"](slots, stepIconClasses.getStepIconUtilityClass, classes);
};
const StepIconRoot = styled["default"](SvgIcon["default"], {
  name: 'MuiStepIcon',
  slot: 'Root',
  ...
  [`&.${stepIconClasses["default"].completed}`]: {
    color: (theme.vars || theme).palette.primary.main
  },
  [`&.${stepIconClasses["default"].active}`]: {
    color: (theme.vars || theme).palette.primary.main
  },
  [`&.${stepIconClasses["default"].error}`]: {
    color: (theme.vars || theme).palette.error.main
  }
}));
const StepIconText = styled["default"]('text', {
  name: 'MuiStepIcon',
  slot: 'Text',
...
const StepIcon = /*#__PURE__*/React__namespace.forwardRef(function StepIcon(inProps, ref) {
  ...
  if (typeof icon === 'number' || typeof icon === 'string') {
    const className = clsx_m.clsx(classNameProp, classes.root);
    if (error) {
      return /*#__PURE__*/jsxRuntime.jsx(StepIconRoot, _extends["default"]({
        as: Warning["default"],
        className: className,
        ref: ref,
    ...
    if (completed) {
      return /*#__PURE__*/jsxRuntime.jsx(StepIconRoot, _extends["default"]({
        as: CheckCircle["default"],
        className: className,
        ref: ref,
        ownerState: ownerState
      }, other));
    }
    return /*#__PURE__*/jsxRuntime.jsxs(StepIconRoot, _extends["default"]({
      className: className,
      ref: ref,
      ownerState: ownerState
    }, other, {
      children: [_circle || (_circle = /*#__PURE__*/jsxRuntime.jsx("circle", {
        cx: "12",
        cy: "12",
        r: "12"
      })), /*#__PURE__*/jsxRuntime.jsx(StepIconText, {
