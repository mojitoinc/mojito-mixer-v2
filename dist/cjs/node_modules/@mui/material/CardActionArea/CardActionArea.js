...
var cardActionAreaClasses = require('./cardActionAreaClasses.js');
...
const useUtilityClasses = ownerState => {
  ...
  return composeClasses["default"](slots, cardActionAreaClasses.getCardActionAreaUtilityClass, classes);
};
const CardActionAreaRoot = styled["default"](ButtonBase["default"], {
  ...
  textAlign: 'inherit',
  width: '100%',
  [`&:hover .${cardActionAreaClasses["default"].focusHighlight}`]: {
    opacity: (theme.vars || theme).palette.action.hoverOpacity,
    '@media (hover: none)': {
      opacity: 0
    }
  },
  [`&.${cardActionAreaClasses["default"].focusVisible} .${cardActionAreaClasses["default"].focusHighlight}`]: {
    opacity: (theme.vars || theme).palette.action.focusOpacity
  }
}));
const CardActionAreaFocusHighlight = styled["default"]('span', {
  name: 'MuiCardActionArea',
  slot: 'FocusHighlight',
...
const CardActionArea = /*#__PURE__*/React__namespace.forwardRef(function CardActionArea(inProps, ref) {
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(CardActionAreaRoot, _extends["default"]({
    className: clsx_m.clsx(classes.root, className),
    focusVisibleClassName: clsx_m.clsx(focusVisibleClassName, classes.focusVisible),
    ref: ref,
    ownerState: ownerState
  }, other, {
    children: [children, /*#__PURE__*/jsxRuntime.jsx(CardActionAreaFocusHighlight, {
...
exports["default"] = CardActionArea;
