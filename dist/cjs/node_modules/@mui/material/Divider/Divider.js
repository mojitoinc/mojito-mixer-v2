...
var dividerClasses = require('./dividerClasses.js');
...
const useUtilityClasses = ownerState => {
  ...
  return composeClasses["default"](slots, dividerClasses.getDividerUtilityClass, classes);
};
const DividerRoot = styled["default"]('div', {
  name: 'MuiDivider',
  slot: 'Root',
  ...
  borderColor: theme.vars ? `rgba(${theme.vars.palette.dividerChannel} / 0.08)` : colorManipulator.alpha(theme.palette.divider, 0.08)
  ...
  theme,
  ownerState
}) => _extends["default"]({}, ownerState.children && {
  display: 'flex',
  whiteSpace: 'nowrap',
  textAlign: 'center',
  border: 0,
  ...
  theme,
  ownerState
}) => _extends["default"]({}, ownerState.children && ownerState.orientation === 'vertical' && {
  ...
  ownerState
}) => _extends["default"]({}, ownerState.textAlign === 'right' && ownerState.orientation !== 'vertical' && {
  '&::before': {
    width: '90%'
  },
  '&::after': {
...
const DividerWrapper = styled["default"]('span', {
  name: 'MuiDivider',
  slot: 'Wrapper',
  overridesResolver: (props, styles) => {
    const {
...
const Divider = /*#__PURE__*/React__namespace.forwardRef(function Divider(inProps, ref) {
  ...
  return /*#__PURE__*/jsxRuntime.jsx(DividerRoot, _extends["default"]({
    as: component,
...
process.env.NODE_ENV !== "production" ? Divider.propTypes /* remove-proptypes */ = {
   ...
   * @default false
   */
  absolute: PropTypes__default["default"].bool,
  /**
   ...
   * @default false
   */
  flexItem: PropTypes__default["default"].bool,
  /**
   ...
   * @default 'center'
   */
  textAlign: PropTypes__default["default"].oneOf(['center', 'left', 'right']),
  /**
   * The variant to use.
   * @default 'fullWidth'
   */
  variant: PropTypes__default["default"] /* @typescript-to-proptypes-ignore */.oneOfType([PropTypes__default["default"].oneOf(['fullWidth', 'inset', 'middle']), PropTypes__default["default"].string])
} : void 0;
