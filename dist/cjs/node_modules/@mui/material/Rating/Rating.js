...
var visuallyHidden = require('../../utils/esm/visuallyHidden.js');
...
var Star = require('../internal/svg-icons/Star.js');
var StarBorder = require('../internal/svg-icons/StarBorder.js');
var useThemeProps = require('../styles/useThemeProps.js');
var styled = require('../styles/styled.js');
var ratingClasses = require('./ratingClasses.js');
...
const useUtilityClasses = ownerState => {
  ...
  const slots = {
    root: ['root', `size${capitalize["default"](size)}`, disabled && 'disabled', focusVisible && 'focusVisible', readOnly && 'readyOnly'],
  ...
  return composeClasses["default"](slots, ratingClasses.getRatingUtilityClass, classes);
};
const RatingRoot = styled["default"]('span', {
  name: 'MuiRating',
  slot: 'Root',
  overridesResolver: (props, styles) => {
    ...
    return [{
      [`& .${ratingClasses["default"].visuallyHidden}`]: styles.visuallyHidden
    }, styles.root, styles[`size${capitalize["default"](ownerState.size)}`], ownerState.readOnly && styles.readOnly];
  }
})(({
  theme,
  ownerState
  ...
  [`&.${ratingClasses["default"].disabled}`]: {
    opacity: (theme.vars || theme).palette.action.disabledOpacity,
    pointerEvents: 'none'
  },
  [`&.${ratingClasses["default"].focusVisible} .${ratingClasses["default"].iconActive}`]: {
    outline: '1px solid #999'
  },
  [`& .${ratingClasses["default"].visuallyHidden}`]: visuallyHidden["default"]
...
const RatingLabel = styled["default"]('label', {
  name: 'MuiRating',
  slot: 'Label',
  overridesResolver: ({
    ownerState
...
const RatingIcon = styled["default"]('span', {
  name: 'MuiRating',
  slot: 'Icon',
  overridesResolver: (props, styles) => {
    const {
...
const RatingDecimal = styled["default"]('span', {
  name: 'MuiRating',
  slot: 'Decimal',
  shouldForwardProp: prop => styled.slotShouldForwardProp(prop) && prop !== 'iconActive',
  overridesResolver: (props, styles) => {
    const {
      iconActive
    } = props;
...
function IconContainer(props) {
  const other = objectWithoutPropertiesLoose["default"](props, _excluded);
  return /*#__PURE__*/jsxRuntime.jsx("span", _extends["default"]({}, other));
}
...
function RatingItem(props) {
  ...
  const container = /*#__PURE__*/jsxRuntime.jsx(RatingIcon, {
    as: IconContainerComponent,
    value: itemValue,
    className: clsx_m.clsx(classes.icon, isFilled ? classes.iconFilled : classes.iconEmpty, isHovered && classes.iconHover, isFocused && classes.iconFocus, isActive && classes.iconActive),
    ownerState: _extends["default"]({}, ownerState, {
      iconEmpty: !isFilled,
      iconFilled: isFilled,
      iconHover: isHovered,
      iconFocus: isFocused,
  ...
  if (readOnly) {
    return /*#__PURE__*/jsxRuntime.jsx("span", _extends["default"]({}, labelProps, {
      children: container
    }));
  }
  return /*#__PURE__*/jsxRuntime.jsxs(React__namespace.Fragment, {
    children: [/*#__PURE__*/jsxRuntime.jsxs(RatingLabel, _extends["default"]({
      ownerState: _extends["default"]({}, ownerState, {
        emptyValueFocused: undefined
      }),
      htmlFor: id
    }, labelProps, {
      children: [container, /*#__PURE__*/jsxRuntime.jsx("span", {
...
process.env.NODE_ENV !== "production" ? RatingItem.propTypes = {
  ...
  emptyIcon: PropTypes__default["default"].node,
  focus: PropTypes__default["default"].number.isRequired,
  getLabelText: PropTypes__default["default"].func.isRequired,
  highlightSelectedOnly: PropTypes__default["default"].bool.isRequired,
  hover: PropTypes__default["default"].number.isRequired,
  icon: PropTypes__default["default"].node,
  IconContainerComponent: PropTypes__default["default"].elementType.isRequired,
  isActive: PropTypes__default["default"].bool.isRequired,
  itemValue: PropTypes__default["default"].number.isRequired,
  ...
  ownerState: PropTypes__default["default"].object.isRequired,
  ratingValue: PropTypes__default["default"].number,
  ratingValueRounded: PropTypes__default["default"].number,
  readOnly: PropTypes__default["default"].bool.isRequired
} : void 0;
const defaultIcon = /*#__PURE__*/jsxRuntime.jsx(Star["default"], {
  fontSize: "inherit"
});
const defaultEmptyIcon = /*#__PURE__*/jsxRuntime.jsx(StarBorder["default"], {
  fontSize: "inherit"
});
...
const Rating = /*#__PURE__*/React__namespace.forwardRef(function Rating(inProps, ref) {
  ...
  const {
    ...
    other = objectWithoutPropertiesLoose["default"](props, _excluded2);
  const name = useId["default"](nameProp);
  const [valueDerived, setValueState] = useControlled["default"]({
  ...
  const handleRef = useForkRef["default"](focusVisibleRef, rootRef, ref);
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(RatingRoot, _extends["default"]({
    ref: handleRef,
    ...
    children: [Array.from(new Array(max)).map((_, index) => {
      ...
      if (precision < 1) {
        ...
        return /*#__PURE__*/jsxRuntime.jsx(RatingDecimal, {
          className: clsx_m.clsx(classes.decimal, isActive && classes.iconActive),
          ownerState: ownerState,
          iconActive: isActive,
          children: items.map(($, indexDecimal) => {
            const itemDecimalValue = roundValueToPrecision(itemValue - 1 + (indexDecimal + 1) * precision, precision);
            return /*#__PURE__*/jsxRuntime.jsx(RatingItem, _extends["default"]({}, ratingItemProps, {
    ...
    }), !readOnly && !disabled && /*#__PURE__*/jsxRuntime.jsxs(RatingLabel, {
      className: clsx_m.clsx(classes.label, classes.labelEmptyValue),
      ownerState: ownerState,
...
process.env.NODE_ENV !== "production" ? Rating.propTypes /* remove-proptypes */ = {
   ...
   * @default 'Empty'
   */
  emptyLabelText: PropTypes__default["default"].node,
  /**
   ...
   * }
   */
  getLabelText: PropTypes__default["default"].func,
  /**
   * If `true`, only the selected icon will be highlighted.
   * @default false
   */
  highlightSelectedOnly: PropTypes__default["default"].bool,
  /**
   * The icon to display.
   ...
   * }
   */
  IconContainerComponent: PropTypes__default["default"].elementType,
  /**
   * Maximum rating.
   * @default 5
   */
   ...
   */
  onChangeActive: PropTypes__default["default"].func,
  /**
   * @ignore
   */
   ...
   * @default 1
   */
  precision: chainPropTypes["default"](PropTypes__default["default"].number, props => {
