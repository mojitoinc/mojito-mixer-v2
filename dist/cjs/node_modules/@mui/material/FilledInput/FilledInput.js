...
var filledInputClasses = require('./filledInputClasses.js');
...
const useUtilityClasses = ownerState => {
  ...
  const composedClasses = composeClasses["default"](slots, filledInputClasses.getFilledInputUtilityClass, classes);
  return _extends["default"]({}, classes, composedClasses);
};
const FilledInputRoot = styled["default"](InputBase.InputBaseRoot, {
  ...
  overridesResolver: (props, styles) => {
    ...
    return [...InputBase.rootOverridesResolver(props, styles), !ownerState.disableUnderline && styles.underline];
  }
})(({
  theme,
  ownerState
  ...
  return _extends["default"]({
    ...
    [`&.${filledInputClasses["default"].error}`]: {
      '&:before, &:after': {
    ...
    [`&:hover:not(.${filledInputClasses["default"].disabled}, .${filledInputClasses["default"].error}):before`]: {
...
const FilledInputInput = styled["default"](InputBase.InputBaseComponent, {
  name: 'MuiFilledInput',
  slot: 'Input',
...
const FilledInput = /*#__PURE__*/React__namespace.forwardRef(function FilledInput(inProps, ref) {
  ...
  const componentsProps = (slotProps != null ? slotProps : componentsPropsProp) ? deepmerge["default"](slotProps != null ? slotProps : componentsPropsProp, filledInputComponentsProps) : filledInputComponentsProps;
  const RootSlot = (_ref = (_slots$root = slots.root) != null ? _slots$root : components.Root) != null ? _ref : FilledInputRoot;
  const InputSlot = (_ref2 = (_slots$input = slots.input) != null ? _slots$input : components.Input) != null ? _ref2 : FilledInputInput;
  return /*#__PURE__*/jsxRuntime.jsx(InputBase["default"], _extends["default"]({
    slots: {
      root: RootSlot,
      input: InputSlot
    },
...
process.env.NODE_ENV !== "production" ? FilledInput.propTypes /* remove-proptypes */ = {
   ...
   */
  disableUnderline: PropTypes__default["default"].bool,
  /**
   ...
   * @default false
   */
  hiddenLabel: PropTypes__default["default"].bool,
  /**
   ...
   * @default 'input'
   */
  inputComponent: PropTypes__default["default"].elementType,
  /**
