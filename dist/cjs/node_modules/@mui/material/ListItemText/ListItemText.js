...
var listItemTextClasses = require('./listItemTextClasses.js');
...
const useUtilityClasses = ownerState => {
  ...
  return composeClasses["default"](slots, listItemTextClasses.getListItemTextUtilityClass, classes);
};
const ListItemTextRoot = styled["default"]('div', {
  ...
  overridesResolver: (props, styles) => {
    ...
    return [{
      [`& .${listItemTextClasses["default"].primary}`]: styles.primary
    }, {
      [`& .${listItemTextClasses["default"].secondary}`]: styles.secondary
...
const ListItemText = /*#__PURE__*/React__namespace.forwardRef(function ListItemText(inProps, ref) {
  ...
  const {
    dense
  } = React__namespace.useContext(ListContext["default"]);
  ...
  if (primary != null && primary.type !== Typography["default"] && !disableTypography) {
    primary = /*#__PURE__*/jsxRuntime.jsx(Typography["default"], _extends["default"]({
  ...
  if (secondary != null && secondary.type !== Typography["default"] && !disableTypography) {
    secondary = /*#__PURE__*/jsxRuntime.jsx(Typography["default"], _extends["default"]({
      variant: "body2",
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(ListItemTextRoot, _extends["default"]({
...
process.env.NODE_ENV !== "production" ? ListItemText.propTypes /* remove-proptypes */ = {
   ...
   * @default false
   */
  inset: PropTypes__default["default"].bool,
  /**
   ...
   */
  primaryTypographyProps: PropTypes__default["default"].object,
  /**
   ...
   * (as long as disableTypography is not `true`).
   */
  secondaryTypographyProps: PropTypes__default["default"].object,
  /**
