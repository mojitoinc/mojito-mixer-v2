...
const ToggleButtonRoot = styled["default"](ButtonBase["default"], {
  ...
  return _extends["default"]({}, theme.typography.button, {
    ...
    [`&.${toggleButtonClasses["default"].selected}`]: {
      color: selectedColor,
      backgroundColor: theme.vars ? `rgba(${selectedColorChannel} / ${theme.vars.palette.action.selectedOpacity})` : colorManipulator.alpha(selectedColor, theme.palette.action.selectedOpacity),
      '&:hover': {
        backgroundColor: theme.vars ? `rgba(${selectedColorChannel} / calc(${theme.vars.palette.action.selectedOpacity} + ${theme.vars.palette.action.hoverOpacity}))` : colorManipulator.alpha(selectedColor, theme.palette.action.selectedOpacity + theme.palette.action.hoverOpacity),
...
const ToggleButton = /*#__PURE__*/React__namespace.forwardRef(function ToggleButton(inProps, ref) {
  ...
  return /*#__PURE__*/jsxRuntime.jsx(ToggleButtonRoot, _extends["default"]({
...
process.env.NODE_ENV !== "production" ? ToggleButton.propTypes /* remove-proptypes */ = {
   ...
   * @default 'standard'
   */
  color: PropTypes__default["default"] /* @typescript-to-proptypes-ignore */.oneOfType([PropTypes__default["default"].oneOf(['standard', 'primary', 'secondary', 'error', 'info', 'success', 'warning']), PropTypes__default["default"].string]),
  /**
   ...
   * ToggleButtonGroup.
   */
  value: PropTypes__default["default"] /* @typescript-to-proptypes-ignore */.any.isRequired
} : void 0;
