...
var cssUtils = require('../styles/cssUtils.js');
...
var skeletonClasses = require('./skeletonClasses.js');
...
const useUtilityClasses = ownerState => {
  ...
  return composeClasses["default"](slots, skeletonClasses.getSkeletonUtilityClass, classes);
};
const pulseKeyframe = emotionReact_esm.keyframes(_t || (_t = _`
  0% {
    opacity: 1;
  }
...
`));
const waveKeyframe = emotionReact_esm.keyframes(_t2 || (_t2 = _`
  0% {
...
`));
const SkeletonRoot = styled["default"]('span', {
  name: 'MuiSkeleton',
  slot: 'Root',
  ...
  const radiusUnit = cssUtils.getUnit(theme.shape.borderRadius) || 'px';
  const radiusValue = cssUtils.toUnitless(theme.shape.borderRadius);
  return _extends["default"]({
    display: 'block',
    // Create a "on paper" color with sufficient contrast retaining the color
    backgroundColor: theme.vars ? theme.vars.palette.Skeleton.bg : colorManipulator.alpha(theme.palette.text.primary, theme.palette.mode === 'light' ? 0.11 : 0.13),
    height: '1.2em'
  ...
  ownerState
}) => ownerState.animation === 'pulse' && emotionReact_esm.css(_t3 || (_t3 = _`
      animation: ${0} 1.5s ease-in-out 0.5s infinite;
    `), pulseKeyframe), ({
  ownerState,
  theme
}) => ownerState.animation === 'wave' && emotionReact_esm.css(_t4 || (_t4 = _`
      position: relative;
      overflow: hidden;
...
const Skeleton = /*#__PURE__*/React__namespace.forwardRef(function Skeleton(inProps, ref) {
  ...
  return /*#__PURE__*/jsxRuntime.jsx(SkeletonRoot, _extends["default"]({
    as: component,
    ref: ref,
...
process.env.NODE_ENV !== "production" ? Skeleton.propTypes /* remove-proptypes */ = {
   ...
   * @default 'pulse'
   */
  animation: PropTypes__default["default"].oneOf(['pulse', 'wave', false]),
  /**
   ...
   * @default 'text'
   */
  variant: PropTypes__default["default"] /* @typescript-to-proptypes-ignore */.oneOfType([PropTypes__default["default"].oneOf(['circular', 'rectangular', 'rounded', 'text']), PropTypes__default["default"].string]),
  /**
