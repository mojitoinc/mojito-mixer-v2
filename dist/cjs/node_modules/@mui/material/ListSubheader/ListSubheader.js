...
var listSubheaderClasses = require('./listSubheaderClasses.js');
...
const useUtilityClasses = ownerState => {
  ...
  const slots = {
    root: ['root', color !== 'default' && `color${capitalize["default"](color)}`, !disableGutters && 'gutters', inset && 'inset', !disableSticky && 'sticky']
  };
  return composeClasses["default"](slots, listSubheaderClasses.getListSubheaderUtilityClass, classes);
};
const ListSubheaderRoot = styled["default"]('li', {
  ...
  overridesResolver: (props, styles) => {
    ...
    return [styles.root, ownerState.color !== 'default' && styles[`color${capitalize["default"](ownerState.color)}`], !ownerState.disableGutters && styles.gutters, ownerState.inset && styles.inset, !ownerState.disableSticky && styles.sticky];
  }
})(({
  theme,
  ownerState
...
const ListSubheader = /*#__PURE__*/React__namespace.forwardRef(function ListSubheader(inProps, ref) {
  ...
  return /*#__PURE__*/jsxRuntime.jsx(ListSubheaderRoot, _extends["default"]({
    as: component,
...
process.env.NODE_ENV !== "production" ? ListSubheader.propTypes /* remove-proptypes */ = {
   ...
   * @default 'default'
   */
  color: PropTypes__default["default"].oneOf(['default', 'inherit', 'primary']),
  /**
   ...
   * @default false
   */
  disableSticky: PropTypes__default["default"].bool,
  /**
