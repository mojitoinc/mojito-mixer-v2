...
var formLabelClasses = require('./formLabelClasses.js');
...
const useUtilityClasses = ownerState => {
  ...
  const slots = {
    root: ['root', `color${capitalize["default"](color)}`, disabled && 'disabled', error && 'error', filled && 'filled', focused && 'focused', required && 'required'],
    asterisk: ['asterisk', error && 'error']
  };
  return composeClasses["default"](slots, formLabelClasses.getFormLabelUtilityClasses, classes);
};
const FormLabelRoot = styled["default"]('label', {
  name: 'MuiFormLabel',
  slot: 'Root',
  overridesResolver: ({
    ownerState
  }, styles) => {
    return _extends["default"]({}, styles.root, ownerState.color === 'secondary' && styles.colorSecondary, ownerState.filled && styles.filled);
  }
})(({
  theme,
  ownerState
  ...
  padding: 0,
  position: 'relative',
  [`&.${formLabelClasses["default"].focused}`]: {
    color: (theme.vars || theme).palette[ownerState.color].main
  },
  [`&.${formLabelClasses["default"].disabled}`]: {
    color: (theme.vars || theme).palette.text.disabled
  },
  [`&.${formLabelClasses["default"].error}`]: {
    color: (theme.vars || theme).palette.error.main
  }
}));
const AsteriskComponent = styled["default"]('span', {
  name: 'MuiFormLabel',
  slot: 'Asterisk',
...
const FormLabel = /*#__PURE__*/React__namespace.forwardRef(function FormLabel(inProps, ref) {
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(FormLabelRoot, _extends["default"]({
    as: component,
