...
var cardHeaderClasses = require('./cardHeaderClasses.js');
...
const useUtilityClasses = ownerState => {
  ...
  return composeClasses["default"](slots, cardHeaderClasses.getCardHeaderUtilityClass, classes);
};
const CardHeaderRoot = styled["default"]('div', {
  name: 'MuiCardHeader',
  slot: 'Root',
  overridesResolver: (props, styles) => _extends["default"]({
    [`& .${cardHeaderClasses["default"].title}`]: styles.title,
    [`& .${cardHeaderClasses["default"].subheader}`]: styles.subheader
  }, styles.root)
})({
  display: 'flex',
  alignItems: 'center',
...
const CardHeaderAvatar = styled["default"]('div', {
  name: 'MuiCardHeader',
  slot: 'Avatar',
...
const CardHeaderAction = styled["default"]('div', {
  name: 'MuiCardHeader',
  slot: 'Action',
...
const CardHeaderContent = styled["default"]('div', {
  name: 'MuiCardHeader',
  slot: 'Content',
...
const CardHeader = /*#__PURE__*/React__namespace.forwardRef(function CardHeader(inProps, ref) {
  ...
  let title = titleProp;
  if (title != null && title.type !== Typography["default"] && !disableTypography) {
    title = /*#__PURE__*/jsxRuntime.jsx(Typography["default"], _extends["default"]({
  ...
  if (subheader != null && subheader.type !== Typography["default"] && !disableTypography) {
    subheader = /*#__PURE__*/jsxRuntime.jsx(Typography["default"], _extends["default"]({
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(CardHeaderRoot, _extends["default"]({
...
process.env.NODE_ENV !== "production" ? CardHeader.propTypes /* remove-proptypes */ = {
   ...
   */
  subheader: PropTypes__default["default"].node,
  /**
   * These props will be forwarded to the subheader
   * (as long as disableTypography is not `true`).
   */
  subheaderTypographyProps: PropTypes__default["default"].object,
  /**
   ...
   * (as long as disableTypography is not `true`).
   */
  titleTypographyProps: PropTypes__default["default"].object
} : void 0;
