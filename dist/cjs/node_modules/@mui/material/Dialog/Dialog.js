...
var dialogClasses = require('./dialogClasses.js');
...
const DialogBackdrop = styled["default"](Backdrop["default"], {
  name: 'MuiDialog',
  slot: 'Backdrop',
...
const useUtilityClasses = ownerState => {
  ...
  const slots = {
    root: ['root'],
    container: ['container', `scroll${capitalize["default"](scroll)}`],
    paper: ['paper', `paperScroll${capitalize["default"](scroll)}`, `paperWidth${capitalize["default"](String(maxWidth))}`, fullWidth && 'paperFullWidth', fullScreen && 'paperFullScreen']
  };
  return composeClasses["default"](slots, dialogClasses.getDialogUtilityClass, classes);
};
const DialogRoot = styled["default"](Modal["default"], {
  name: 'MuiDialog',
  slot: 'Root',
...
const DialogContainer = styled["default"]('div', {
  name: 'MuiDialog',
  slot: 'Container',
  overridesResolver: (props, styles) => {
    ...
    return [styles.container, styles[`scroll${capitalize["default"](ownerState.scroll)}`]];
  }
})(({
  ownerState
}) => _extends["default"]({
...
const DialogPaper = styled["default"](Paper["default"], {
  name: 'MuiDialog',
  slot: 'Paper',
  overridesResolver: (props, styles) => {
    const {
    ...
    return [styles.paper, styles[`scrollPaper${capitalize["default"](ownerState.scroll)}`], styles[`paperWidth${capitalize["default"](String(ownerState.maxWidth))}`], ownerState.fullWidth && styles.paperFullWidth, ownerState.fullScreen && styles.paperFullScreen];
  }
})(({
  theme,
  ownerState
  ...
  [`&.${dialogClasses["default"].paperScrollBody}`]: {
...
const Dialog = /*#__PURE__*/React__namespace.forwardRef(function Dialog(inProps, ref) {
  ...
  const ariaLabelledby = useId["default"](ariaLabelledbyProp);
  const dialogContextValue = React__namespace.useMemo(() => {
    return {
      titleId: ariaLabelledby
    };
  }, [ariaLabelledby]);
  return /*#__PURE__*/jsxRuntime.jsx(DialogRoot, _extends["default"]({
    ...
    children: /*#__PURE__*/jsxRuntime.jsx(TransitionComponent, _extends["default"]({
      ...
      children: /*#__PURE__*/jsxRuntime.jsx(DialogContainer, {
        className: clsx_m.clsx(classes.container),
        onMouseDown: handleMouseDown,
        ownerState: ownerState,
        children: /*#__PURE__*/jsxRuntime.jsx(DialogPaper, _extends["default"]({
          as: PaperComponent,
          elevation: 24,
          role: "dialog",
          "aria-describedby": ariaDescribedby,
          ...
          ownerState: ownerState,
          children: /*#__PURE__*/jsxRuntime.jsx(DialogContext["default"].Provider, {
...
process.env.NODE_ENV !== "production" ? Dialog.propTypes /* remove-proptypes */ = {
   ...
   * @default 'paper'
   */
  scroll: PropTypes__default["default"].oneOf(['body', 'paper']),
  /**
