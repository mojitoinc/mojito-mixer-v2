...
var TextareaAutosize = require('../../base/TextareaAutosize/TextareaAutosize.js');
...
var inputBaseClasses = require('./inputBaseClasses.js');
...
const useUtilityClasses = ownerState => {
  ...
  const slots = {
    root: ['root', `color${capitalize["default"](color)}`, disabled && 'disabled', error && 'error', fullWidth && 'fullWidth', focused && 'focused', formControl && 'formControl', size === 'small' && 'sizeSmall', multiline && 'multiline', startAdornment && 'adornedStart', endAdornment && 'adornedEnd', hiddenLabel && 'hiddenLabel', readOnly && 'readOnly'],
    input: ['input', disabled && 'disabled', type === 'search' && 'inputTypeSearch', multiline && 'inputMultiline', size === 'small' && 'inputSizeSmall', hiddenLabel && 'inputHiddenLabel', startAdornment && 'inputAdornedStart', endAdornment && 'inputAdornedEnd', readOnly && 'readOnly']
  };
  return composeClasses["default"](slots, inputBaseClasses.getInputBaseUtilityClass, classes);
};
const InputBaseRoot = styled["default"]('div', {
  name: 'MuiInputBase',
  slot: 'Root',
...
}, ownerState.multiline && _extends["default"]({
  padding: '4px 0 5px'
...
const InputBaseComponent = styled["default"]('input', {
  name: 'MuiInputBase',
  slot: 'Input',
  ...
  const placeholder = _extends["default"]({
    color: 'currentColor'
  }, theme.vars ? {
...
const inputGlobalStyles = /*#__PURE__*/jsxRuntime.jsx(GlobalStyles["default"], {
  styles: {
...
const InputBase = /*#__PURE__*/React__namespace.forwardRef(function InputBase(inProps, ref) {
  ...
  const handleInputRef = useForkRef["default"](inputRef, inputRefProp, inputPropsProp.ref, handleInputRefWarning);
  ...
  const handleChange = (event, ...args) => {
    if (!isControlled) {
      ...
      if (element == null) {
        throw new Error(process.env.NODE_ENV !== "production" ? `MUI: Expected valid input target. Did you use a custom \`inputComponent\` and forget to forward refs? See https://mui.com/r/input-component-ref-interface for more info.` : formatMuiErrorMessage["default"](1));
      }
      checkDirty({
        value: element.value
      });
  ...
  if (multiline && InputComponent === 'input') {
    ...
    InputComponent = TextareaAutosize["default"];
  }
  ...
  inputProps = _extends["default"]({}, inputProps, (_slotProps$input = slotProps.input) != null ? _slotProps$input : componentsProps.input);
  return /*#__PURE__*/jsxRuntime.jsxs(React__namespace.Fragment, {
    children: [!disableInjectingGlobalStyles && inputGlobalStyles, /*#__PURE__*/jsxRuntime.jsxs(Root, _extends["default"]({}, rootProps, !isHostComponent["default"](Root) && {
      ...
      children: [startAdornment, /*#__PURE__*/jsxRuntime.jsx(FormControlContext["default"].Provider, {
        value: null,
        children: /*#__PURE__*/jsxRuntime.jsx(Input, _extends["default"]({
          ...
          onKeyUp: onKeyUp,
          type: type
        }, inputProps, !isHostComponent["default"](Input) && {
          as: InputComponent,
          ownerState: _extends["default"]({}, ownerState, inputProps.ownerState)
        }, {
          ref: handleInputRef,
          className: clsx_m.clsx(classes.input, inputProps.className),
          onBlur: handleBlur,
          onChange: handleChange,
          onFocus: handleFocus
        }))
      }), endAdornment, renderSuffix ? renderSuffix(_extends["default"]({}, fcs, {
        startAdornment
      })) : null]
    }))]
  });
...
process.env.NODE_ENV !== "production" ? InputBase.propTypes /* remove-proptypes */ = {
   ...
   * @default false
   */
  disableInjectingGlobalStyles: PropTypes__default["default"].bool,
  /**
   ...
   */
  margin: PropTypes__default["default"].oneOf(['dense', 'none']),
  /**
   ...
   * @ignore
   */
  renderSuffix: PropTypes__default["default"].func,
  /**
