...
require('../Popover/popoverClasses.js');
...
var menuClasses = require('./menuClasses.js');
...
const useUtilityClasses = ownerState => {
  ...
  return composeClasses["default"](slots, menuClasses.getMenuUtilityClass, classes);
};
const MenuRoot = styled["default"](Popover["default"], {
  shouldForwardProp: prop => styled.rootShouldForwardProp(prop) || prop === 'classes',
  name: 'MuiMenu',
  slot: 'Root',
  overridesResolver: (props, styles) => styles.root
})({});
const MenuPaper = styled["default"](Paper["default"], {
  name: 'MuiMenu',
  slot: 'Paper',
...
const MenuMenuList = styled["default"](MenuList["default"], {
  name: 'MuiMenu',
  slot: 'List',
...
const Menu = /*#__PURE__*/React__namespace.forwardRef(function Menu(inProps, ref) {
  ...
  return /*#__PURE__*/jsxRuntime.jsx(MenuRoot, _extends["default"]({
    onClose: onClose,
    anchorOrigin: {
      vertical: 'bottom',
    ...
    PaperProps: _extends["default"]({
      component: MenuPaper
    }, PaperProps, {
      classes: _extends["default"]({}, PaperProps.classes, {
        root: classes.paper
      })
    }),
    ...
    TransitionProps: _extends["default"]({
      onEntering: handleEntering
    }, TransitionProps),
    ownerState: ownerState
  }, other, {
    classes: PopoverClasses,
    children: /*#__PURE__*/jsxRuntime.jsx(MenuMenuList, _extends["default"]({
      ...
      className: clsx_m.clsx(classes.list, MenuListProps.className),
      children: children
    }))
  }));
});
process.env.NODE_ENV !== "production" ? Menu.propTypes /* remove-proptypes */ = {
   ...
   */
  anchorEl: PropTypes__default["default"] /* @typescript-to-proptypes-ignore */.oneOfType([HTMLElementType["default"], PropTypes__default["default"].func]),
  /**
   ...
   * @default false
   */
  disableAutoFocusItem: PropTypes__default["default"].bool,
  /**
   * Props applied to the [`MenuList`](/material-ui/api/menu-list/) element.
   * @default {}
   */
  MenuListProps: PropTypes__default["default"].object,
  /**
   ...
   */
  PopoverClasses: PropTypes__default["default"].object,
  /**
   ...
   */
  variant: PropTypes__default["default"].oneOf(['menu', 'selectedMenu'])
} : void 0;
