...
var toolbarClasses = require('./toolbarClasses.js');
...
const useUtilityClasses = ownerState => {
  ...
  return composeClasses["default"](slots, toolbarClasses.getToolbarUtilityClass, classes);
};
const ToolbarRoot = styled["default"]('div', {
  name: 'MuiToolbar',
  slot: 'Root',
...
const Toolbar = /*#__PURE__*/React__namespace.forwardRef(function Toolbar(inProps, ref) {
  ...
  return /*#__PURE__*/jsxRuntime.jsx(ToolbarRoot, _extends["default"]({
    as: component,
...
process.env.NODE_ENV !== "production" ? Toolbar.propTypes /* remove-proptypes */ = {
   ...
   * @default 'regular'
   */
  variant: PropTypes__default["default"] /* @typescript-to-proptypes-ignore */.oneOfType([PropTypes__default["default"].oneOf(['dense', 'regular']), PropTypes__default["default"].string])
} : void 0;
