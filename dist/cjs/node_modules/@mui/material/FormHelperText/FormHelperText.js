...
var formHelperTextClasses = require('./formHelperTextClasses.js');
...
const useUtilityClasses = ownerState => {
  ...
  const slots = {
    root: ['root', disabled && 'disabled', error && 'error', size && `size${capitalize["default"](size)}`, contained && 'contained', focused && 'focused', filled && 'filled', required && 'required']
  };
  return composeClasses["default"](slots, formHelperTextClasses.getFormHelperTextUtilityClasses, classes);
};
const FormHelperTextRoot = styled["default"]('p', {
  ...
  overridesResolver: (props, styles) => {
    ...
    return [styles.root, ownerState.size && styles[`size${capitalize["default"](ownerState.size)}`], ownerState.contained && styles.contained, ownerState.filled && styles.filled];
  }
})(({
  theme,
  ownerState
  ...
  marginBottom: 0,
  marginLeft: 0,
  [`&.${formHelperTextClasses["default"].disabled}`]: {
    color: (theme.vars || theme).palette.text.disabled
  },
  [`&.${formHelperTextClasses["default"].error}`]: {
...
const FormHelperText = /*#__PURE__*/React__namespace.forwardRef(function FormHelperText(inProps, ref) {
  ...
  return /*#__PURE__*/jsxRuntime.jsx(FormHelperTextRoot, _extends["default"]({
    as: component,
