...
var drawerClasses = require('./drawerClasses.js');
...
const useUtilityClasses = ownerState => {
  ...
  const slots = {
    ...
    modal: ['modal'],
    paper: ['paper', `paperAnchor${capitalize["default"](anchor)}`, variant !== 'temporary' && `paperAnchorDocked${capitalize["default"](anchor)}`]
  };
  return composeClasses["default"](slots, drawerClasses.getDrawerUtilityClass, classes);
};
const DrawerRoot = styled["default"](Modal["default"], {
  name: 'MuiDrawer',
  slot: 'Root',
  overridesResolver
})(({
...
const DrawerDockedRoot = styled["default"]('div', {
...
const DrawerPaper = styled["default"](Paper["default"], {
  name: 'MuiDrawer',
  slot: 'Paper',
  overridesResolver: (props, styles) => {
    ...
    return [styles.paper, styles[`paperAnchor${capitalize["default"](ownerState.anchor)}`], ownerState.variant !== 'temporary' && styles[`paperAnchorDocked${capitalize["default"](ownerState.anchor)}`]];
  }
})(({
  theme,
  ownerState
...
const Drawer = /*#__PURE__*/React__namespace.forwardRef(function Drawer(inProps, ref) {
  ...
  const {
    ...
    ModalProps = objectWithoutPropertiesLoose["default"](props.ModalProps, _excluded),
  ...
  const drawer = /*#__PURE__*/jsxRuntime.jsx(DrawerPaper, _extends["default"]({
  ...
  if (variant === 'permanent') {
    return /*#__PURE__*/jsxRuntime.jsx(DrawerDockedRoot, _extends["default"]({
      className: clsx_m.clsx(classes.root, classes.docked, className),
      ownerState: ownerState,
      ref: ref
    }, other, {
      children: drawer
  ...
  const slidingDrawer = /*#__PURE__*/jsxRuntime.jsx(TransitionComponent, _extends["default"]({
    in: open,
  ...
  // variant === temporary
  return /*#__PURE__*/jsxRuntime.jsx(DrawerRoot, _extends["default"]({
    BackdropProps: _extends["default"]({}, BackdropProps, BackdropPropsProp, {
      transitionDuration
    }),
    className: clsx_m.clsx(classes.root, classes.modal, className),
    open: open,
    ownerState: ownerState,
    onClose: onClose,
...
process.env.NODE_ENV !== "production" ? Drawer.propTypes /* remove-proptypes */ = {
   ...
   * @default {}
   */
  ModalProps: PropTypes__default["default"].object,
  /**
   ...
   */
  SlideProps: PropTypes__default["default"].object,
  /**
