...
var popoverClasses = require('./popoverClasses.js');
...
const useUtilityClasses = ownerState => {
  ...
  return composeClasses["default"](slots, popoverClasses.getPopoverUtilityClass, classes);
};
const PopoverRoot = styled["default"](Modal["default"], {
  name: 'MuiPopover',
  slot: 'Root',
  overridesResolver: (props, styles) => styles.root
})({});
const PopoverPaper = styled["default"](Paper["default"], {
  name: 'MuiPopover',
  slot: 'Paper',
...
const Popover = /*#__PURE__*/React__namespace.forwardRef(function Popover(inProps, ref) {
  ...
  const {
    ...
    TransitionProps = objectWithoutPropertiesLoose["default"](props.TransitionProps, _excluded),
    other = objectWithoutPropertiesLoose["default"](props, _excluded2);
  const paperRef = React__namespace.useRef();
  const handlePaperRef = useForkRef["default"](paperRef, PaperProps.ref);
  ...
  const getAnchorOffset = React__namespace.useCallback(() => {
    ...
    const anchorElement = resolvedAnchorEl && resolvedAnchorEl.nodeType === 1 ? resolvedAnchorEl : ownerDocument["default"](paperRef.current).body;
  ...
  const getPositioningStyle = React__namespace.useCallback(element => {
    ...
    const containerWindow = ownerWindow["default"](resolveAnchorEl(anchorEl));
  ...
  React__namespace.useEffect(() => {
    ...
    const containerWindow = ownerWindow["default"](anchorEl);
  ...
  const container = containerProp || (anchorEl ? ownerDocument["default"](resolveAnchorEl(anchorEl)).body : undefined);
  return /*#__PURE__*/jsxRuntime.jsx(PopoverRoot, _extends["default"]({
    BackdropProps: {
      invisible: true
    },
    ...
    children: /*#__PURE__*/jsxRuntime.jsx(TransitionComponent, _extends["default"]({
      appear: true,
      in: open,
      ...
      children: /*#__PURE__*/jsxRuntime.jsx(PopoverPaper, _extends["default"]({
        elevation: elevation
      }, PaperProps, {
        ref: handlePaperRef,
        className: clsx_m.clsx(classes.paper, PaperProps.className)
      }, isPositioned ? undefined : {
        style: _extends["default"]({}, PaperProps.style, {
          opacity: 0
        })
      }, {
        ownerState: ownerState,
...
process.env.NODE_ENV !== "production" ? Popover.propTypes /* remove-proptypes */ = {
   ...
   */
  anchorEl: chainPropTypes["default"](PropTypes__default["default"].oneOfType([HTMLElementType["default"], PropTypes__default["default"].func]), props => {
   ...
   * }
   */
  anchorOrigin: PropTypes__default["default"].shape({
    horizontal: PropTypes__default["default"].oneOfType([PropTypes__default["default"].oneOf(['center', 'left', 'right']), PropTypes__default["default"].number]).isRequired,
    vertical: PropTypes__default["default"].oneOfType([PropTypes__default["default"].oneOf(['bottom', 'center', 'top']), PropTypes__default["default"].number]).isRequired
  }),
  /**
   * This is the position that may be used to set the position of the popover.
   * The coordinates are relative to the application's client area.
   */
  anchorPosition: PropTypes__default["default"].shape({
   ...
   * @default 'anchorEl'
   */
  anchorReference: PropTypes__default["default"].oneOf(['anchorEl', 'anchorPosition', 'none']),
  /**
   ...
   * @default 16
   */
  marginThreshold: PropTypes__default["default"].number,
  /**
   ...
   * }
   */
  transformOrigin: PropTypes__default["default"].shape({
    horizontal: PropTypes__default["default"].oneOfType([PropTypes__default["default"].oneOf(['center', 'left', 'right']), PropTypes__default["default"].number]).isRequired,
    vertical: PropTypes__default["default"].oneOfType([PropTypes__default["default"].oneOf(['bottom', 'center', 'top']), PropTypes__default["default"].number]).isRequired
  }),
  /**
   ...
   * @default 'auto'
   */
  transitionDuration: PropTypes__default["default"].oneOfType([PropTypes__default["default"].oneOf(['auto']), PropTypes__default["default"].number, PropTypes__default["default"].shape({
