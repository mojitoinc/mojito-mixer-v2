...
var getThemeProps = require('../../system/esm/useThemeProps/getThemeProps.js');
...
var useMediaQuery = require('../useMediaQuery/useMediaQuery.js');
...
const withWidth = (options = {}) => Component => {
  ...
  function WithWidth(props) {
    const contextTheme = useTheme["default"]();
    const theme = props.theme || contextTheme;
    const _getThemeProps = getThemeProps["default"]({
        theme,
        name: 'MuiWithWidth',
        props
      }),
      ...
      other = objectWithoutPropertiesLoose["default"](_getThemeProps, _excluded);
    ...
    const widthComputed = keys.reduce((output, key) => {
      ...
      const matches = useMediaQuery["default"](theme.breakpoints.up(key));
      return !output && matches ? key : output;
    }, null);
    const more = _extends["default"]({
    ...
    return /*#__PURE__*/jsxRuntime.jsx(Component, _extends["default"]({}, more));
  }
  process.env.NODE_ENV !== "production" ? WithWidth.propTypes = {
     ...
     */
    width: PropTypes__default["default"].oneOf(['xs', 'sm', 'md', 'lg', 'xl'])
  } : void 0;
  if (process.env.NODE_ENV !== 'production') {
    WithWidth.displayName = `WithWidth(${getDisplayName["default"](Component)})`;
  }
  return WithWidth;
};
