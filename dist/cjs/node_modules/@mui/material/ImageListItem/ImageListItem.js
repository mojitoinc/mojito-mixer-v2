...
var ImageListContext = require('../ImageList/ImageListContext.js');
var styled = require('../styles/styled.js');
var useThemeProps = require('../styles/useThemeProps.js');
var imageListItemClasses = require('./imageListItemClasses.js');
...
const useUtilityClasses = ownerState => {
  ...
  return composeClasses["default"](slots, imageListItemClasses.getImageListItemUtilityClass, classes);
};
const ImageListItemRoot = styled["default"]('li', {
  ...
  overridesResolver: (props, styles) => {
    ...
    return [{
      [`& .${imageListItemClasses["default"].img}`]: styles.img
  ...
  [`& .${imageListItemClasses["default"].img}`]: _extends["default"]({
    objectFit: 'cover',
    width: '100%',
    height: '100%',
    display: 'block'
...
const ImageListItem = /*#__PURE__*/React__namespace.forwardRef(function ImageListItem(inProps, ref) {
  ...
  const {
    ...
    gap,
    variant
  } = React__namespace.useContext(ImageListContext["default"]);
  let height = 'auto';
  if (variant === 'woven') {
    height = undefined;
  ...
  return /*#__PURE__*/jsxRuntime.jsx(ImageListItemRoot, _extends["default"]({
    as: component,
    ...
    children: React__namespace.Children.map(children, child => {
      ...
      if (child.type === 'img' || isMuiElement["default"](child, ['Image'])) {
        return /*#__PURE__*/React__namespace.cloneElement(child, {
          className: clsx_m.clsx(classes.img, child.props.className)
        });
      }
      return child;
    })
