...
var tableRowClasses = require('./tableRowClasses.js');
...
const useUtilityClasses = ownerState => {
  ...
  return composeClasses["default"](slots, tableRowClasses.getTableRowUtilityClass, classes);
};
const TableRowRoot = styled["default"]('tr', {
  name: 'MuiTableRow',
  slot: 'Root',
  ...
  outline: 0,
  [`&.${tableRowClasses["default"].hover}:hover`]: {
...
const TableRow = /*#__PURE__*/React__namespace.forwardRef(function TableRow(inProps, ref) {
  ...
  return /*#__PURE__*/jsxRuntime.jsx(TableRowRoot, _extends["default"]({
    as: component,
    ref: ref,
