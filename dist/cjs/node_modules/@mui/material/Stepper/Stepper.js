...
var stepperClasses = require('./stepperClasses.js');
var StepConnector = require('../StepConnector/StepConnector.js');
require('../StepConnector/stepConnectorClasses.js');
...
const useUtilityClasses = ownerState => {
  ...
  return composeClasses["default"](slots, stepperClasses.getStepperUtilityClass, classes);
};
const StepperRoot = styled["default"]('div', {
  name: 'MuiStepper',
  slot: 'Root',
...
const defaultConnector = /*#__PURE__*/jsxRuntime.jsx(StepConnector["default"], {});
const Stepper = /*#__PURE__*/React__namespace.forwardRef(function Stepper(inProps, ref) {
  ...
  const steps = childrenArray.map((step, index) => {
    return /*#__PURE__*/React__namespace.cloneElement(step, _extends["default"]({
      index,
  ...
  return /*#__PURE__*/jsxRuntime.jsx(StepperContext["default"].Provider, {
    value: contextValue,
    children: /*#__PURE__*/jsxRuntime.jsx(StepperRoot, _extends["default"]({
      as: component,
...
process.env.NODE_ENV !== "production" ? Stepper.propTypes /* remove-proptypes */ = {
   ...
   * @default false
   */
  alternativeLabel: PropTypes__default["default"].bool,
  /**
   ...
   */
  connector: PropTypes__default["default"].element,
  /**
