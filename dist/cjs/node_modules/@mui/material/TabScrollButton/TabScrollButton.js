...
var tabScrollButtonClasses = require('./tabScrollButtonClasses.js');
...
const useUtilityClasses = ownerState => {
  ...
  return composeClasses["default"](slots, tabScrollButtonClasses.getTabScrollButtonUtilityClass, classes);
};
const TabScrollButtonRoot = styled["default"](ButtonBase["default"], {
  ...
  flexShrink: 0,
  opacity: 0.8,
  [`&.${tabScrollButtonClasses["default"].disabled}`]: {
    opacity: 0
  }
...
const TabScrollButton = /*#__PURE__*/React__namespace.forwardRef(function TabScrollButton(inProps, ref) {
  ...
  const ownerState = _extends["default"]({
    isRtl
  }, props);
  const classes = useUtilityClasses(ownerState);
  return /*#__PURE__*/jsxRuntime.jsx(TabScrollButtonRoot, _extends["default"]({
    component: "div",
    ...
    children: direction === 'left' ? _KeyboardArrowLeft || (_KeyboardArrowLeft = /*#__PURE__*/jsxRuntime.jsx(KeyboardArrowLeft["default"], {
      fontSize: "small"
    })) : _KeyboardArrowRight || (_KeyboardArrowRight = /*#__PURE__*/jsxRuntime.jsx(KeyboardArrowRight["default"], {
      fontSize: "small"
    }))
  }));
});
process.env.NODE_ENV !== "production" ? TabScrollButton.propTypes /* remove-proptypes */ = {
   ...
   */
  direction: PropTypes__default["default"].oneOf(['left', 'right']).isRequired,
  /**
   ...
   */
  orientation: PropTypes__default["default"].oneOf(['horizontal', 'vertical']).isRequired,
  /**
