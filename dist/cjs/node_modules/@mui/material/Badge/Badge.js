...
var usePreviousProps = require('../../utils/esm/usePreviousProps.js');
...
var useBadge = require('../../base/BadgeUnstyled/useBadge.js');
require('../../base/BadgeUnstyled/badgeUnstyledClasses.js');
var useSlotProps = require('../../base/utils/useSlotProps.js');
...
var badgeClasses = require('./badgeClasses.js');
...
const useUtilityClasses = ownerState => {
  ...
  const slots = {
    root: ['root'],
    badge: ['badge', variant, invisible && 'invisible', `anchorOrigin${capitalize["default"](anchorOrigin.vertical)}${capitalize["default"](anchorOrigin.horizontal)}`, `anchorOrigin${capitalize["default"](anchorOrigin.vertical)}${capitalize["default"](anchorOrigin.horizontal)}${capitalize["default"](overlap)}`, `overlap${capitalize["default"](overlap)}`, color !== 'default' && `color${capitalize["default"](color)}`]
  };
  return composeClasses["default"](slots, badgeClasses.getBadgeUtilityClass, classes);
};
const BadgeRoot = styled["default"]('span', {
  name: 'MuiBadge',
  slot: 'Root',
...
const BadgeBadge = styled["default"]('span', {
  name: 'MuiBadge',
  slot: 'Badge',
  overridesResolver: (props, styles) => {
    ...
    return [styles.badge, styles[ownerState.variant], styles[`anchorOrigin${capitalize["default"](ownerState.anchorOrigin.vertical)}${capitalize["default"](ownerState.anchorOrigin.horizontal)}${capitalize["default"](ownerState.overlap)}`], ownerState.color !== 'default' && styles[`color${capitalize["default"](ownerState.color)}`], ownerState.invisible && styles.invisible];
  }
})(({
  theme,
  ownerState
  ...
  [`&.${badgeClasses["default"].invisible}`]: {
...
const Badge = /*#__PURE__*/React__namespace.forwardRef(function Badge(inProps, ref) {
  ...
  const prevProps = usePreviousProps["default"]({
    anchorOrigin: anchorOriginProp,
    color: colorProp,
    overlap: overlapProp,
    variant: variantProp,
  ...
  const rootProps = useSlotProps["default"]({
    ...
    ownerState,
    className: clsx_m.clsx(rootSlotProps == null ? void 0 : rootSlotProps.className, classes.root, className)
  });
  const badgeProps = useSlotProps["default"]({
    elementType: BadgeSlot,
    externalSlotProps: badgeSlotProps,
    ownerState,
    className: clsx_m.clsx(classes.badge, badgeSlotProps == null ? void 0 : badgeSlotProps.className)
  });
  return /*#__PURE__*/jsxRuntime.jsxs(RootSlot, _extends["default"]({}, rootProps, {
    children: [children, /*#__PURE__*/jsxRuntime.jsx(BadgeSlot, _extends["default"]({}, badgeProps, {
...
process.env.NODE_ENV !== "production" ? Badge.propTypes /* remove-proptypes */ = {
  ...
  anchorOrigin: PropTypes__default["default"].shape({
    horizontal: PropTypes__default["default"].oneOf(['left', 'right']).isRequired,
    vertical: PropTypes__default["default"].oneOf(['bottom', 'top']).isRequired
  }),
  /**
   ...
   * @default 'rectangular'
   */
  overlap: PropTypes__default["default"].oneOf(['circular', 'rectangular']),
  /**
   ...
   * @default 'standard'
   */
  variant: PropTypes__default["default"] /* @typescript-to-proptypes-ignore */.oneOfType([PropTypes__default["default"].oneOf(['dot', 'standard']), PropTypes__default["default"].string])
} : void 0;
