...
var appendOwnerState = require('../../base/utils/appendOwnerState.js');
...
var Grow = require('../Grow/Grow.js');
var Popper = require('../Popper/Popper.js');
var tooltipClasses = require('./tooltipClasses.js');
...
const useUtilityClasses = ownerState => {
  ...
  const slots = {
    ...
    tooltip: ['tooltip', arrow && 'tooltipArrow', touch && 'touch', `tooltipPlacement${capitalize["default"](placement.split('-')[0])}`],
    arrow: ['arrow']
  };
  return composeClasses["default"](slots, tooltipClasses.getTooltipUtilityClass, classes);
};
const TooltipPopper = styled["default"](Popper["default"], {
  name: 'MuiTooltip',
  slot: 'Popper',
  ...
  [`&[data-popper-placement*="bottom"] .${tooltipClasses["default"].arrow}`]: {
    top: 0,
    marginTop: '-0.71em',
    '&::before': {
  ...
  [`&[data-popper-placement*="top"] .${tooltipClasses["default"].arrow}`]: {
    bottom: 0,
    marginBottom: '-0.71em',
    '&::before': {
  ...
  [`&[data-popper-placement*="right"] .${tooltipClasses["default"].arrow}`]: _extends["default"]({}, !ownerState.isRtl ? {
    left: 0,
    marginLeft: '-0.71em'
  } : {
    right: 0,
  ...
  [`&[data-popper-placement*="left"] .${tooltipClasses["default"].arrow}`]: _extends["default"]({}, !ownerState.isRtl ? {
    right: 0,
    marginRight: '-0.71em'
  } : {
    left: 0,
...
const TooltipTooltip = styled["default"]('div', {
  name: 'MuiTooltip',
  slot: 'Tooltip',
  overridesResolver: (props, styles) => {
    const {
    ...
    return [styles.tooltip, ownerState.touch && styles.touch, ownerState.arrow && styles.tooltipArrow, styles[`tooltipPlacement${capitalize["default"](ownerState.placement.split('-')[0])}`]];
  }
})(({
  theme,
  ownerState
}) => _extends["default"]({
  backgroundColor: theme.vars ? theme.vars.palette.Tooltip.bg : colorManipulator.alpha(theme.palette.grey[700], 0.92),
  ...
  [`.${tooltipClasses["default"].popper}[data-popper-placement*="left"] &`]: _extends["default"]({
    transformOrigin: 'right center'
  }, !ownerState.isRtl ? _extends["default"]({
    marginRight: '14px'
  }, ownerState.touch && {
    marginRight: '24px'
  }) : _extends["default"]({
  ...
  [`.${tooltipClasses["default"].popper}[data-popper-placement*="right"] &`]: _extends["default"]({
  ...
  [`.${tooltipClasses["default"].popper}[data-popper-placement*="top"] &`]: _extends["default"]({
    transformOrigin: 'center bottom',
    marginBottom: '14px'
  }, ownerState.touch && {
    marginBottom: '24px'
  }),
  [`.${tooltipClasses["default"].popper}[data-popper-placement*="bottom"] &`]: _extends["default"]({
...
const TooltipArrow = styled["default"]('span', {
  name: 'MuiTooltip',
  slot: 'Arrow',
  ...
  color: theme.vars ? theme.vars.palette.Tooltip.bg : colorManipulator.alpha(theme.palette.grey[700], 0.9),
  '&::before': {
    content: '""',
    margin: 'auto',
    display: 'block',
...
const Tooltip = /*#__PURE__*/React__namespace.forwardRef(function Tooltip(inProps, ref) {
  ...
  const [openState, setOpenState] = useControlled["default"]({
    controlled: openProp,
    default: false,
    name: 'Tooltip',
    state: 'open'
  ...
  const handleClose = useEventCallback["default"](
  /**
  ...
  const handleRef = useForkRef["default"](children.ref, focusVisibleRef, setChildNode, ref);
  ...
  const childrenProps = _extends["default"]({}, nameOrDescProps, other, children.props, {
    className: clsx_m.clsx(other.className, children.props.className),
  ...
  const popperOptions = React__namespace.useMemo(() => {
    ...
    return _extends["default"]({}, PopperProps.popperOptions, {
  ...
  const TransitionComponent = (_ref2 = (_ref3 = (_slots$transition = slots.transition) != null ? _slots$transition : components.Transition) != null ? _ref3 : TransitionComponentProp) != null ? _ref2 : Grow["default"];
  const TooltipComponent = (_ref4 = (_slots$tooltip = slots.tooltip) != null ? _slots$tooltip : components.Tooltip) != null ? _ref4 : TooltipTooltip;
  const ArrowComponent = (_ref5 = (_slots$arrow = slots.arrow) != null ? _slots$arrow : components.Arrow) != null ? _ref5 : TooltipArrow;
  const popperProps = appendOwnerState["default"](PopperComponent, _extends["default"]({}, PopperProps, (_slotProps$popper = slotProps.popper) != null ? _slotProps$popper : componentsProps.popper, {
    className: clsx_m.clsx(classes.popper, PopperProps == null ? void 0 : PopperProps.className, (_ref6 = (_slotProps$popper2 = slotProps.popper) != null ? _slotProps$popper2 : componentsProps.popper) == null ? void 0 : _ref6.className)
  }), ownerState);
  const transitionProps = appendOwnerState["default"](TransitionComponent, _extends["default"]({}, TransitionProps, (_slotProps$transition = slotProps.transition) != null ? _slotProps$transition : componentsProps.transition), ownerState);
  const tooltipProps = appendOwnerState["default"](TooltipComponent, _extends["default"]({}, (_slotProps$tooltip = slotProps.tooltip) != null ? _slotProps$tooltip : componentsProps.tooltip, {
    className: clsx_m.clsx(classes.tooltip, (_ref7 = (_slotProps$tooltip2 = slotProps.tooltip) != null ? _slotProps$tooltip2 : componentsProps.tooltip) == null ? void 0 : _ref7.className)
  }), ownerState);
  const tooltipArrowProps = appendOwnerState["default"](ArrowComponent, _extends["default"]({}, (_slotProps$arrow = slotProps.arrow) != null ? _slotProps$arrow : componentsProps.arrow, {
    className: clsx_m.clsx(classes.arrow, (_ref8 = (_slotProps$arrow2 = slotProps.arrow) != null ? _slotProps$arrow2 : componentsProps.arrow) == null ? void 0 : _ref8.className)
  }), ownerState);
  return /*#__PURE__*/jsxRuntime.jsxs(React__namespace.Fragment, {
    children: [/*#__PURE__*/React__namespace.cloneElement(children, childrenProps), /*#__PURE__*/jsxRuntime.jsx(PopperComponent, _extends["default"]({
      ...
      }) => /*#__PURE__*/jsxRuntime.jsx(TransitionComponent, _extends["default"]({
        timeout: theme.transitions.duration.shorter
      }, TransitionPropsInner, transitionProps, {
        children: /*#__PURE__*/jsxRuntime.jsxs(TooltipComponent, _extends["default"]({}, tooltipProps, {
          children: [title, arrow ? /*#__PURE__*/jsxRuntime.jsx(ArrowComponent, _extends["default"]({}, tooltipArrowProps, {
            ref: setArrowRef
          })) : null]
        }))
      }))
...
process.env.NODE_ENV !== "production" ? Tooltip.propTypes /* remove-proptypes */ = {
  ...
  components: PropTypes__default["default"].shape({
    Arrow: PropTypes__default["default"].elementType,
    Popper: PropTypes__default["default"].elementType,
    Tooltip: PropTypes__default["default"].elementType,
  ...
  componentsProps: PropTypes__default["default"].shape({
    arrow: PropTypes__default["default"].object,
    popper: PropTypes__default["default"].object,
    tooltip: PropTypes__default["default"].object,
    transition: PropTypes__default["default"].object
  }),
  /**
   ...
   * @default false
   */
  describeChild: PropTypes__default["default"].bool,
  /**
   * Do not respond to focus-visible events.
   * @default false
   */
  disableFocusListener: PropTypes__default["default"].bool,
  /**
   * Do not respond to hover events.
   * @default false
   */
  disableHoverListener: PropTypes__default["default"].bool,
  /**
   * Makes a tooltip not interactive, i.e. it will close when the user
   * hovers over the tooltip before the `leaveDelay` is expired.
   * @default false
   */
  disableInteractive: PropTypes__default["default"].bool,
  /**
   * Do not respond to long press touch events.
   * @default false
   */
  disableTouchListener: PropTypes__default["default"].bool,
  /**
   * The number of milliseconds to wait before showing the tooltip.
   * This prop won't impact the enter touch delay (`enterTouchDelay`).
   * @default 100
   */
  enterDelay: PropTypes__default["default"].number,
  /**
   * The number of milliseconds to wait before showing the tooltip when one was already recently opened.
   * @default 0
   */
  enterNextDelay: PropTypes__default["default"].number,
  /**
   * The number of milliseconds a user must touch the element before showing the tooltip.
   * @default 700
   */
  enterTouchDelay: PropTypes__default["default"].number,
  /**
   * If `true`, the tooltip follow the cursor over the wrapped element.
   * @default false
   */
  followCursor: PropTypes__default["default"].bool,
  /**
   ...
   * @default 0
   */
  leaveDelay: PropTypes__default["default"].number,
  /**
   * The number of milliseconds after the user stops touching an element before hiding the tooltip.
   * @default 1500
   */
  leaveTouchDelay: PropTypes__default["default"].number,
  /**
   ...
   * @default 'bottom'
   */
  placement: PropTypes__default["default"].oneOf(['bottom-end', 'bottom-start', 'bottom', 'left-end', 'left-start', 'left', 'right-end', 'right-start', 'right', 'top-end', 'top-start', 'top']),
  /**
   ...
   * @default Grow
   */
  TransitionComponent: PropTypes__default["default"].elementType,
  /**
   * Props applied to the transition element.
   * By default, the element is based on this [`Transition`](http://reactcommunity.org/react-transition-group/transition/) component.
   */
  TransitionProps: PropTypes__default["default"].object
} : void 0;
