...
var style = require('../../system/esm/style.js');
...
const getTextDecoration = ({
  ...
  const color = style.getPath(theme, `palette.${transformedColor}`, false) || ownerState.color;
  const channelColor = style.getPath(theme, `palette.${transformedColor}Channel`);
  if ('vars' in theme && channelColor) {
    return `rgba(${channelColor} / 0.4)`;
  }
  return colorManipulator.alpha(color, 0.4);
};

exports.colorTransformations = colorTransformations;
exports["default"] = getTextDecoration;
