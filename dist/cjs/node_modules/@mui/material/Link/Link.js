...
var linkClasses = require('./linkClasses.js');
var getTextDecoration = require('./getTextDecoration.js');
...
const useUtilityClasses = ownerState => {
  ...
  const slots = {
    root: ['root', `underline${capitalize["default"](underline)}`, component === 'button' && 'button', focusVisible && 'focusVisible']
  };
  return composeClasses["default"](slots, linkClasses.getLinkUtilityClass, classes);
};
const LinkRoot = styled["default"](Typography["default"], {
  name: 'MuiLink',
  slot: 'Root',
  overridesResolver: (props, styles) => {
    ...
    return [styles.root, styles[`underline${capitalize["default"](ownerState.underline)}`], ownerState.component === 'button' && styles.button];
  }
})(({
  theme,
  ownerState
}) => {
  return _extends["default"]({}, ownerState.underline === 'none' && {
    textDecoration: 'none'
  ...
  }, ownerState.underline === 'always' && _extends["default"]({
    textDecoration: 'underline'
  }, ownerState.color !== 'inherit' && {
    textDecorationColor: getTextDecoration["default"]({
      theme,
      ownerState
    })
  }, {
    ...
    [`&.${linkClasses["default"].focusVisible}`]: {
      outline: 'auto'
    }
  });
});
const Link = /*#__PURE__*/React__namespace.forwardRef(function Link(inProps, ref) {
  ...
  const handlerRef = useForkRef["default"](ref, focusVisibleRef);
  ...
  return /*#__PURE__*/jsxRuntime.jsx(LinkRoot, _extends["default"]({
    color: color,
    ...
    variant: variant,
    sx: [...(!Object.keys(getTextDecoration.colorTransformations).includes(color) ? [{
      color
...
process.env.NODE_ENV !== "production" ? Link.propTypes /* remove-proptypes */ = {
   ...
   * @default 'primary'
   */
  color: PropTypes__default["default"] /* @typescript-to-proptypes-ignore */.any,
  /**
   ...
   */
  TypographyClasses: PropTypes__default["default"].object,
  /**
   * Controls when the link should have an underline.
   * @default 'always'
   */
  underline: PropTypes__default["default"].oneOf(['always', 'hover', 'none']),
  /**
