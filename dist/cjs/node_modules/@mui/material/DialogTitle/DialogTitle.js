...
var dialogTitleClasses = require('./dialogTitleClasses.js');
...
const useUtilityClasses = ownerState => {
  ...
  return composeClasses["default"](slots, dialogTitleClasses.getDialogTitleUtilityClass, classes);
};
const DialogTitleRoot = styled["default"](Typography["default"], {
  name: 'MuiDialogTitle',
  slot: 'Root',
...
const DialogTitle = /*#__PURE__*/React__namespace.forwardRef(function DialogTitle(inProps, ref) {
  ...
  const {
    titleId: id = idProp
  } = React__namespace.useContext(DialogContext["default"]);
  return /*#__PURE__*/jsxRuntime.jsx(DialogTitleRoot, _extends["default"]({
    component: "h2",
