...
var switchClasses = require('./switchClasses.js');
...
const useUtilityClasses = ownerState => {
  ...
  const slots = {
    root: ['root', edge && `edge${capitalize["default"](edge)}`, `size${capitalize["default"](size)}`],
    switchBase: ['switchBase', `color${capitalize["default"](color)}`, checked && 'checked', disabled && 'disabled'],
    thumb: ['thumb'],
    track: ['track'],
    input: ['input']
  };
  const composedClasses = composeClasses["default"](slots, switchClasses.getSwitchUtilityClass, classes);
  return _extends["default"]({}, classes, composedClasses);
};
const SwitchRoot = styled["default"]('span', {
  name: 'MuiSwitch',
  slot: 'Root',
  overridesResolver: (props, styles) => {
    ...
    return [styles.root, ownerState.edge && styles[`edge${capitalize["default"](ownerState.edge)}`], styles[`size${capitalize["default"](ownerState.size)}`]];
  }
})(({
  ownerState
}) => _extends["default"]({
  ...
  height: 24,
  padding: 7,
  [`& .${switchClasses["default"].thumb}`]: {
    width: 16,
    height: 16
  },
  [`& .${switchClasses["default"].switchBase}`]: {
    padding: 4,
    [`&.${switchClasses["default"].checked}`]: {
      transform: 'translateX(16px)'
    }
  }
}));
const SwitchSwitchBase = styled["default"](SwitchBase["default"], {
  name: 'MuiSwitch',
  slot: 'SwitchBase',
  overridesResolver: (props, styles) => {
    const {
    ...
    return [styles.switchBase, {
      [`& .${switchClasses["default"].input}`]: styles.input
    }, ownerState.color !== 'default' && styles[`color${capitalize["default"](ownerState.color)}`]];
  }
})(({
  theme
}) => ({
  ...
  [`&.${switchClasses["default"].disabled}`]: {
    color: theme.vars ? theme.vars.palette.Switch.defaultDisabledColor : `${theme.palette.mode === 'light' ? theme.palette.grey[100] : theme.palette.grey[600]}`
  },
  [`&.${switchClasses["default"].checked} + .${switchClasses["default"].track}`]: {
    opacity: 0.5
  },
  [`&.${switchClasses["default"].disabled} + .${switchClasses["default"].track}`]: {
    opacity: theme.vars ? theme.vars.opacity.switchTrackDisabled : `${theme.palette.mode === 'light' ? 0.12 : 0.2}`
  },
  [`& .${switchClasses["default"].input}`]: {
    left: '-100%',
    width: '300%'
  }
}), ({
  ...
  '&:hover': {
    backgroundColor: theme.vars ? `rgba(${theme.vars.palette.action.activeChannel} / ${theme.vars.palette.action.hoverOpacity})` : colorManipulator.alpha(theme.palette.action.active, theme.palette.action.hoverOpacity),
  ...
  [`&.${switchClasses["default"].checked}`]: {
    ...
    [`&.${switchClasses["default"].disabled}`]: {
      color: theme.vars ? theme.vars.palette.Switch[`${ownerState.color}DisabledColor`] : `${theme.palette.mode === 'light' ? colorManipulator.lighten(theme.palette[ownerState.color].main, 0.62) : colorManipulator.darken(theme.palette[ownerState.color].main, 0.55)}`
    }
  },
  [`&.${switchClasses["default"].checked} + .${switchClasses["default"].track}`]: {
...
const SwitchTrack = styled["default"]('span', {
  name: 'MuiSwitch',
  slot: 'Track',
...
const SwitchThumb = styled["default"]('span', {
  name: 'MuiSwitch',
  slot: 'Thumb',
...
const Switch = /*#__PURE__*/React__namespace.forwardRef(function Switch(inProps, ref) {
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(SwitchRoot, {
    ...
    sx: sx,
    ownerState: ownerState,
    children: [/*#__PURE__*/jsxRuntime.jsx(SwitchSwitchBase, _extends["default"]({
      type: "checkbox",
      icon: icon,
      checkedIcon: icon,
      ref: ref,
      ...
      classes: _extends["default"]({}, classes, {
...
process.env.NODE_ENV !== "production" ? Switch.propTypes /* remove-proptypes */ = {
   ...
   */
  checkedIcon: PropTypes__default["default"].node,
  /**
