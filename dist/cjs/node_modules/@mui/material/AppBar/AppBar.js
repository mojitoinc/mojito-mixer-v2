...
var appBarClasses = require('./appBarClasses.js');
...
const useUtilityClasses = ownerState => {
  ...
  const slots = {
    root: ['root', `color${capitalize["default"](color)}`, `position${capitalize["default"](position)}`]
  };
  return composeClasses["default"](slots, appBarClasses.getAppBarUtilityClass, classes);
};

// var2 is the fallback.
// Ex. var1: 'var(--a)', var2: 'var(--b)'; return: 'var(--a, var(--b))'
const joinVars = (var1, var2) => var1 ? `${var1 == null ? void 0 : var1.replace(')', '')}, ${var2})` : var2;
const AppBarRoot = styled["default"](Paper["default"], {
  name: 'MuiAppBar',
  slot: 'Root',
  overridesResolver: (props, styles) => {
    ...
    return [styles.root, styles[`position${capitalize["default"](ownerState.position)}`], styles[`color${capitalize["default"](ownerState.color)}`]];
  }
})(({
  theme,
  ownerState
  ...
  return _extends["default"]({
    ...
    position: 'relative'
  }, !theme.vars && _extends["default"]({}, ownerState.color === 'default' && {
    ...
    color: null
  }, ownerState.color === 'transparent' && _extends["default"]({
...
const AppBar = /*#__PURE__*/React__namespace.forwardRef(function AppBar(inProps, ref) {
  ...
  return /*#__PURE__*/jsxRuntime.jsx(AppBarRoot, _extends["default"]({
    square: true,
    component: "header",
    ownerState: ownerState,
    elevation: 4,
    className: clsx_m.clsx(classes.root, className, position === 'fixed' && 'mui-fixed'),
    ref: ref
  }, other));
});
process.env.NODE_ENV !== "production" ? AppBar.propTypes /* remove-proptypes */ = {
   ...
   * @default 'primary'
   */
  color: PropTypes__default["default"] /* @typescript-to-proptypes-ignore */.oneOfType([PropTypes__default["default"].oneOf(['default', 'inherit', 'primary', 'secondary', 'transparent']), PropTypes__default["default"].string]),
  /**
   * If true, the `color` prop is applied in dark mode.
   * @default false
   */
  enableColorOnDark: PropTypes__default["default"].bool,
  /**
   ...
   * @default 'fixed'
   */
  position: PropTypes__default["default"].oneOf(['absolute', 'fixed', 'relative', 'static', 'sticky']),
  /**
