...
var getOverlayAlpha = require('../styles/getOverlayAlpha.js');
var useThemeProps = require('../styles/useThemeProps.js');
var useTheme = require('../styles/useTheme.js');
var paperClasses = require('./paperClasses.js');
...
const useUtilityClasses = ownerState => {
  ...
  return composeClasses["default"](slots, paperClasses.getPaperUtilityClass, classes);
};
const PaperRoot = styled["default"]('div', {
  name: 'MuiPaper',
  slot: 'Root',
  ...
  }, ownerState.variant === 'elevation' && _extends["default"]({
    boxShadow: (theme.vars || theme).shadows[ownerState.elevation]
  }, !theme.vars && theme.palette.mode === 'dark' && {
    backgroundImage: `linear-gradient(${colorManipulator.alpha('#fff', getOverlayAlpha["default"](ownerState.elevation))}, ${colorManipulator.alpha('#fff', getOverlayAlpha["default"](ownerState.elevation))})`
  }, theme.vars && {
...
const Paper = /*#__PURE__*/React__namespace.forwardRef(function Paper(inProps, ref) {
  ...
  return /*#__PURE__*/jsxRuntime.jsx(PaperRoot, _extends["default"]({
    as: component,
...
process.env.NODE_ENV !== "production" ? Paper.propTypes /* remove-proptypes */ = {
   ...
   * @default 1
   */
  elevation: chainPropTypes["default"](integerPropType["default"], props => {
    const {
      elevation,
      variant
    } = props;
   ...
   * @default 'elevation'
   */
  variant: PropTypes__default["default"] /* @typescript-to-proptypes-ignore */.oneOfType([PropTypes__default["default"].oneOf(['elevation', 'outlined']), PropTypes__default["default"].string])
} : void 0;
