...
var stepConnectorClasses = require('./stepConnectorClasses.js');
...
const useUtilityClasses = ownerState => {
  ...
  const slots = {
    ...
    line: ['line', `line${capitalize["default"](orientation)}`]
  };
  return composeClasses["default"](slots, stepConnectorClasses.getStepConnectorUtilityClass, classes);
};
const StepConnectorRoot = styled["default"]('div', {
...
const StepConnectorLine = styled["default"]('span', {
  name: 'MuiStepConnector',
  slot: 'Line',
  overridesResolver: (props, styles) => {
    const {
    ...
    return [styles.line, styles[`line${capitalize["default"](ownerState.orientation)}`]];
  }
})(({
  ownerState,
  theme
...
const StepConnector = /*#__PURE__*/React__namespace.forwardRef(function StepConnector(inProps, ref) {
  ...
  return /*#__PURE__*/jsxRuntime.jsx(StepConnectorRoot, _extends["default"]({
    className: clsx_m.clsx(classes.root, className),
    ref: ref,
    ownerState: ownerState
  }, other, {
    children: /*#__PURE__*/jsxRuntime.jsx(StepConnectorLine, {
