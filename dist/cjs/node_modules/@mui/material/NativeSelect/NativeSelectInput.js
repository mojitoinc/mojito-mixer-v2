...
const nativeSelectSelectStyles = ({
  ...
  // Reset
  cursor: 'pointer',
  '&:focus': _extends["default"]({}, theme.vars ? {
  ...
  [`&.${nativeSelectClasses["default"].disabled}`]: {
    cursor: 'default'
  },
  '&[multiple]': {
    height: 'auto'
...
const NativeSelectSelect = styled["default"]('select', {
  ...
  overridesResolver: (props, styles) => {
    ...
    return [styles.select, styles[ownerState.variant], {
      [`&.${nativeSelectClasses["default"].multiple}`]: styles.multiple
    }];
  }
...
const NativeSelectIcon = styled["default"]('svg', {
  name: 'MuiNativeSelect',
  slot: 'Icon',
  overridesResolver: (props, styles) => {
    const {
...
const NativeSelectInput = /*#__PURE__*/React__namespace.forwardRef(function NativeSelectInput(props, ref) {
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(React__namespace.Fragment, {
    children: [/*#__PURE__*/jsxRuntime.jsx(NativeSelectSelect, _extends["default"]({
      ownerState: ownerState,
      className: clsx_m.clsx(classes.select, className),
      disabled: disabled,
      ref: inputRef || ref
