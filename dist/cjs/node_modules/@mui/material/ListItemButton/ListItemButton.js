...
var listItemButtonClasses = require('./listItemButtonClasses.js');
...
const useUtilityClasses = ownerState => {
  ...
  const composedClasses = composeClasses["default"](slots, listItemButtonClasses.getListItemButtonUtilityClass, classes);
  return _extends["default"]({}, classes, composedClasses);
};
const ListItemButtonRoot = styled["default"](ButtonBase["default"], {
  ...
  [`&.${listItemButtonClasses["default"].selected}`]: {
    ...
    [`&.${listItemButtonClasses["default"].focusVisible}`]: {
  ...
  [`&.${listItemButtonClasses["default"].selected}:hover`]: {
  ...
  [`&.${listItemButtonClasses["default"].disabled}`]: {
...
const ListItemButton = /*#__PURE__*/React__namespace.forwardRef(function ListItemButton(inProps, ref) {
  ...
  return /*#__PURE__*/jsxRuntime.jsx(ListContext["default"].Provider, {
    value: childContext,
    children: /*#__PURE__*/jsxRuntime.jsx(ListItemButtonRoot, _extends["default"]({
      ref: handleRef,
