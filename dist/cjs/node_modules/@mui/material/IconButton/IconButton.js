...
var iconButtonClasses = require('./iconButtonClasses.js');
...
const useUtilityClasses = ownerState => {
  ...
  const slots = {
    root: ['root', disabled && 'disabled', color !== 'default' && `color${capitalize["default"](color)}`, edge && `edge${capitalize["default"](edge)}`, `size${capitalize["default"](size)}`]
  };
  return composeClasses["default"](slots, iconButtonClasses.getIconButtonUtilityClass, classes);
};
const IconButtonRoot = styled["default"](ButtonBase["default"], {
  name: 'MuiIconButton',
  slot: 'Root',
  overridesResolver: (props, styles) => {
    ...
    return [styles.root, ownerState.color !== 'default' && styles[`color${capitalize["default"](ownerState.color)}`], ownerState.edge && styles[`edge${capitalize["default"](ownerState.edge)}`], styles[`size${capitalize["default"](ownerState.size)}`]];
  }
})(({
  theme,
  ownerState
  ...
  return _extends["default"]({}, ownerState.color === 'inherit' && {
    color: 'inherit'
  }, ownerState.color !== 'inherit' && ownerState.color !== 'default' && _extends["default"]({
    color: palette == null ? void 0 : palette.main
  }, !ownerState.disableRipple && {
    '&:hover': _extends["default"]({}, palette && {
      backgroundColor: theme.vars ? `rgba(${palette.mainChannel} / ${theme.vars.palette.action.hoverOpacity})` : colorManipulator.alpha(palette.main, theme.palette.action.hoverOpacity)
    }, {
      // Reset on touch devices, it doesn't add specificity
      '@media (hover: none)': {
        backgroundColor: 'transparent'
    ...
    [`&.${iconButtonClasses["default"].disabled}`]: {
      backgroundColor: 'transparent',
...
const IconButton = /*#__PURE__*/React__namespace.forwardRef(function IconButton(inProps, ref) {
  ...
  return /*#__PURE__*/jsxRuntime.jsx(IconButtonRoot, _extends["default"]({
