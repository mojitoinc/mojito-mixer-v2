...
var StepLabel = require('../StepLabel/StepLabel.js');
require('../StepLabel/stepLabelClasses.js');
var StepperContext = require('../Stepper/StepperContext.js');
var StepContext = require('../Step/StepContext.js');
var stepButtonClasses = require('./stepButtonClasses.js');
...
const useUtilityClasses = ownerState => {
  ...
  return composeClasses["default"](slots, stepButtonClasses.getStepButtonUtilityClass, classes);
};
const StepButtonRoot = styled["default"](ButtonBase["default"], {
  name: 'MuiStepButton',
  slot: 'Root',
  overridesResolver: (props, styles) => {
    ...
    return [{
      [`& .${stepButtonClasses["default"].touchRipple}`]: styles.touchRipple
  ...
  [`& .${stepButtonClasses["default"].touchRipple}`]: {
...
const StepButton = /*#__PURE__*/React__namespace.forwardRef(function StepButton(inProps, ref) {
  ...
  const child = isMuiElement["default"](children, ['StepLabel']) ? /*#__PURE__*/React__namespace.cloneElement(children, childProps) : /*#__PURE__*/jsxRuntime.jsx(StepLabel["default"], _extends["default"]({}, childProps, {
    children: children
  }));
  return /*#__PURE__*/jsxRuntime.jsx(StepButtonRoot, _extends["default"]({
    focusRipple: true,
    disabled: disabled,
    TouchRippleProps: {
