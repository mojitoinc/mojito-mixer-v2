...
var circularProgressClasses = require('./circularProgressClasses.js');
...
let _ = t => t,
  ...
  _t4;
const SIZE = 44;
const circularRotateKeyframe = emotionReact_esm.keyframes(_t || (_t = _`
  0% {
...
`));
const circularDashKeyframe = emotionReact_esm.keyframes(_t2 || (_t2 = _`
  0% {
...
const useUtilityClasses = ownerState => {
  ...
  const slots = {
    root: ['root', variant, `color${capitalize["default"](color)}`],
    svg: ['svg'],
    circle: ['circle', `circle${capitalize["default"](variant)}`, disableShrink && 'circleDisableShrink']
  };
  return composeClasses["default"](slots, circularProgressClasses.getCircularProgressUtilityClass, classes);
};
const CircularProgressRoot = styled["default"]('span', {
  ...
  overridesResolver: (props, styles) => {
    ...
    return [styles.root, styles[ownerState.variant], styles[`color${capitalize["default"](ownerState.color)}`]];
  }
})(({
  ownerState,
  theme
  ...
  ownerState
}) => ownerState.variant === 'indeterminate' && emotionReact_esm.css(_t3 || (_t3 = _`
      animation: ${0} 1.4s linear infinite;
    `), circularRotateKeyframe));
const CircularProgressSVG = styled["default"]('svg', {
  name: 'MuiCircularProgress',
  slot: 'Svg',
...
const CircularProgressCircle = styled["default"]('circle', {
  name: 'MuiCircularProgress',
  slot: 'Circle',
  overridesResolver: (props, styles) => {
    const {
    ...
    return [styles.circle, styles[`circle${capitalize["default"](ownerState.variant)}`], ownerState.disableShrink && styles.circleDisableShrink];
  }
})(({
  ownerState,
  theme
  ...
  ownerState
}) => ownerState.variant === 'indeterminate' && !ownerState.disableShrink && emotionReact_esm.css(_t4 || (_t4 = _`
...
const CircularProgress = /*#__PURE__*/React__namespace.forwardRef(function CircularProgress(inProps, ref) {
  ...
  return /*#__PURE__*/jsxRuntime.jsx(CircularProgressRoot, _extends["default"]({
...
process.env.NODE_ENV !== "production" ? CircularProgress.propTypes /* remove-proptypes */ = {
   ...
   * @default false
   */
  disableShrink: chainPropTypes["default"](PropTypes__default["default"].bool, props => {
