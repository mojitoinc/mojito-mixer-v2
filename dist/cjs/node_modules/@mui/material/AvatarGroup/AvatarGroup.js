...
var avatarClasses = require('../Avatar/avatarClasses.js');
var avatarGroupClasses = require('./avatarGroupClasses.js');
...
const useUtilityClasses = ownerState => {
  ...
  return composeClasses["default"](slots, avatarGroupClasses.getAvatarGroupUtilityClass, classes);
};
const AvatarGroupRoot = styled["default"]('div', {
  name: 'MuiAvatarGroup',
  slot: 'Root',
  overridesResolver: (props, styles) => _extends["default"]({
    [`& .${avatarGroupClasses["default"].avatar}`]: styles.avatar
  }, styles.root)
})(({
  theme
}) => ({
  [`& .${avatarClasses["default"].root}`]: {
...
const AvatarGroupAvatar = styled["default"](Avatar["default"], {
  name: 'MuiAvatarGroup',
  slot: 'Avatar',
...
const AvatarGroup = /*#__PURE__*/React__namespace.forwardRef(function AvatarGroup(inProps, ref) {
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(AvatarGroupRoot, _extends["default"]({
    as: component,
    ownerState: ownerState,
    className: clsx_m.clsx(classes.root, className),
    ref: ref
  }, other, {
    children: [extraAvatars ? /*#__PURE__*/jsxRuntime.jsxs(AvatarGroupAvatar, _extends["default"]({
      ownerState: ownerState,
      variant: variant
    }, additionalAvatarSlotProps, {
      className: clsx_m.clsx(classes.avatar, additionalAvatarSlotProps == null ? void 0 : additionalAvatarSlotProps.className),
      ...
      return /*#__PURE__*/React__namespace.cloneElement(child, {
        className: clsx_m.clsx(child.props.className, classes.avatar),
        style: _extends["default"]({
...
process.env.NODE_ENV !== "production" ? AvatarGroup.propTypes /* remove-proptypes */ = {
  ...
  componentsProps: PropTypes__default["default"].shape({
    additionalAvatar: PropTypes__default["default"].object
  }),
  /**
   * Max avatars to show before +x.
   * @default 5
   */
  max: chainPropTypes["default"](PropTypes__default["default"].number, props => {
    if (props.max < 2) {
   ...
   * @default 'medium'
   */
  spacing: PropTypes__default["default"].oneOfType([PropTypes__default["default"].oneOf(['medium', 'small']), PropTypes__default["default"].number]),
  /**
   ...
   * @default 'circular'
   */
  variant: PropTypes__default["default"] /* @typescript-to-proptypes-ignore */.oneOfType([PropTypes__default["default"].oneOf(['circular', 'rounded', 'square']), PropTypes__default["default"].string])
} : void 0;
