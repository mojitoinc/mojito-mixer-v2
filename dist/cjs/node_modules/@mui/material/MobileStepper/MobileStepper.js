...
var LinearProgress = require('../LinearProgress/LinearProgress.js');
require('../LinearProgress/linearProgressClasses.js');
var useThemeProps = require('../styles/useThemeProps.js');
var styled = require('../styles/styled.js');
var mobileStepperClasses = require('./mobileStepperClasses.js');
...
const useUtilityClasses = ownerState => {
  ...
  const slots = {
    root: ['root', `position${capitalize["default"](position)}`],
    dots: ['dots'],
    dot: ['dot'],
    dotActive: ['dotActive'],
    progress: ['progress']
  };
  return composeClasses["default"](slots, mobileStepperClasses.getMobileStepperUtilityClass, classes);
};
const MobileStepperRoot = styled["default"](Paper["default"], {
  ...
  overridesResolver: (props, styles) => {
    ...
    return [styles.root, styles[`position${capitalize["default"](ownerState.position)}`]];
  }
})(({
  theme,
  ownerState
...
const MobileStepperDots = styled["default"]('div', {
  name: 'MuiMobileStepper',
  slot: 'Dots',
  overridesResolver: (props, styles) => styles.dots
})(({
  ownerState
}) => _extends["default"]({}, ownerState.variant === 'dots' && {
  display: 'flex',
  flexDirection: 'row'
}));
const MobileStepperDot = styled["default"]('div', {
  name: 'MuiMobileStepper',
  slot: 'Dot',
  shouldForwardProp: prop => styled.slotShouldForwardProp(prop) && prop !== 'dotActive',
  overridesResolver: (props, styles) => {
    const {
      dotActive
    } = props;
  ...
  ownerState,
  dotActive
}) => _extends["default"]({}, ownerState.variant === 'dots' && _extends["default"]({
...
const MobileStepperProgress = styled["default"](LinearProgress["default"], {
  name: 'MuiMobileStepper',
  slot: 'Progress',
  overridesResolver: (props, styles) => styles.progress
})(({
  ownerState
}) => _extends["default"]({}, ownerState.variant === 'progress' && {
  width: '50%'
}));
const MobileStepper = /*#__PURE__*/React__namespace.forwardRef(function MobileStepper(inProps, ref) {
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(MobileStepperRoot, _extends["default"]({
    square: true,
    elevation: 0,
    ...
    children: [backButton, variant === 'text' && /*#__PURE__*/jsxRuntime.jsxs(React__namespace.Fragment, {
      children: [activeStep + 1, " / ", steps]
    }), variant === 'dots' && /*#__PURE__*/jsxRuntime.jsx(MobileStepperDots, {
      ownerState: ownerState,
      className: classes.dots,
      children: [...new Array(steps)].map((_, index) => /*#__PURE__*/jsxRuntime.jsx(MobileStepperDot, {
        className: clsx_m.clsx(classes.dot, index === activeStep && classes.dotActive),
        ownerState: ownerState,
        dotActive: index === activeStep
      }, index))
    }), variant === 'progress' && /*#__PURE__*/jsxRuntime.jsx(MobileStepperProgress, _extends["default"]({
      ownerState: ownerState,
...
process.env.NODE_ENV !== "production" ? MobileStepper.propTypes /* remove-proptypes */ = {
   ...
   * @default 0
   */
  activeStep: integerPropType["default"],
  /**
   * A back button element. For instance, it can be a `Button` or an `IconButton`.
   */
  backButton: PropTypes__default["default"].node,
  /**
   ...
   */
  LinearProgressProps: PropTypes__default["default"].object,
  /**
   ...
   * @default 'bottom'
   */
  position: PropTypes__default["default"].oneOf(['bottom', 'static', 'top']),
  /**
   * The total steps.
   */
  steps: integerPropType["default"].isRequired,
  /**
   ...
   * @default 'dots'
   */
  variant: PropTypes__default["default"].oneOf(['dots', 'progress', 'text'])
} : void 0;
