...
var BreadcrumbCollapsed = require('./BreadcrumbCollapsed.js');
var breadcrumbsClasses = require('./breadcrumbsClasses.js');
...
const useUtilityClasses = ownerState => {
  ...
  return composeClasses["default"](slots, breadcrumbsClasses.getBreadcrumbsUtilityClass, classes);
};
const BreadcrumbsRoot = styled["default"](Typography["default"], {
  name: 'MuiBreadcrumbs',
  slot: 'Root',
  overridesResolver: (props, styles) => {
    return [{
      [`& .${breadcrumbsClasses["default"].li}`]: styles.li
    }, styles.root];
  }
})({});
const BreadcrumbsOl = styled["default"]('ol', {
  name: 'MuiBreadcrumbs',
  slot: 'Ol',
...
const BreadcrumbsSeparator = styled["default"]('li', {
  name: 'MuiBreadcrumbs',
  slot: 'Separator',
...
function insertSeparators(items, className, separator, ownerState) {
  return items.reduce((acc, current, index) => {
    if (index < items.length - 1) {
      acc = acc.concat(current, /*#__PURE__*/jsxRuntime.jsx(BreadcrumbsSeparator, {
        "aria-hidden": true,
        className: className,
...
const Breadcrumbs = /*#__PURE__*/React__namespace.forwardRef(function Breadcrumbs(inProps, ref) {
  ...
  const renderItemsBeforeAndAfter = allItems => {
    ...
    return [...allItems.slice(0, itemsBeforeCollapse), /*#__PURE__*/jsxRuntime.jsx(BreadcrumbCollapsed["default"], {
  ...
  }).map((child, index) => /*#__PURE__*/jsxRuntime.jsx("li", {
    className: classes.li,
    children: child
  }, `child-${index}`));
  return /*#__PURE__*/jsxRuntime.jsx(BreadcrumbsRoot, _extends["default"]({
    ref: ref,
    component: component,
    ...
    children: /*#__PURE__*/jsxRuntime.jsx(BreadcrumbsOl, {
...
process.env.NODE_ENV !== "production" ? Breadcrumbs.propTypes /* remove-proptypes */ = {
   ...
   * @default 'Show path'
   */
  expandText: PropTypes__default["default"].string,
  /**
   * If max items is exceeded, the number of items to show after the ellipsis.
   * @default 1
   */
  itemsAfterCollapse: integerPropType["default"],
  /**
   * If max items is exceeded, the number of items to show before the ellipsis.
   * @default 1
   */
  itemsBeforeCollapse: integerPropType["default"],
  /**
   ...
   * @default 8
   */
  maxItems: integerPropType["default"],
  /**
