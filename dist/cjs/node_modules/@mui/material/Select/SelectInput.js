...
var utils = require('../InputBase/utils.js');
var styled = require('../styles/styled.js');
var selectClasses = require('./selectClasses.js');
...
const SelectSelect = styled["default"]('div', {
  name: 'MuiSelect',
  slot: 'Select',
  overridesResolver: (props, styles) => {
    ...
    {
      [`&.${selectClasses["default"].select}`]: styles.select
    }, {
      [`&.${selectClasses["default"].select}`]: styles[ownerState.variant]
    }, {
      [`&.${selectClasses["default"].multiple}`]: styles.multiple
    }];
  }
})(NativeSelectInput.nativeSelectSelectStyles, {
  // Win specificity over the input base
  [`&.${selectClasses["default"].select}`]: {
    height: 'auto',
...
const SelectIcon = styled["default"]('svg', {
  name: 'MuiSelect',
  slot: 'Icon',
  overridesResolver: (props, styles) => {
    const {
    ...
    return [styles.icon, ownerState.variant && styles[`icon${capitalize["default"](ownerState.variant)}`], ownerState.open && styles.iconOpen];
  }
})(NativeSelectInput.nativeSelectIconStyles);
const SelectNativeInput = styled["default"]('input', {
  shouldForwardProp: prop => styled.slotShouldForwardProp(prop) && prop !== 'classes',
  name: 'MuiSelect',
  slot: 'NativeInput',
...
const useUtilityClasses = ownerState => {
  ...
  const slots = {
    ...
    icon: ['icon', `icon${capitalize["default"](variant)}`, open && 'iconOpen', disabled && 'disabled'],
    nativeInput: ['nativeInput']
  };
  return composeClasses["default"](slots, selectClasses.getSelectUtilityClasses, classes);
};
...
const SelectInput = /*#__PURE__*/React__namespace.forwardRef(function SelectInput(props, ref) {
  ...
  const handleRef = useForkRef["default"](ref, inputRefProp);
  ...
  React__namespace.useEffect(() => {
    ...
    const label = ownerDocument["default"](displayRef.current).getElementById(labelId);
    if (label) {
      const handler = () => {
  ...
  const items = childrenArray.map((child, index, arr) => {
    ...
    if (multiple) {
      if (!Array.isArray(value)) {
        throw new Error(process.env.NODE_ENV !== "production" ? `MUI: The \`value\` prop must be an array when using the \`Select\` component with \`multiple\`.` : formatMuiErrorMessage["default"](2));
      }
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(React__namespace.Fragment, {
    children: [/*#__PURE__*/jsxRuntime.jsx(SelectSelect, _extends["default"]({
      ...
      className: clsx_m.clsx(SelectDisplayProps.className, classes.select, className)
    ...
    })), /*#__PURE__*/jsxRuntime.jsx(SelectNativeInput, _extends["default"]({
      ...
      ownerState: ownerState
    }), /*#__PURE__*/jsxRuntime.jsx(Menu["default"], _extends["default"]({
      id: `menu-${name || ''}`,
      ...
      MenuListProps: _extends["default"]({
        'aria-labelledby': labelId,
        role: 'listbox',
        disableListWrap: true
      }, MenuProps.MenuListProps),
      PaperProps: _extends["default"]({}, MenuProps.PaperProps, {
...
process.env.NODE_ENV !== "production" ? SelectInput.propTypes = {
   ...
   */
  IconComponent: PropTypes__default["default"].elementType.isRequired,
  /**
   ...
   * @ignore
   */
  type: PropTypes__default["default"].any,
  /**
   * The input value.
   */
   ...
   * The variant to use.
   */
  variant: PropTypes__default["default"].oneOf(['standard', 'outlined', 'filled'])
} : void 0;
