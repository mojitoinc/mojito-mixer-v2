...
var TableContext = require('../Table/TableContext.js');
var Tablelvl2Context = require('../Table/Tablelvl2Context.js');
var useThemeProps = require('../styles/useThemeProps.js');
var styled = require('../styles/styled.js');
var tableCellClasses = require('./tableCellClasses.js');
...
const useUtilityClasses = ownerState => {
  ...
  const slots = {
    root: ['root', variant, stickyHeader && 'stickyHeader', align !== 'inherit' && `align${capitalize["default"](align)}`, padding !== 'normal' && `padding${capitalize["default"](padding)}`, `size${capitalize["default"](size)}`]
  };
  return composeClasses["default"](slots, tableCellClasses.getTableCellUtilityClass, classes);
};
const TableCellRoot = styled["default"]('td', {
  name: 'MuiTableCell',
  slot: 'Root',
  overridesResolver: (props, styles) => {
    ...
    return [styles.root, styles[ownerState.variant], styles[`size${capitalize["default"](ownerState.size)}`], ownerState.padding !== 'normal' && styles[`padding${capitalize["default"](ownerState.padding)}`], ownerState.align !== 'inherit' && styles[`align${capitalize["default"](ownerState.align)}`], ownerState.stickyHeader && styles.stickyHeader];
  }
})(({
  theme,
  ownerState
  ...
  borderBottom: theme.vars ? `1px solid ${theme.vars.palette.TableCell.border}` : `1px solid
    ${theme.palette.mode === 'light' ? colorManipulator.lighten(colorManipulator.alpha(theme.palette.divider, 1), 0.88) : colorManipulator.darken(colorManipulator.alpha(theme.palette.divider, 1), 0.68)}`,
  textAlign: 'left',
  padding: 16
  ...
  padding: '6px 16px',
  [`&.${tableCellClasses["default"].paddingCheckbox}`]: {
    width: 24,
...
const TableCell = /*#__PURE__*/React__namespace.forwardRef(function TableCell(inProps, ref) {
  ...
  const table = React__namespace.useContext(TableContext["default"]);
  const tablelvl2 = React__namespace.useContext(Tablelvl2Context["default"]);
  ...
  return /*#__PURE__*/jsxRuntime.jsx(TableCellRoot, _extends["default"]({
    as: component,
    ref: ref,
...
process.env.NODE_ENV !== "production" ? TableCell.propTypes /* remove-proptypes */ = {
   ...
   */
  padding: PropTypes__default["default"].oneOf(['checkbox', 'none', 'normal']),
  /**
   * Set scope attribute.
   */
   ...
   */
  sortDirection: PropTypes__default["default"].oneOf(['asc', 'desc', false]),
  /**
   ...
   */
  variant: PropTypes__default["default"] /* @typescript-to-proptypes-ignore */.oneOfType([PropTypes__default["default"].oneOf(['body', 'footer', 'head']), PropTypes__default["default"].string])
} : void 0;
