...
var StepIcon = require('../StepIcon/StepIcon.js');
require('../StepIcon/stepIconClasses.js');
var StepperContext = require('../Stepper/StepperContext.js');
var StepContext = require('../Step/StepContext.js');
var stepLabelClasses = require('./stepLabelClasses.js');
...
const useUtilityClasses = ownerState => {
  ...
  return composeClasses["default"](slots, stepLabelClasses.getStepLabelUtilityClass, classes);
};
const StepLabelRoot = styled["default"]('span', {
  name: 'MuiStepLabel',
  slot: 'Root',
  ...
  display: 'flex',
  alignItems: 'center',
  [`&.${stepLabelClasses["default"].alternativeLabel}`]: {
    flexDirection: 'column'
  },
  [`&.${stepLabelClasses["default"].disabled}`]: {
    cursor: 'default'
  }
...
const StepLabelLabel = styled["default"]('span', {
  name: 'MuiStepLabel',
  slot: 'Label',
  ...
  [`&.${stepLabelClasses["default"].active}`]: {
    color: (theme.vars || theme).palette.text.primary,
    fontWeight: 500
  },
  [`&.${stepLabelClasses["default"].completed}`]: {
    color: (theme.vars || theme).palette.text.primary,
    fontWeight: 500
  },
  [`&.${stepLabelClasses["default"].alternativeLabel}`]: {
  ...
  [`&.${stepLabelClasses["default"].error}`]: {
    color: (theme.vars || theme).palette.error.main
  }
}));
const StepLabelIconContainer = styled["default"]('span', {
  name: 'MuiStepLabel',
  slot: 'IconContainer',
...
const StepLabelLabelContainer = styled["default"]('span', {
  name: 'MuiStepLabel',
  slot: 'LabelContainer',
...
const StepLabel = /*#__PURE__*/React__namespace.forwardRef(function StepLabel(inProps, ref) {
  ...
  const {
    alternativeLabel,
    orientation
  } = React__namespace.useContext(StepperContext["default"]);
  const {
    active,
    disabled,
    completed,
    icon: iconContext
  } = React__namespace.useContext(StepContext["default"]);
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(StepLabelRoot, _extends["default"]({
    className: clsx_m.clsx(classes.root, className),
    ref: ref,
    ownerState: ownerState
  }, other, {
    children: [icon || StepIconComponent ? /*#__PURE__*/jsxRuntime.jsx(StepLabelIconContainer, {
      className: classes.iconContainer,
      ownerState: ownerState,
      children: /*#__PURE__*/jsxRuntime.jsx(StepIconComponent, _extends["default"]({
        completed: completed,
        active: active,
        error: error,
        icon: icon
      }, StepIconProps))
    }) : null, /*#__PURE__*/jsxRuntime.jsxs(StepLabelLabelContainer, {
      className: classes.labelContainer,
      ownerState: ownerState,
      children: [children ? /*#__PURE__*/jsxRuntime.jsx(StepLabelLabel, _extends["default"]({
        ownerState: ownerState
      }, labelSlotProps, {
        className: clsx_m.clsx(classes.label, labelSlotProps == null ? void 0 : labelSlotProps.className),
        children: children
      })) : null, optional]
    })]
  }));
...
process.env.NODE_ENV !== "production" ? StepLabel.propTypes /* remove-proptypes */ = {
   ...
   */
  optional: PropTypes__default["default"].node,
  /**
   * The props used for each slot inside.
   * @default {}
   */
   ...
   */
  StepIconComponent: PropTypes__default["default"].elementType,
  /**
   * Props applied to the [`StepIcon`](/material-ui/api/step-icon/) element.
   */
  StepIconProps: PropTypes__default["default"].object,
  /**
