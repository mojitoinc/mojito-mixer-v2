...
var AccordionContext = require('../Accordion/AccordionContext.js');
var accordionSummaryClasses = require('./accordionSummaryClasses.js');
...
const useUtilityClasses = ownerState => {
  ...
  return composeClasses["default"](slots, accordionSummaryClasses.getAccordionSummaryUtilityClass, classes);
};
const AccordionSummaryRoot = styled["default"](ButtonBase["default"], {
  ...
  return _extends["default"]({
    ...
    [`&.${accordionSummaryClasses["default"].focusVisible}`]: {
      backgroundColor: (theme.vars || theme).palette.action.focus
    },
    [`&.${accordionSummaryClasses["default"].disabled}`]: {
      opacity: (theme.vars || theme).palette.action.disabledOpacity
    },
    [`&:hover:not(.${accordionSummaryClasses["default"].disabled})`]: {
      cursor: 'pointer'
    }
  }, !ownerState.disableGutters && {
    [`&.${accordionSummaryClasses["default"].expanded}`]: {
      minHeight: 64
    }
  });
});
const AccordionSummaryContent = styled["default"]('div', {
  name: 'MuiAccordionSummary',
  slot: 'Content',
...
const AccordionSummaryExpandIconWrapper = styled["default"]('div', {
  name: 'MuiAccordionSummary',
...
const AccordionSummary = /*#__PURE__*/React__namespace.forwardRef(function AccordionSummary(inProps, ref) {
  ...
  const {
    ...
    expanded,
    toggle
  } = React__namespace.useContext(AccordionContext["default"]);
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(AccordionSummaryRoot, _extends["default"]({
    focusRipple: false,
    disableRipple: true,
    disabled: disabled,
    component: "div",
...
process.env.NODE_ENV !== "production" ? AccordionSummary.propTypes /* remove-proptypes */ = {
   ...
   */
  expandIcon: PropTypes__default["default"].node,
  /**
