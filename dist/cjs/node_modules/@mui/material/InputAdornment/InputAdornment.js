...
require('../Typography/typographyClasses.js');
...
var inputAdornmentClasses = require('./inputAdornmentClasses.js');
...
const overridesResolver = (props, styles) => {
  ...
  return [styles.root, styles[`position${capitalize["default"](ownerState.position)}`], ownerState.disablePointerEvents === true && styles.disablePointerEvents, styles[ownerState.variant]];
};
const useUtilityClasses = ownerState => {
  ...
  const slots = {
    root: ['root', disablePointerEvents && 'disablePointerEvents', position && `position${capitalize["default"](position)}`, variant, hiddenLabel && 'hiddenLabel', size && `size${capitalize["default"](size)}`]
  };
  return composeClasses["default"](slots, inputAdornmentClasses.getInputAdornmentUtilityClass, classes);
};
const InputAdornmentRoot = styled["default"]('div', {
  ...
  [`&.${inputAdornmentClasses["default"].positionStart}&:not(.${inputAdornmentClasses["default"].hiddenLabel})`]: {
    marginTop: 16
  }
...
const InputAdornment = /*#__PURE__*/React__namespace.forwardRef(function InputAdornment(inProps, ref) {
  ...
  return /*#__PURE__*/jsxRuntime.jsx(FormControlContext["default"].Provider, {
    value: null,
    children: /*#__PURE__*/jsxRuntime.jsx(InputAdornmentRoot, _extends["default"]({
      as: component,
      ownerState: ownerState,
      className: clsx_m.clsx(classes.root, className),
      ref: ref
    }, other, {
      children: typeof children === 'string' && !disableTypography ? /*#__PURE__*/jsxRuntime.jsx(Typography["default"], {
...
process.env.NODE_ENV !== "production" ? InputAdornment.propTypes /* remove-proptypes */ = {
   ...
   * @default false
   */
  disablePointerEvents: PropTypes__default["default"].bool,
  /**
   * If children is a string then disable wrapping in a Typography component.
   * @default false
   */
  disableTypography: PropTypes__default["default"].bool,
  /**
   * The position this adornment should appear relative to the `Input`.
   */
  position: PropTypes__default["default"].oneOf(['end', 'start']).isRequired,
  /**
