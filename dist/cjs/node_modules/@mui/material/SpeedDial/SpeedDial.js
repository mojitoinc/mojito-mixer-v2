...
var Zoom = require('../Zoom/Zoom.js');
var Fab = require('../Fab/Fab.js');
require('../Fab/fabClasses.js');
var speedDialClasses = require('./speedDialClasses.js');
...
const useUtilityClasses = ownerState => {
  ...
  const slots = {
    root: ['root', `direction${capitalize["default"](direction)}`],
    fab: ['fab'],
    actions: ['actions', !open && 'actionsClosed']
  };
  return composeClasses["default"](slots, speedDialClasses.getSpeedDialUtilityClass, classes);
};
...
const SpeedDialRoot = styled["default"]('div', {
  name: 'MuiSpeedDial',
  slot: 'Root',
  overridesResolver: (props, styles) => {
    ...
    return [styles.root, styles[`direction${capitalize["default"](ownerState.direction)}`]];
  }
})(({
  theme,
  ownerState
  ...
  [`& .${speedDialClasses["default"].actions}`]: {
    flexDirection: 'column-reverse',
...
const SpeedDialFab = styled["default"](Fab["default"], {
  name: 'MuiSpeedDial',
  slot: 'Fab',
...
const SpeedDialActions = styled["default"]('div', {
  name: 'MuiSpeedDial',
  slot: 'Actions',
  overridesResolver: (props, styles) => {
    const {
...
const SpeedDial = /*#__PURE__*/React__namespace.forwardRef(function SpeedDial(inProps, ref) {
  ...
  const {
      ...
      onOpen,
      open: openProp,
      TransitionComponent = Zoom["default"],
      transitionDuration = defaultTransitionDuration,
      TransitionProps
    } = props,
    FabProps = objectWithoutPropertiesLoose["default"](props.FabProps, _excluded),
    other = objectWithoutPropertiesLoose["default"](props, _excluded2);
  const [open, setOpenState] = useControlled["default"]({
    controlled: openProp,
    default: false,
    name: 'SpeedDial',
    state: 'open'
  ...
  const handleFabRef = useForkRef["default"](origDialButtonRef, handleOwnFabRef);
  ...
  const children = allItems.map((child, index) => {
    const _child$props = child.props,
      ...
      ChildFabProps = objectWithoutPropertiesLoose["default"](_child$props.FabProps, _excluded3);
    const tooltipPlacement = tooltipPlacementProp || (getOrientation(direction) === 'vertical' ? 'left' : 'top');
    return /*#__PURE__*/React__namespace.cloneElement(child, {
      FabProps: _extends["default"]({}, ChildFabProps, {
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(SpeedDialRoot, _extends["default"]({
    ...
    children: [/*#__PURE__*/jsxRuntime.jsx(TransitionComponent, _extends["default"]({
      ...
      children: /*#__PURE__*/jsxRuntime.jsx(SpeedDialFab, _extends["default"]({
        color: "primary",
        ...
        onClick: handleClick,
        className: clsx_m.clsx(classes.fab, FabProps.className),
        ref: handleFabRef,
        ownerState: ownerState,
        children: /*#__PURE__*/React__namespace.isValidElement(icon) && isMuiElement["default"](icon, ['SpeedDialIcon']) ? /*#__PURE__*/React__namespace.cloneElement(icon, {
          open
        }) : icon
      }))
    })), /*#__PURE__*/jsxRuntime.jsx(SpeedDialActions, {
      id: `${id}-actions`,
      role: "menu",
      "aria-orientation": getOrientation(direction),
      className: clsx_m.clsx(classes.actions, !open && classes.actionsClosed),
      ownerState: ownerState,
      children: children
    })]
  }));
...
process.env.NODE_ENV !== "production" ? SpeedDial.propTypes /* remove-proptypes */ = {
   ...
   * @default 'up'
   */
  direction: PropTypes__default["default"].oneOf(['down', 'left', 'right', 'up']),
  /**
   * Props applied to the [`Fab`](/material-ui/api/fab/) element.
   * @default {}
   */
  FabProps: PropTypes__default["default"].object,
  /**
   ...
   */
  openIcon: PropTypes__default["default"].node,
  /**
