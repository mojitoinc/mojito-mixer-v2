...
var buttonGroupClasses = require('./buttonGroupClasses.js');
...
const overridesResolver = (props, styles) => {
  ...
  return [{
    [`& .${buttonGroupClasses["default"].grouped}`]: styles.grouped
  }, {
    [`& .${buttonGroupClasses["default"].grouped}`]: styles[`grouped${capitalize["default"](ownerState.orientation)}`]
  }, {
    [`& .${buttonGroupClasses["default"].grouped}`]: styles[`grouped${capitalize["default"](ownerState.variant)}`]
  }, {
    [`& .${buttonGroupClasses["default"].grouped}`]: styles[`grouped${capitalize["default"](ownerState.variant)}${capitalize["default"](ownerState.orientation)}`]
  }, {
    [`& .${buttonGroupClasses["default"].grouped}`]: styles[`grouped${capitalize["default"](ownerState.variant)}${capitalize["default"](ownerState.color)}`]
...
const useUtilityClasses = ownerState => {
  ...
  const slots = {
    ...
    grouped: ['grouped', `grouped${capitalize["default"](orientation)}`, `grouped${capitalize["default"](variant)}`, `grouped${capitalize["default"](variant)}${capitalize["default"](orientation)}`, `grouped${capitalize["default"](variant)}${capitalize["default"](color)}`, disabled && 'disabled']
  };
  return composeClasses["default"](slots, buttonGroupClasses.getButtonGroupUtilityClass, classes);
};
const ButtonGroupRoot = styled["default"]('div', {
  name: 'MuiButtonGroup',
  slot: 'Root',
  overridesResolver
})(({
  ...
  [`& .${buttonGroupClasses["default"].grouped}`]: _extends["default"]({
    minWidth: 40,
    '&:not(:first-of-type)': _extends["default"]({}, ownerState.orientation === 'horizontal' && {
    ...
    '&:not(:last-of-type)': _extends["default"]({}, ownerState.orientation === 'horizontal' && {
      borderTopRightRadius: 0,
      ...
      borderColor: theme.vars ? `rgba(${theme.vars.palette[ownerState.color].mainChannel} / 0.5)` : colorManipulator.alpha(theme.palette[ownerState.color].main, 0.5)
    }, ownerState.variant === 'outlined' && ownerState.orientation === 'horizontal' && {
      ...
      [`&.${buttonGroupClasses["default"].disabled}`]: {
      ...
      '&:hover': _extends["default"]({}, ownerState.variant === 'outlined' && ownerState.orientation === 'horizontal' && {
        borderRightColor: 'currentColor'
      }, ownerState.variant === 'outlined' && ownerState.orientation === 'vertical' && {
        borderBottomColor: 'currentColor'
      })
    }),
    '&:hover': _extends["default"]({}, ownerState.variant === 'contained' && {
      boxShadow: 'none'
    })
  }, ownerState.variant === 'contained' && {
    boxShadow: 'none'
...
const ButtonGroup = /*#__PURE__*/React__namespace.forwardRef(function ButtonGroup(inProps, ref) {
  ...
  return /*#__PURE__*/jsxRuntime.jsx(ButtonGroupRoot, _extends["default"]({
    as: component,
    role: "group",
    ...
    children: /*#__PURE__*/jsxRuntime.jsx(ButtonGroupContext["default"].Provider, {
      value: context,
      children: children
    })
  }));
