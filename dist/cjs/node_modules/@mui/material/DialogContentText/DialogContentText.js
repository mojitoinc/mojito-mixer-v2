...
var dialogContentTextClasses = require('./dialogContentTextClasses.js');
...
const useUtilityClasses = ownerState => {
  ...
  const composedClasses = composeClasses["default"](slots, dialogContentTextClasses.getDialogContentTextUtilityClass, classes);
  return _extends["default"]({}, classes, composedClasses);
};
const DialogContentTextRoot = styled["default"](Typography["default"], {
...
const DialogContentText = /*#__PURE__*/React__namespace.forwardRef(function DialogContentText(inProps, ref) {
  ...
  const {
    ...
    ownerState = objectWithoutPropertiesLoose["default"](props, _excluded);
  const classes = useUtilityClasses(ownerState);
  return /*#__PURE__*/jsxRuntime.jsx(DialogContentTextRoot, _extends["default"]({
    component: "p",
    variant: "body1",
