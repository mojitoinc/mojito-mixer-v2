...
var getScrollbarSize = require('../../utils/esm/getScrollbarSize.js');
require('../../utils/esm/integerPropType.js');
var List = require('../List/List.js');
require('../List/listClasses.js');
...
const MenuList = /*#__PURE__*/React__namespace.forwardRef(function MenuList(props, ref) {
  ...
  React__namespace.useImperativeHandle(actions, () => ({
    adjustStyleForScrollbar: (containerElement, theme) => {
      ...
      if (containerElement.clientHeight < listRef.current.clientHeight && noExplicitWidth) {
        const scrollbarSize = `${getScrollbarSize["default"](ownerDocument["default"](containerElement))}px`;
  ...
  const handleRef = useForkRef["default"](listRef, ref);
  ...
  return /*#__PURE__*/jsxRuntime.jsx(List["default"], _extends["default"]({
    role: "menu",
    ref: handleRef,
    className: className,
...
process.env.NODE_ENV !== "production" ? MenuList.propTypes /* remove-proptypes */ = {
   ...
   * @default false
   */
  autoFocusItem: PropTypes__default["default"].bool,
  /**
