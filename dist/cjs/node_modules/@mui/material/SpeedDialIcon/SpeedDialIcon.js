...
var Add = require('../internal/svg-icons/Add.js');
var speedDialIconClasses = require('./speedDialIconClasses.js');
...
const useUtilityClasses = ownerState => {
  ...
  return composeClasses["default"](slots, speedDialIconClasses.getSpeedDialIconUtilityClass, classes);
};
const SpeedDialIconRoot = styled["default"]('span', {
  ...
  overridesResolver: (props, styles) => {
    ...
    return [{
      [`& .${speedDialIconClasses["default"].icon}`]: styles.icon
    }, {
      [`& .${speedDialIconClasses["default"].icon}`]: ownerState.open && styles.iconOpen
    }, {
      [`& .${speedDialIconClasses["default"].icon}`]: ownerState.open && ownerState.openIcon && styles.iconWithOpenIconOpen
    }, {
      [`& .${speedDialIconClasses["default"].openIcon}`]: styles.openIcon
    }, {
      [`& .${speedDialIconClasses["default"].openIcon}`]: ownerState.open && styles.openIconOpen
    }, styles.root];
  }
})(({
  theme,
  ...
  height: 24,
  [`& .${speedDialIconClasses["default"].icon}`]: _extends["default"]({
    transition: theme.transitions.create(['transform', 'opacity'], {
      duration: theme.transitions.duration.short
    })
  }, ownerState.open && _extends["default"]({
    transform: 'rotate(45deg)'
  }, ownerState.openIcon && {
    opacity: 0
  })),
  [`& .${speedDialIconClasses["default"].openIcon}`]: _extends["default"]({
    position: 'absolute',
    transition: theme.transitions.create(['transform', 'opacity'], {
      duration: theme.transitions.duration.short
    }),
...
const SpeedDialIcon = /*#__PURE__*/React__namespace.forwardRef(function SpeedDialIcon(inProps, ref) {
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(SpeedDialIconRoot, _extends["default"]({
    className: clsx_m.clsx(classes.root, className),
    ref: ref,
    ownerState: ownerState
  }, other, {
    children: [openIconProp ? formatIcon(openIconProp, classes.openIcon) : null, iconProp ? formatIcon(iconProp, classes.icon) : /*#__PURE__*/jsxRuntime.jsx(Add["default"], {
