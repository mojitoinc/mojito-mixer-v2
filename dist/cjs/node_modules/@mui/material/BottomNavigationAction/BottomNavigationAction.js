...
var bottomNavigationActionClasses = require('./bottomNavigationActionClasses.js');
...
const useUtilityClasses = ownerState => {
  ...
  return composeClasses["default"](slots, bottomNavigationActionClasses.getBottomNavigationActionUtilityClass, classes);
};
const BottomNavigationActionRoot = styled["default"](ButtonBase["default"], {
  ...
  [`&.${bottomNavigationActionClasses["default"].selected}`]: {
    color: (theme.vars || theme).palette.primary.main
  }
}));
const BottomNavigationActionLabel = styled["default"]('span', {
  name: 'MuiBottomNavigationAction',
  slot: 'Label',
...
const BottomNavigationAction = /*#__PURE__*/React__namespace.forwardRef(function BottomNavigationAction(inProps, ref) {
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(BottomNavigationActionRoot, _extends["default"]({
    ref: ref,
    ...
    children: [icon, /*#__PURE__*/jsxRuntime.jsx(BottomNavigationActionLabel, {
