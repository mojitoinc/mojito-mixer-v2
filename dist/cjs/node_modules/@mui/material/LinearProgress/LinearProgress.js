...
const indeterminate1Keyframe = react.keyframes(_t || (_t = _`
  0% {
    left: -35%;
    right: 100%;
  }
...
`));
const indeterminate2Keyframe = react.keyframes(_t2 || (_t2 = _`
  0% {
    left: -200%;
    right: 100%;
  }
...
`));
const bufferKeyframe = react.keyframes(_t3 || (_t3 = _`
  0% {
    opacity: 1;
...
const LinearProgressBar1 = styled["default"]('span', {
  ...
  ownerState
}) => (ownerState.variant === 'indeterminate' || ownerState.variant === 'query') && react.css(_t5 || (_t5 = _`
      width: auto;
...
const LinearProgressBar2 = styled["default"]('span', {
  ...
  ownerState
}) => (ownerState.variant === 'indeterminate' || ownerState.variant === 'query') && react.css(_t6 || (_t6 = _`
      width: auto;
