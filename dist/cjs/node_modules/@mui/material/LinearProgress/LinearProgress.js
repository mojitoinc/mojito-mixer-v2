...
var linearProgressClasses = require('./linearProgressClasses.js');
...
const indeterminate1Keyframe = emotionReact_esm.keyframes(_t || (_t = _`
  0% {
    left: -35%;
    right: 100%;
  }
...
`));
const indeterminate2Keyframe = emotionReact_esm.keyframes(_t2 || (_t2 = _`
  0% {
    left: -200%;
    right: 100%;
  }
...
`));
const bufferKeyframe = emotionReact_esm.keyframes(_t3 || (_t3 = _`
  0% {
    opacity: 1;
...
const useUtilityClasses = ownerState => {
  ...
  const slots = {
    root: ['root', `color${capitalize["default"](color)}`, variant],
    dashed: ['dashed', `dashedColor${capitalize["default"](color)}`],
    bar1: ['bar', `barColor${capitalize["default"](color)}`, (variant === 'indeterminate' || variant === 'query') && 'bar1Indeterminate', variant === 'determinate' && 'bar1Determinate', variant === 'buffer' && 'bar1Buffer'],
    bar2: ['bar', variant !== 'buffer' && `barColor${capitalize["default"](color)}`, variant === 'buffer' && `color${capitalize["default"](color)}`, (variant === 'indeterminate' || variant === 'query') && 'bar2Indeterminate', variant === 'buffer' && 'bar2Buffer']
  };
  return composeClasses["default"](slots, linearProgressClasses.getLinearProgressUtilityClass, classes);
};
const getColorShade = (theme, color) => {
  ...
  return theme.palette.mode === 'light' ? colorManipulator.lighten(theme.palette[color].main, 0.62) : colorManipulator.darken(theme.palette[color].main, 0.5);
};
const LinearProgressRoot = styled["default"]('span', {
  ...
  overridesResolver: (props, styles) => {
    ...
    return [styles.root, styles[`color${capitalize["default"](ownerState.color)}`], styles[ownerState.variant]];
  }
})(({
  ownerState,
  theme
...
const LinearProgressDashed = styled["default"]('span', {
  name: 'MuiLinearProgress',
  slot: 'Dashed',
  overridesResolver: (props, styles) => {
    const {
    ...
    return [styles.dashed, styles[`dashedColor${capitalize["default"](ownerState.color)}`]];
  }
})(({
  ownerState,
  theme
...
}, emotionReact_esm.css(_t4 || (_t4 = _`
    animation: ${0} 3s infinite linear;
  `), bufferKeyframe));
const LinearProgressBar1 = styled["default"]('span', {
  name: 'MuiLinearProgress',
  slot: 'Bar1',
  overridesResolver: (props, styles) => {
    const {
    ...
    return [styles.bar, styles[`barColor${capitalize["default"](ownerState.color)}`], (ownerState.variant === 'indeterminate' || ownerState.variant === 'query') && styles.bar1Indeterminate, ownerState.variant === 'determinate' && styles.bar1Determinate, ownerState.variant === 'buffer' && styles.bar1Buffer];
  }
})(({
  ownerState,
  theme
  ...
  ownerState
}) => (ownerState.variant === 'indeterminate' || ownerState.variant === 'query') && emotionReact_esm.css(_t5 || (_t5 = _`
      width: auto;
      animation: ${0} 2.1s cubic-bezier(0.65, 0.815, 0.735, 0.395) infinite;
    `), indeterminate1Keyframe));
const LinearProgressBar2 = styled["default"]('span', {
  name: 'MuiLinearProgress',
  slot: 'Bar2',
  overridesResolver: (props, styles) => {
    const {
    ...
    return [styles.bar, styles[`barColor${capitalize["default"](ownerState.color)}`], (ownerState.variant === 'indeterminate' || ownerState.variant === 'query') && styles.bar2Indeterminate, ownerState.variant === 'buffer' && styles.bar2Buffer];
  }
})(({
  ownerState,
  theme
  ...
  ownerState
}) => (ownerState.variant === 'indeterminate' || ownerState.variant === 'query') && emotionReact_esm.css(_t6 || (_t6 = _`
      width: auto;
...
const LinearProgress = /*#__PURE__*/React__namespace.forwardRef(function LinearProgress(inProps, ref) {
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(LinearProgressRoot, _extends["default"]({
    ...
    children: [variant === 'buffer' ? /*#__PURE__*/jsxRuntime.jsx(LinearProgressDashed, {
      className: classes.dashed,
      ownerState: ownerState
    }) : null, /*#__PURE__*/jsxRuntime.jsx(LinearProgressBar1, {
      className: classes.bar1,
      ownerState: ownerState,
      style: inlineStyles.bar1
    }), variant === 'determinate' ? null : /*#__PURE__*/jsxRuntime.jsx(LinearProgressBar2, {
...
process.env.NODE_ENV !== "production" ? LinearProgress.propTypes /* remove-proptypes */ = {
   ...
   * @default 'primary'
   */
  color: PropTypes__default["default"] /* @typescript-to-proptypes-ignore */.oneOfType([PropTypes__default["default"].oneOf(['inherit', 'primary', 'secondary']), PropTypes__default["default"].string]),
  /**
   ...
   * Value between 0 and 100.
   */
  valueBuffer: PropTypes__default["default"].number,
  /**
   * The variant to use.
   * Use indeterminate or query when there is no progress value.
   * @default 'indeterminate'
   */
  variant: PropTypes__default["default"].oneOf(['buffer', 'determinate', 'indeterminate', 'query'])
} : void 0;
