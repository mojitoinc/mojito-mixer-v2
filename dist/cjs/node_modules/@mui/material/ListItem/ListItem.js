...
var isMuiElement = require('../../utils/esm/isMuiElement.js');
...
var listItemClasses = require('./listItemClasses.js');
require('../ListItemButton/ListItemButton.js');
var listItemButtonClasses = require('../ListItemButton/listItemButtonClasses.js');
var ListItemSecondaryAction = require('../ListItemSecondaryAction/ListItemSecondaryAction.js');
require('../ListItemSecondaryAction/listItemSecondaryActionClasses.js');
...
const useUtilityClasses = ownerState => {
  ...
  return composeClasses["default"](slots, listItemClasses.getListItemUtilityClass, classes);
};
const ListItemRoot = styled["default"]('div', {
  name: 'MuiListItem',
  slot: 'Root',
  overridesResolver
})(({
  ...
  textAlign: 'left'
}, !ownerState.disablePadding && _extends["default"]({
  paddingTop: 8,
  paddingBottom: 8
}, ownerState.dense && {
  paddingTop: 4,
  ...
  [`& > .${listItemButtonClasses["default"].root}`]: {
    paddingRight: 48
  }
}, {
  [`&.${listItemClasses["default"].focusVisible}`]: {
  ...
  [`&.${listItemClasses["default"].selected}:hover`]: {
...
const ListItemContainer = styled["default"]('li', {
  name: 'MuiListItem',
  slot: 'Container',
...
const ListItem = /*#__PURE__*/React__namespace.forwardRef(function ListItem(inProps, ref) {
  ...
  const {
    ...
    ContainerProps = objectWithoutPropertiesLoose["default"](props.ContainerProps, _excluded),
  ...
  const hasSecondaryAction = children.length && isMuiElement["default"](children[children.length - 1], ['ListItemSecondaryAction']);
  ...
  const handleRef = useForkRef["default"](listItemRef, ref);
  const Root = slots.root || components.Root || ListItemRoot;
  const rootProps = slotProps.root || componentsProps.root || {};
  const componentProps = _extends["default"]({
    className: clsx_m.clsx(classes.root, rootProps.className, className),
    disabled
  }, other);
  let Component = componentProp || 'li';
  if (button) {
    componentProps.component = componentProp || 'div';
    componentProps.focusVisibleClassName = clsx_m.clsx(listItemClasses["default"].focusVisible, focusVisibleClassName);
    Component = ButtonBase["default"];
  }
  ...
  if (hasSecondaryAction) {
    ...
    return /*#__PURE__*/jsxRuntime.jsx(ListContext["default"].Provider, {
      value: childContext,
      children: /*#__PURE__*/jsxRuntime.jsxs(ListItemContainer, _extends["default"]({
        as: ContainerComponent,
        className: clsx_m.clsx(classes.container, ContainerClassName),
        ref: handleRef,
        ownerState: ownerState
      }, ContainerProps, {
        children: [/*#__PURE__*/jsxRuntime.jsx(Root, _extends["default"]({}, rootProps, !isHostComponent["default"](Root) && {
          as: Component,
  ...
  return /*#__PURE__*/jsxRuntime.jsx(ListContext["default"].Provider, {
    value: childContext,
    children: /*#__PURE__*/jsxRuntime.jsxs(Root, _extends["default"]({}, rootProps, {
      as: Component,
      ref: handleRef
    }, !isHostComponent["default"](Root) && {
      ownerState: _extends["default"]({}, ownerState, rootProps.ownerState)
    }, componentProps, {
      children: [children, secondaryAction && /*#__PURE__*/jsxRuntime.jsx(ListItemSecondaryAction["default"], {
...
process.env.NODE_ENV !== "production" ? ListItem.propTypes /* remove-proptypes */ = {
   ...
   * @default 'center'
   */
  alignItems: PropTypes__default["default"].oneOf(['center', 'flex-start']),
  /**
   ...
   * be the last child.
   */
  children: chainPropTypes["default"](PropTypes__default["default"].node, props => {
    ...
    for (let i = children.length - 1; i >= 0; i -= 1) {
      ...
      if (isMuiElement["default"](child, ['ListItemSecondaryAction'])) {
   ...
   * @deprecated
   */
  ContainerComponent: elementTypeAcceptingRef["default"],
  /**
   ...
   * @default false
   */
  disablePadding: PropTypes__default["default"].bool,
  /**
   ...
   */
  secondaryAction: PropTypes__default["default"].node,
  /**
