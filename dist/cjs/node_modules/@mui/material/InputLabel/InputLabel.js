...
var formLabelClasses = require('../FormLabel/formLabelClasses.js');
var useThemeProps = require('../styles/useThemeProps.js');
var styled = require('../styles/styled.js');
var inputLabelClasses = require('./inputLabelClasses.js');
...
const useUtilityClasses = ownerState => {
  ...
  const composedClasses = composeClasses["default"](slots, inputLabelClasses.getInputLabelUtilityClasses, classes);
  return _extends["default"]({}, classes, composedClasses);
};
const InputLabelRoot = styled["default"](FormLabel["default"], {
  ...
  overridesResolver: (props, styles) => {
    ...
    return [{
      [`& .${formLabelClasses["default"].asterisk}`]: styles.asterisk
...
}, ownerState.variant === 'filled' && _extends["default"]({
...
}, ownerState.shrink && _extends["default"]({
  userSelect: 'none',
  pointerEvents: 'auto',
...
})), ownerState.variant === 'outlined' && _extends["default"]({
...
const InputLabel = /*#__PURE__*/React__namespace.forwardRef(function InputLabel(inProps, ref) {
  ...
  return /*#__PURE__*/jsxRuntime.jsx(InputLabelRoot, _extends["default"]({
    "data-shrink": shrink,
...
process.env.NODE_ENV !== "production" ? InputLabel.propTypes /* remove-proptypes */ = {
   ...
   */
  color: PropTypes__default["default"] /* @typescript-to-proptypes-ignore */.oneOfType([PropTypes__default["default"].oneOf(['error', 'info', 'primary', 'secondary', 'success', 'warning']), PropTypes__default["default"].string]),
  /**
   * If `true`, the transition animation is disabled.
   * @default false
   */
  disableAnimation: PropTypes__default["default"].bool,
  /**
   ...
   * FormControl.
   */
  margin: PropTypes__default["default"].oneOf(['dense']),
  /**
   ...
   * @default 'normal'
   */
  size: PropTypes__default["default"] /* @typescript-to-proptypes-ignore */.oneOfType([PropTypes__default["default"].oneOf(['normal', 'small']), PropTypes__default["default"].string]),
  /**
