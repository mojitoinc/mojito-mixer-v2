...
var TransitionGroup = require('../../../react-transition-group/esm/TransitionGroup.js');
require('../../../react-transition-group/esm/Transition.js');
...
var touchRippleClasses = require('./touchRippleClasses.js');
...
const enterKeyframe = emotionReact_esm.keyframes(_t || (_t = _`
  0% {
    transform: scale(0);
    opacity: 0.1;
  }
...
`));
const exitKeyframe = emotionReact_esm.keyframes(_t2 || (_t2 = _`
  0% {
    opacity: 1;
  }
...
`));
const pulsateKeyframe = emotionReact_esm.keyframes(_t3 || (_t3 = _`
  0% {
    transform: scale(1);
  }
...
`));
const TouchRippleRoot = styled["default"]('span', {
  name: 'MuiTouchRipple',
  slot: 'Root'
})({
  overflow: 'hidden',
...
const TouchRippleRipple = styled["default"](Ripple["default"], {
  name: 'MuiTouchRipple',
  slot: 'Ripple'
})(_t4 || (_t4 = _`
  opacity: 0;
...
`), touchRippleClasses["default"].rippleVisible, enterKeyframe, DURATION, ({
  theme
}) => theme.transitions.easing.easeInOut, touchRippleClasses["default"].ripplePulsate, ({
  theme
}) => theme.transitions.duration.shorter, touchRippleClasses["default"].child, touchRippleClasses["default"].childLeaving, exitKeyframe, DURATION, ({
  theme
}) => theme.transitions.easing.easeInOut, touchRippleClasses["default"].childPulsate, pulsateKeyframe, ({
  theme
...
const TouchRipple = /*#__PURE__*/React__namespace.forwardRef(function TouchRipple(inProps, ref) {
  ...
  const startCommit = React__namespace.useCallback(params => {
    ...
    setRipples(oldRipples => [...oldRipples, /*#__PURE__*/jsxRuntime.jsx(TouchRippleRipple, {
      classes: {
        ripple: clsx_m.clsx(classes.ripple, touchRippleClasses["default"].ripple),
        rippleVisible: clsx_m.clsx(classes.rippleVisible, touchRippleClasses["default"].rippleVisible),
        ripplePulsate: clsx_m.clsx(classes.ripplePulsate, touchRippleClasses["default"].ripplePulsate),
        child: clsx_m.clsx(classes.child, touchRippleClasses["default"].child),
        childLeaving: clsx_m.clsx(classes.childLeaving, touchRippleClasses["default"].childLeaving),
        childPulsate: clsx_m.clsx(classes.childPulsate, touchRippleClasses["default"].childPulsate)
      },
      timeout: DURATION,
      pulsate: pulsate,
      rippleX: rippleX,
  ...
  return /*#__PURE__*/jsxRuntime.jsx(TouchRippleRoot, _extends["default"]({
    className: clsx_m.clsx(touchRippleClasses["default"].root, classes.root, className),
    ref: container
  }, other, {
    children: /*#__PURE__*/jsxRuntime.jsx(TransitionGroup["default"], {
      component: null,
      exit: true,
      children: ripples
    })
