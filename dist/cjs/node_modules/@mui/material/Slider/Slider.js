...
const SliderThumb = styled["default"]('span', {
  ...
  [`&:hover, &.${sliderClasses.focusVisible}`]: {
    boxShadow: `0px 0px 0px 8px ${theme.vars ? `rgba(${theme.vars.palette[ownerState.color].mainChannel} / 0.16)` : colorManipulator.alpha(theme.palette[ownerState.color].main, 0.16)}`,
    '@media (hover: none)': {
      boxShadow: 'none'
    }
  },
  [`&.${sliderClasses.active}`]: {
    boxShadow: `0px 0px 0px 14px ${theme.vars ? `rgba(${theme.vars.palette[ownerState.color].mainChannel} / 0.16)` : colorManipulator.alpha(theme.palette[ownerState.color].main, 0.16)}`
  },
  [`&.${sliderClasses.disabled}`]: {
    '&:hover': {
      boxShadow: 'none'
...
const extendUtilityClasses = ownerState => {
  ...
  return _extends["default"]({}, classes, {
    root: clsx_m.clsx(classes.root, sliderUnstyledClasses.getSliderUtilityClass(`color${capitalize["default"](color)}`), classes[`color${capitalize["default"](color)}`], size && [sliderUnstyledClasses.getSliderUtilityClass(`size${capitalize["default"](size)}`), classes[`size${capitalize["default"](size)}`]]),
    thumb: clsx_m.clsx(classes.thumb, sliderUnstyledClasses.getSliderUtilityClass(`thumbColor${capitalize["default"](color)}`), classes[`thumbColor${capitalize["default"](color)}`], size && [sliderUnstyledClasses.getSliderUtilityClass(`thumbSize${capitalize["default"](size)}`), classes[`thumbSize${capitalize["default"](size)}`]])
  });
};
const Slider = /*#__PURE__*/React__namespace.forwardRef(function Slider(inputProps, ref) {
  ...
  return /*#__PURE__*/jsxRuntime.jsx(SliderUnstyled["default"], _extends["default"]({}, other, {
    ...
    slotProps: _extends["default"]({}, componentsProps, {
      root: _extends["default"]({}, rootSlotProps, shouldSpreadAdditionalProps["default"](RootSlot) && {
        as: component,
        ownerState: _extends["default"]({}, rootSlotProps == null ? void 0 : rootSlotProps.ownerState, {
          color,
          size
        })
      }),
      rail: railSlotProps,
      thumb: _extends["default"]({}, thumbSlotProps, shouldSpreadAdditionalProps["default"](ThumbSlot) && {
        ownerState: _extends["default"]({}, thumbSlotProps == null ? void 0 : thumbSlotProps.ownerState, {
          color,
          size
        })
      }),
      track: _extends["default"]({}, trackSlotProps, shouldSpreadAdditionalProps["default"](TrackSlot) && {
        ownerState: _extends["default"]({}, trackSlotProps == null ? void 0 : trackSlotProps.ownerState, {
          color,
          size
        })
      }),
      valueLabel: _extends["default"]({}, valueLabelSlotProps, shouldSpreadAdditionalProps["default"](ValueLabelSlot) && {
        ownerState: _extends["default"]({}, valueLabelSlotProps == null ? void 0 : valueLabelSlotProps.ownerState, {
          color,
          size
        })
      }),
...
process.env.NODE_ENV !== "production" ? Slider.propTypes /* remove-proptypes */ = {
   ...
   * @default 'primary'
   */
  color: PropTypes__default["default"] /* @typescript-to-proptypes-ignore */.oneOfType([PropTypes__default["default"].oneOf(['primary', 'secondary']), PropTypes__default["default"].string]),
  /**
  ...
  componentsProps: PropTypes__default["default"].shape({
    ...
    valueLabel: PropTypes__default["default"].oneOfType([PropTypes__default["default"].func, PropTypes__default["default"].shape({
