...
var resolveProps = require('../../utils/esm/resolveProps.js');
...
const useUtilityClasses = ownerState => {
  ...
  const slots = {
    root: ['root', variant, `${variant}${capitalize["default"](color)}`, `size${capitalize["default"](size)}`, `${variant}Size${capitalize["default"](size)}`, color === 'inherit' && 'colorInherit', disableElevation && 'disableElevation', fullWidth && 'fullWidth'],
    label: ['label'],
    startIcon: ['startIcon', `iconSize${capitalize["default"](size)}`],
    endIcon: ['endIcon', `iconSize${capitalize["default"](size)}`]
  };
...
const commonIconStyles = ownerState => _extends["default"]({}, ownerState.size === 'small' && {
  '& > *:nth-of-type(1)': {
    fontSize: 18
  }
...
const ButtonRoot = styled["default"](ButtonBase["default"], {
  ...
  return _extends["default"]({}, theme.typography.button, {
    ...
    '&:hover': _extends["default"]({
      textDecoration: 'none',
      backgroundColor: theme.vars ? `rgba(${theme.vars.palette.text.primaryChannel} / ${theme.vars.palette.action.hoverOpacity})` : colorManipulator.alpha(theme.palette.text.primary, theme.palette.action.hoverOpacity),
    ...
    '&:active': _extends["default"]({}, ownerState.variant === 'contained' && {
      boxShadow: (theme.vars || theme).shadows[8]
    }),
    [`&.${buttonClasses["default"].focusVisible}`]: _extends["default"]({}, ownerState.variant === 'contained' && {
      boxShadow: (theme.vars || theme).shadows[6]
    }),
    [`&.${buttonClasses["default"].disabled}`]: _extends["default"]({
    ...
    color: (theme.vars || theme).palette[ownerState.color].main,
    border: theme.vars ? `1px solid rgba(${theme.vars.palette[ownerState.color].mainChannel} / 0.5)` : `1px solid ${colorManipulator.alpha(theme.palette[ownerState.color].main, 0.5)}`
  }, ownerState.variant === 'contained' && {
    color: theme.vars ?
...
const ButtonStartIcon = styled["default"]('span', {
  ...
  overridesResolver: (props, styles) => {
    ...
    return [styles.startIcon, styles[`iconSize${capitalize["default"](ownerState.size)}`]];
  }
})(({
  ownerState
}) => _extends["default"]({
...
const ButtonEndIcon = styled["default"]('span', {
  ...
  overridesResolver: (props, styles) => {
    ...
    return [styles.endIcon, styles[`iconSize${capitalize["default"](ownerState.size)}`]];
  }
})(({
  ownerState
}) => _extends["default"]({
...
const Button = /*#__PURE__*/React__namespace.forwardRef(function Button(inProps, ref) {
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(ButtonRoot, _extends["default"]({
    ownerState: ownerState,
    className: clsx_m.clsx(contextProps.className, classes.root, className),
    component: component,
    disabled: disabled,
    focusRipple: !disableFocusRipple,
    focusVisibleClassName: clsx_m.clsx(classes.focusVisible, focusVisibleClassName),
    ref: ref,
    type: type
  }, other, {
    classes: classes,
...
process.env.NODE_ENV !== "production" ? Button.propTypes /* remove-proptypes */ = {
   ...
   * @default 'primary'
   */
  color: PropTypes__default["default"] /* @typescript-to-proptypes-ignore */.oneOfType([PropTypes__default["default"].oneOf(['inherit', 'primary', 'secondary', 'success', 'error', 'info', 'warning']), PropTypes__default["default"].string]),
  /**
   ...
   * @default false
   */
  disableElevation: PropTypes__default["default"].bool,
  /**
   ...
   */
  endIcon: PropTypes__default["default"].node,
  /**
   * @ignore
   */
   ...
   */
  startIcon: PropTypes__default["default"].node,
  /**
   ...
   * @default 'text'
   */
  variant: PropTypes__default["default"] /* @typescript-to-proptypes-ignore */.oneOfType([PropTypes__default["default"].oneOf(['contained', 'outlined', 'text']), PropTypes__default["default"].string])
} : void 0;
