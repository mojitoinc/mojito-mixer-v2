...
var useThemeWithoutDefault = require('../../system/esm/useThemeWithoutDefault.js');
...
require('../styles/createPalette.js');
require('../styles/shadows.js');
require('../styles/defaultTheme.js');
var useThemeProps = require('../styles/useThemeProps.js');
var styled = require('../styles/styled.js');
require('../styles/CssVarsProvider.js');
require('../styles/experimental_extendTheme.js');
...
const PopperRoot = styled["default"](PopperUnstyled["default"], {
  name: 'MuiPopper',
  slot: 'Root',
...
const Popper = /*#__PURE__*/React__namespace.forwardRef(function Popper(inProps, ref) {
  var _slots$root;
  const theme = useThemeWithoutDefault["default"]();
  ...
  return /*#__PURE__*/jsxRuntime.jsx(PopperRoot, _extends["default"]({
...
process.env.NODE_ENV !== "production" ? Popper.propTypes /* remove-proptypes */ = {
   ...
   */
  anchorEl: PropTypes__default["default"] /* @typescript-to-proptypes-ignore */.oneOfType([HTMLElementType["default"], PropTypes__default["default"].object, PropTypes__default["default"].func]),
  /**
   * Popper render function or node.
   */
  children: PropTypes__default["default"] /* @typescript-to-proptypes-ignore */.oneOfType([PropTypes__default["default"].node, PropTypes__default["default"].func]),
  /**
   * @ignore
   */
  component: PropTypes__default["default"] /* @typescript-to-proptypes-ignore */.elementType,
  /**
   ...
   */
  modifiers: PropTypes__default["default"].arrayOf(PropTypes__default["default"].shape({
    data: PropTypes__default["default"].object,
    effect: PropTypes__default["default"].func,
    enabled: PropTypes__default["default"].bool,
    fn: PropTypes__default["default"].func,
    name: PropTypes__default["default"].any,
    options: PropTypes__default["default"].object,
    phase: PropTypes__default["default"].oneOf(['afterMain', 'afterRead', 'afterWrite', 'beforeMain', 'beforeRead', 'beforeWrite', 'main', 'read', 'write']),
    requires: PropTypes__default["default"].arrayOf(PropTypes__default["default"].string),
    requiresIfExists: PropTypes__default["default"].arrayOf(PropTypes__default["default"].string)
  })),
  /**
   ...
   * @ignore
   */
  ownerState: PropTypes__default["default"].any,
  /**
   * Popper placement.
   * @default 'bottom'
   */
  placement: PropTypes__default["default"].oneOf(['auto-end', 'auto-start', 'auto', 'bottom-end', 'bottom-start', 'bottom', 'left-end', 'left-start', 'left', 'right-end', 'right-start', 'right', 'top-end', 'top-start', 'top']),
  /**
   * Options provided to the [`Popper.js`](https://popper.js.org/docs/v2/constructors/#options) instance.
   * @default {}
   */
  popperOptions: PropTypes__default["default"].shape({
    modifiers: PropTypes__default["default"].array,
    onFirstUpdate: PropTypes__default["default"].func,
    placement: PropTypes__default["default"].oneOf(['auto-end', 'auto-start', 'auto', 'bottom-end', 'bottom-start', 'bottom', 'left-end', 'left-start', 'left', 'right-end', 'right-start', 'right', 'top-end', 'top-start', 'top']),
    strategy: PropTypes__default["default"].oneOf(['absolute', 'fixed'])
  }),
  /**
