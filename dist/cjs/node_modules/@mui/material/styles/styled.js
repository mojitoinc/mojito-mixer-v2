...
var createStyled = require('../../system/esm/createStyled.js');
...
const rootShouldForwardProp = prop => createStyled.shouldForwardProp(prop) && prop !== 'classes';
const slotShouldForwardProp = createStyled.shouldForwardProp;
