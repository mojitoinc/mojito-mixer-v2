...
function createTypography(palette, typography) {
  const _ref = typeof typography === 'function' ? typography(palette) : typography,
    ...
    other = objectWithoutPropertiesLoose["default"](_ref, _excluded);
  ...
  const buildVariant = (fontWeight, size, lineHeight, letterSpacing, casing) => _extends["default"]({
    fontFamily,
    fontWeight,
  ...
  return deepmerge["default"](_extends["default"]({
    htmlFontSize,
    pxToRem,
    fontFamily,
    fontSize,
