...
var requirePropFactory = require('../../utils/esm/requirePropFactory.js');
...
var breakpoints = require('../../system/esm/breakpoints.js');
...
var gridClasses = require('./gridClasses.js');
...
function generateGrid({
  ...
  return theme.breakpoints.keys.reduce((globalStyles, breakpoint) => {
    ...
    if (size === true) {
      ...
      const columnsBreakpointValues = breakpoints.resolveBreakpointValues({
...
function generateDirection({
  ...
  return breakpoints.handleBreakpoints({
    theme
    ...
    if (propValue.indexOf('column') === 0) {
      output[`& > .${gridClasses["default"].item}`] = {
        maxWidth: 'none'
      };
    }
    return output;
...
function generateRowGap({
  ...
  if (container && rowSpacing !== 0) {
    const rowSpacingValues = breakpoints.resolveBreakpointValues({
      values: rowSpacing,
      breakpoints: theme.breakpoints.values
    });
    ...
    styles = breakpoints.handleBreakpoints({
      theme
...
function generateColumnGap({
  ...
  if (container && columnSpacing !== 0) {
    const columnSpacingValues = breakpoints.resolveBreakpointValues({
...
const GridRoot = styled["default"]('div', {
  name: 'MuiGrid',
  slot: 'Root',
...
const useUtilityClasses = ownerState => {
  ...
  return composeClasses["default"](slots, gridClasses.getGridUtilityClass, classes);
};
const Grid = /*#__PURE__*/React__namespace.forwardRef(function Grid(inProps, ref) {
  ...
  const props = extendSxProp["default"](themeProps);
  const {
      className,
      columns: columnsProp,
  ...
  const columnsContext = React__namespace.useContext(GridContext["default"]);

  // columns set with default breakpoint unit of 12
  const columns = container ? columnsProp || 12 : columnsContext;
  const breakpointsValues = {};
  const otherFiltered = _extends["default"]({}, other);
  ...
  return /*#__PURE__*/jsxRuntime.jsx(GridContext["default"].Provider, {
    value: columns,
    children: /*#__PURE__*/jsxRuntime.jsx(GridRoot, _extends["default"]({
...
process.env.NODE_ENV !== "production" ? Grid.propTypes /* remove-proptypes */ = {
   ...
   * @default false
   */
  zeroMinWidth: PropTypes__default["default"].bool
} : void 0;
if (process.env.NODE_ENV !== 'production') {
  const requireProp = requirePropFactory["default"]('Grid', Grid);
  // eslint-disable-next-line no-useless-concat
  Grid['propTypes' + ''] = _extends["default"]({}, Grid.propTypes, {
