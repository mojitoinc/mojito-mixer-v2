...
var formControlClasses = require('./formControlClasses.js');
...
const useUtilityClasses = ownerState => {
  ...
  const slots = {
    root: ['root', margin !== 'none' && `margin${capitalize["default"](margin)}`, fullWidth && 'fullWidth']
  };
  return composeClasses["default"](slots, formControlClasses.getFormControlUtilityClasses, classes);
};
const FormControlRoot = styled["default"]('div', {
  name: 'MuiFormControl',
  slot: 'Root',
  overridesResolver: ({
    ownerState
  }, styles) => {
    return _extends["default"]({}, styles.root, styles[`margin${capitalize["default"](ownerState.margin)}`], ownerState.fullWidth && styles.fullWidth);
  }
})(({
  ownerState
}) => _extends["default"]({
...
const FormControl = /*#__PURE__*/React__namespace.forwardRef(function FormControl(inProps, ref) {
  ...
  const [adornedStart, setAdornedStart] = React__namespace.useState(() => {
    ...
    if (children) {
      React__namespace.Children.forEach(children, child => {
        if (!isMuiElement["default"](child, ['Input', 'Select'])) {
          return;
        }
        const input = isMuiElement["default"](child, ['Select']) ? child.props.input : child;
        if (input && utils.isAdornedStart(input.props)) {
  ...
  const [filled, setFilled] = React__namespace.useState(() => {
    ...
    if (children) {
      React__namespace.Children.forEach(children, child => {
        ...
        if (utils.isFilled(child.props, true)) {
          initialFilled = true;
        }
      });
    }
  ...
  return /*#__PURE__*/jsxRuntime.jsx(FormControlContext["default"].Provider, {
    value: childContext,
    children: /*#__PURE__*/jsxRuntime.jsx(FormControlRoot, _extends["default"]({
      as: component,
