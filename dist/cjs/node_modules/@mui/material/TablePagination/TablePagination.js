...
require('../InputBase/inputBaseClasses.js');
var MenuItem = require('../MenuItem/MenuItem.js');
require('../MenuItem/menuItemClasses.js');
var Select = require('../Select/Select.js');
require('../Select/selectClasses.js');
var TableCell = require('../TableCell/TableCell.js');
require('../TableCell/tableCellClasses.js');
var Toolbar = require('../Toolbar/Toolbar.js');
require('../Toolbar/toolbarClasses.js');
var TablePaginationActions = require('./TablePaginationActions.js');
var tablePaginationClasses = require('./tablePaginationClasses.js');
...
const TablePaginationRoot = styled["default"](TableCell["default"], {
...
const TablePaginationToolbar = styled["default"](Toolbar["default"], {
  name: 'MuiTablePagination',
  slot: 'Toolbar',
  overridesResolver: (props, styles) => _extends["default"]({
    [`& .${tablePaginationClasses["default"].actions}`]: styles.actions
  }, styles.toolbar)
})(({
  theme
}) => ({
  ...
  [`& .${tablePaginationClasses["default"].actions}`]: {
    flexShrink: 0,
    marginLeft: 20
  }
}));
const TablePaginationSpacer = styled["default"]('div', {
  name: 'MuiTablePagination',
  slot: 'Spacer',
...
const TablePaginationSelectLabel = styled["default"]('p', {
  name: 'MuiTablePagination',
  slot: 'SelectLabel',
...
const TablePaginationSelect = styled["default"](Select["default"], {
  name: 'MuiTablePagination',
  slot: 'Select',
  overridesResolver: (props, styles) => _extends["default"]({
    [`& .${tablePaginationClasses["default"].selectIcon}`]: styles.selectIcon,
    [`& .${tablePaginationClasses["default"].select}`]: styles.select
  ...
  marginRight: 32,
  marginLeft: 8,
  [`& .${tablePaginationClasses["default"].select}`]: {
    paddingLeft: 8,
    paddingRight: 24,
    textAlign: 'right',
...
const TablePaginationMenuItem = styled["default"](MenuItem["default"], {
  name: 'MuiTablePagination',
  slot: 'MenuItem',
  overridesResolver: (props, styles) => styles.menuItem
})({});
const TablePaginationDisplayedRows = styled["default"]('p', {
  name: 'MuiTablePagination',
  slot: 'DisplayedRows',
...
const useUtilityClasses = ownerState => {
  ...
  return composeClasses["default"](slots, tablePaginationClasses.getTablePaginationUtilityClass, classes);
};
...
const TablePagination = /*#__PURE__*/React__namespace.forwardRef(function TablePagination(inProps, ref) {
  ...
  let colSpan;
  if (component === TableCell["default"] || component === 'td') {
    colSpan = colSpanProp || 1000; // col-span over everything
  }

  const selectId = useId["default"](SelectProps.id);
  const labelId = useId["default"](SelectProps.labelId);
  ...
  return /*#__PURE__*/jsxRuntime.jsx(TablePaginationRoot, _extends["default"]({
    colSpan: colSpan,
    ref: ref,
    as: component,
    ...
    children: /*#__PURE__*/jsxRuntime.jsxs(TablePaginationToolbar, {
      ...
      children: [/*#__PURE__*/jsxRuntime.jsx(TablePaginationSpacer, {
      ...
      }), rowsPerPageOptions.length > 1 && /*#__PURE__*/jsxRuntime.jsx(TablePaginationSelect, _extends["default"]({
        variant: "standard"
      }, !SelectProps.variant && {
        input: _InputBase || (_InputBase = /*#__PURE__*/jsxRuntime.jsx(InputBase["default"], {}))
      }, {
        value: rowsPerPage,
        ...
        classes: _extends["default"]({}, SelectProps.classes, {
          // TODO v5 remove `classes.input`
          root: clsx_m.clsx(classes.input, classes.selectRoot, (SelectProps.classes || {}).root),
          select: clsx_m.clsx(classes.select, (SelectProps.classes || {}).select),
          // TODO v5 remove `selectIcon`
          icon: clsx_m.clsx(classes.selectIcon, (SelectProps.classes || {}).icon)
        }),
        children: rowsPerPageOptions.map(rowsPerPageOption => /*#__PURE__*/React.createElement(MenuItemComponent, _extends["default"]({}, !isHostComponent["default"](MenuItemComponent) && {
          ownerState
        }, {
...
process.env.NODE_ENV !== "production" ? TablePagination.propTypes /* remove-proptypes */ = {
   ...
   */
  ActionsComponent: PropTypes__default["default"].elementType,
  /**
   ...
   */
  count: integerPropType["default"].isRequired,
  /**
   ...
   * }
   */
  getItemAriaLabel: PropTypes__default["default"].func,
  /**
   ...
   * }
   */
  labelDisplayedRows: PropTypes__default["default"].func,
  /**
   ...
   */
  labelRowsPerPage: PropTypes__default["default"].node,
  /**
   ...
   */
  page: chainPropTypes["default"](integerPropType["default"].isRequired, props => {
    const {
      count,
      page,
      rowsPerPage
   ...
   */
  rowsPerPage: integerPropType["default"].isRequired,
  /**
   ...
   */
  rowsPerPageOptions: PropTypes__default["default"].arrayOf(PropTypes__default["default"].oneOfType([PropTypes__default["default"].number, PropTypes__default["default"].shape({
   ...
   * @default false
   */
  showFirstButton: PropTypes__default["default"].bool,
  /**
   * If `true`, show the last-page button.
   * @default false
   */
  showLastButton: PropTypes__default["default"].bool,
  /**
