...
var snackbarContentClasses = require('./snackbarContentClasses.js');
...
const useUtilityClasses = ownerState => {
  ...
  return composeClasses["default"](slots, snackbarContentClasses.getSnackbarContentUtilityClass, classes);
};
const SnackbarContentRoot = styled["default"](Paper["default"], {
  ...
  const backgroundColor = colorManipulator.emphasize(theme.palette.background.default, emphasis);
...
const SnackbarContentMessage = styled["default"]('div', {
  name: 'MuiSnackbarContent',
  slot: 'Message',
...
const SnackbarContentAction = styled["default"]('div', {
  name: 'MuiSnackbarContent',
  slot: 'Action',
...
const SnackbarContent = /*#__PURE__*/React__namespace.forwardRef(function SnackbarContent(inProps, ref) {
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(SnackbarContentRoot, _extends["default"]({
    role: role,
    square: true,
    elevation: 6,
