...
var stepClasses = require('./stepClasses.js');
...
const useUtilityClasses = ownerState => {
  ...
  return composeClasses["default"](slots, stepClasses.getStepUtilityClass, classes);
};
const StepRoot = styled["default"]('div', {
  name: 'MuiStep',
  slot: 'Root',
  ...
  ownerState
}) => _extends["default"]({}, ownerState.orientation === 'horizontal' && {
  paddingLeft: 8,
  paddingRight: 8
...
const Step = /*#__PURE__*/React__namespace.forwardRef(function Step(inProps, ref) {
  ...
  const newChildren = /*#__PURE__*/jsxRuntime.jsxs(StepRoot, _extends["default"]({
    as: component,
  ...
  return /*#__PURE__*/jsxRuntime.jsx(StepContext["default"].Provider, {
    value: contextValue,
    children: connector && !alternativeLabel && index !== 0 ? /*#__PURE__*/jsxRuntime.jsxs(React__namespace.Fragment, {
