...
var iconClasses = require('./iconClasses.js');
...
const useUtilityClasses = ownerState => {
  ...
  return composeClasses["default"](slots, iconClasses.getIconUtilityClass, classes);
};
const IconRoot = styled["default"]('span', {
  name: 'MuiIcon',
  slot: 'Root',
...
const Icon = /*#__PURE__*/React__namespace.forwardRef(function Icon(inProps, ref) {
  ...
  return /*#__PURE__*/jsxRuntime.jsx(IconRoot, _extends["default"]({
    as: Component,
    className: clsx_m.clsx(baseClassName,
...
process.env.NODE_ENV !== "production" ? Icon.propTypes /* remove-proptypes */ = {
   ...
   */
  baseClassName: PropTypes__default["default"].string,
  /**
