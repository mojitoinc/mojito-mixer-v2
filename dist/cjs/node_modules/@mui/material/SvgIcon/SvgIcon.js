...
var svgIconClasses = require('./svgIconClasses.js');
...
const useUtilityClasses = ownerState => {
  ...
  const slots = {
    root: ['root', color !== 'inherit' && `color${capitalize["default"](color)}`, `fontSize${capitalize["default"](fontSize)}`]
  };
  return composeClasses["default"](slots, svgIconClasses.getSvgIconUtilityClass, classes);
};
const SvgIconRoot = styled["default"]('svg', {
  name: 'MuiSvgIcon',
  slot: 'Root',
  overridesResolver: (props, styles) => {
    ...
    return [styles.root, ownerState.color !== 'inherit' && styles[`color${capitalize["default"](ownerState.color)}`], styles[`fontSize${capitalize["default"](ownerState.fontSize)}`]];
  }
})(({
  theme,
  ownerState
...
const SvgIcon = /*#__PURE__*/React__namespace.forwardRef(function SvgIcon(inProps, ref) {
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(SvgIconRoot, _extends["default"]({
    as: component,
...
process.env.NODE_ENV !== "production" ? SvgIcon.propTypes /* remove-proptypes */ = {
   ...
   * @default 'inherit'
   */
  color: PropTypes__default["default"] /* @typescript-to-proptypes-ignore */.oneOfType([PropTypes__default["default"].oneOf(['inherit', 'action', 'disabled', 'primary', 'secondary', 'error', 'info', 'success', 'warning']), PropTypes__default["default"].string]),
  /**
   ...
   * @default 'medium'
   */
  fontSize: PropTypes__default["default"] /* @typescript-to-proptypes-ignore */.oneOfType([PropTypes__default["default"].oneOf(['inherit', 'large', 'medium', 'small']), PropTypes__default["default"].string]),
  /**
   * Applies a color attribute to the SVG element.
   */
  htmlColor: PropTypes__default["default"].string,
  /**
   ...
   * @default false
   */
  inheritViewBox: PropTypes__default["default"].bool,
  /**
   * The shape-rendering attribute. The behavior of the different options is described on the
   * [MDN Web Docs](https://developer.mozilla.org/en-US/docs/Web/SVG/Attribute/shape-rendering).
   * If you are having issues with blurry icons you should investigate this prop.
   */
  shapeRendering: PropTypes__default["default"].string,
  /**
   ...
   */
  titleAccess: PropTypes__default["default"].string,
  /**
