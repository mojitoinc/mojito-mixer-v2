...
var imageListItemBarClasses = require('./imageListItemBarClasses.js');
...
const useUtilityClasses = ownerState => {
  ...
  const slots = {
    ...
    titleWrap: ['titleWrap', `titleWrap${capitalize["default"](position)}`, actionIcon && `titleWrapActionPos${capitalize["default"](actionPosition)}`],
    title: ['title'],
    subtitle: ['subtitle'],
    actionIcon: ['actionIcon', `actionIconActionPos${capitalize["default"](actionPosition)}`]
  };
  return composeClasses["default"](slots, imageListItemBarClasses.getImageListItemBarUtilityClass, classes);
};
const ImageListItemBarRoot = styled["default"]('div', {
...
const ImageListItemBarTitleWrap = styled["default"]('div', {
  name: 'MuiImageListItemBar',
  slot: 'TitleWrap',
  overridesResolver: (props, styles) => {
    const {
    ...
    return [styles.titleWrap, styles[`titleWrap${capitalize["default"](ownerState.position)}`], ownerState.actionIcon && styles[`titleWrapActionPos${capitalize["default"](ownerState.actionPosition)}`]];
  }
})(({
  theme,
  ownerState
...
const ImageListItemBarTitle = styled["default"]('div', {
  name: 'MuiImageListItemBar',
  slot: 'Title',
...
const ImageListItemBarSubtitle = styled["default"]('div', {
  name: 'MuiImageListItemBar',
  slot: 'Subtitle',
...
const ImageListItemBarActionIcon = styled["default"]('div', {
  name: 'MuiImageListItemBar',
  slot: 'ActionIcon',
  overridesResolver: (props, styles) => {
    const {
    ...
    return [styles.actionIcon, styles[`actionIconActionPos${capitalize["default"](ownerState.actionPosition)}`]];
  }
})(({
  ownerState
}) => {
  return _extends["default"]({}, ownerState.actionPosition === 'left' && {
    order: -1
  });
});
const ImageListItemBar = /*#__PURE__*/React__namespace.forwardRef(function ImageListItemBar(inProps, ref) {
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(ImageListItemBarRoot, _extends["default"]({
    ownerState: ownerState,
    className: clsx_m.clsx(classes.root, className),
    ref: ref
  }, other, {
    children: [/*#__PURE__*/jsxRuntime.jsxs(ImageListItemBarTitleWrap, {
      ownerState: ownerState,
      className: classes.titleWrap,
      children: [/*#__PURE__*/jsxRuntime.jsx(ImageListItemBarTitle, {
        className: classes.title,
        children: title
      }), subtitle ? /*#__PURE__*/jsxRuntime.jsx(ImageListItemBarSubtitle, {
        className: classes.subtitle,
        children: subtitle
      }) : null]
    }), actionIcon ? /*#__PURE__*/jsxRuntime.jsx(ImageListItemBarActionIcon, {
      ownerState: ownerState,
...
process.env.NODE_ENV !== "production" ? ImageListItemBar.propTypes /* remove-proptypes */ = {
   ...
   */
  actionIcon: PropTypes__default["default"].node,
  /**
   * Position of secondary action IconButton.
   * @default 'right'
   */
  actionPosition: PropTypes__default["default"].oneOf(['left', 'right']),
  /**
   * @ignore
   */
   ...
   * @default 'bottom'
   */
  position: PropTypes__default["default"].oneOf(['below', 'bottom', 'top']),
  /**
...
exports["default"] = ImageListItemBar;
