...
var createTransitions = require('../styles/createTransitions.js');
...
var collapseClasses = require('./collapseClasses.js');
...
const useUtilityClasses = ownerState => {
  ...
  return composeClasses["default"](slots, collapseClasses.getCollapseUtilityClass, classes);
};
const CollapseRoot = styled["default"]('div', {
  name: 'MuiCollapse',
  slot: 'Root',
...
}, ownerState.state === 'entered' && _extends["default"]({
  height: 'auto',
  overflow: 'visible'
}, ownerState.orientation === 'horizontal' && {
  width: 'auto'
...
const CollapseWrapper = styled["default"]('div', {
  name: 'MuiCollapse',
  slot: 'Wrapper',
...
const CollapseWrapperInner = styled["default"]('div', {
  name: 'MuiCollapse',
  slot: 'WrapperInner',
...
const Collapse = /*#__PURE__*/React__namespace.forwardRef(function Collapse(inProps, ref) {
  ...
  const {
      ...
      style,
      timeout = createTransitions.duration.standard,
  ...
  const handleRef = useForkRef["default"](ref, nodeRef);
  ...
  return /*#__PURE__*/jsxRuntime.jsx(TransitionComponent, _extends["default"]({
    ...
    children: (state, childProps) => /*#__PURE__*/jsxRuntime.jsx(CollapseRoot, _extends["default"]({
      as: component,
...
process.env.NODE_ENV !== "production" ? Collapse.propTypes /* remove-proptypes */ = {
   ...
   * @default '0px'
   */
  collapsedSize: PropTypes__default["default"].oneOfType([PropTypes__default["default"].number, PropTypes__default["default"].string]),
  /**
   ...
   */
  timeout: PropTypes__default["default"].oneOfType([PropTypes__default["default"].oneOf(['auto']), PropTypes__default["default"].number, PropTypes__default["default"].shape({
