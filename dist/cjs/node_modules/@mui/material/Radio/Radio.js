...
var useRadioGroup = require('../RadioGroup/useRadioGroup.js');
var radioClasses = require('./radioClasses.js');
...
const useUtilityClasses = ownerState => {
  ...
  const slots = {
    root: ['root', `color${capitalize["default"](color)}`]
  };
  return _extends["default"]({}, classes, composeClasses["default"](slots, radioClasses.getRadioUtilityClass, classes));
};
const RadioRoot = styled["default"](SwitchBase["default"], {
  ...
  overridesResolver: (props, styles) => {
    ...
    return [styles.root, styles[`color${capitalize["default"](ownerState.color)}`]];
  }
})(({
  theme,
  ownerState
  ...
  '&:hover': {
    backgroundColor: theme.vars ? `rgba(${ownerState.color === 'default' ? theme.vars.palette.action.activeChannel : theme.vars.palette[ownerState.color].mainChannel} / ${theme.vars.palette.action.hoverOpacity})` : colorManipulator.alpha(ownerState.color === 'default' ? theme.palette.action.active : theme.palette[ownerState.color].main, theme.palette.action.hoverOpacity),
  ...
  [`&.${radioClasses["default"].checked}`]: {
    color: (theme.vars || theme).palette[ownerState.color].main
  }
}, {
  [`&.${radioClasses["default"].disabled}`]: {
...
const defaultCheckedIcon = /*#__PURE__*/jsxRuntime.jsx(RadioButtonIcon["default"], {
  checked: true
});
const defaultIcon = /*#__PURE__*/jsxRuntime.jsx(RadioButtonIcon["default"], {});
const Radio = /*#__PURE__*/React__namespace.forwardRef(function Radio(inProps, ref) {
  ...
  const radioGroup = useRadioGroup["default"]();
  let checked = checkedProp;
  const onChange = createChainedFunction["default"](onChangeProp, radioGroup && radioGroup.onChange);
  let name = nameProp;
  if (radioGroup) {
  ...
  return /*#__PURE__*/jsxRuntime.jsx(RadioRoot, _extends["default"]({
    type: "radio",
