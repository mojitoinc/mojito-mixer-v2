...
var inputClasses = require('./inputClasses.js');
...
const useUtilityClasses = ownerState => {
  ...
  const composedClasses = composeClasses["default"](slots, inputClasses.getInputUtilityClass, classes);
  return _extends["default"]({}, classes, composedClasses);
};
const InputRoot = styled["default"](InputBase.InputBaseRoot, {
  ...
  return _extends["default"]({
    ...
    [`&:hover:not(.${inputClasses["default"].disabled}, .${inputClasses["default"].error}):before`]: {
...
const InputInput = styled["default"](InputBase.InputBaseComponent, {
  name: 'MuiInput',
  slot: 'Input',
...
const Input = /*#__PURE__*/React__namespace.forwardRef(function Input(inProps, ref) {
  ...
  const componentsProps = (slotProps != null ? slotProps : componentsPropsProp) ? deepmerge["default"](slotProps != null ? slotProps : componentsPropsProp, inputComponentsProps) : inputComponentsProps;
