...
var scrollLeft = require('../../utils/esm/scrollLeft.js');
...
var animate = require('../internal/animate.js');
var ScrollbarSize = require('./ScrollbarSize.js');
var TabScrollButton = require('../TabScrollButton/TabScrollButton.js');
require('../TabScrollButton/tabScrollButtonClasses.js');
var tabsClasses = require('./tabsClasses.js');
...
const useUtilityClasses = ownerState => {
  ...
  return composeClasses["default"](slots, tabsClasses.getTabsUtilityClass, classes);
};
const TabsRoot = styled["default"]('div', {
  name: 'MuiTabs',
  slot: 'Root',
  overridesResolver: (props, styles) => {
    ...
    return [{
      [`& .${tabsClasses["default"].scrollButtons}`]: styles.scrollButtons
    }, {
      [`& .${tabsClasses["default"].scrollButtons}`]: ownerState.scrollButtonsHideMobile && styles.scrollButtonsHideMobile
  ...
  [`& .${tabsClasses["default"].scrollButtons}`]: {
    [theme.breakpoints.down('sm')]: {
      display: 'none'
    }
  }
}));
const TabsScroller = styled["default"]('div', {
  name: 'MuiTabs',
  slot: 'Scroller',
  overridesResolver: (props, styles) => {
    const {
...
const TabsIndicator = styled["default"]('span', {
  name: 'MuiTabs',
  slot: 'Indicator',
...
const TabsScrollbarSize = styled["default"](ScrollbarSize["default"], {
  name: 'MuiTabs',
  slot: 'ScrollbarSize'
})({
  overflowX: 'auto',
...
const Tabs = /*#__PURE__*/React__namespace.forwardRef(function Tabs(inProps, ref) {
  ...
  const {
      ...
      ScrollButtonComponent = TabScrollButton["default"],
      scrollButtons = 'auto',
  ...
  const getTabsMeta = () => {
    ...
    if (tabsNode) {
      ...
      tabsMeta = {
        ...
        scrollLeftNormalized: scrollLeft.getNormalizedScrollLeft(tabsNode, theme.direction),
  ...
  const updateIndicatorState = useEventCallback["default"](() => {
    const {
      tabsMeta,
      tabMeta
    } = getTabsMeta();
  ...
  const scroll = (scrollValue, {
    ...
    if (animation) {
      animate["default"](scrollStart, tabsRef.current, scrollValue, {
  ...
  const moveTabsScroll = delta => {
    ...
    if (vertical) {
      ...
      // Fix for Edge
      scrollValue *= isRtl && scrollLeft.detectScrollType() === 'reverse' ? -1 : 1;
    }
    scroll(scrollValue);
  };
  const getScrollSize = () => {
  ...
  const getConditionalElements = () => {
    ...
    conditionalElements.scrollbarSizeListener = scrollable ? /*#__PURE__*/jsxRuntime.jsx(TabsScrollbarSize, {
      ...
      className: clsx_m.clsx(classes.scrollableX, classes.hideScrollbar)
    }) : null;
    const scrollButtonsActive = displayScroll.start || displayScroll.end;
    const showScrollButtons = scrollable && (scrollButtons === 'auto' && scrollButtonsActive || scrollButtons === true);
    conditionalElements.scrollButtonStart = showScrollButtons ? /*#__PURE__*/jsxRuntime.jsx(ScrollButtonComponent, _extends["default"]({
      orientation: orientation,
      direction: isRtl ? 'right' : 'left',
      onClick: handleStartScrollClick,
      disabled: !displayScroll.start
    }, TabScrollButtonProps, {
      className: clsx_m.clsx(classes.scrollButtons, TabScrollButtonProps.className)
    })) : null;
    conditionalElements.scrollButtonEnd = showScrollButtons ? /*#__PURE__*/jsxRuntime.jsx(ScrollButtonComponent, _extends["default"]({
      orientation: orientation,
  ...
  const scrollSelectedIntoView = useEventCallback["default"](animation => {
    const {
      tabsMeta,
      tabMeta
    } = getTabsMeta();
  ...
  const updateScrollButtonState = useEventCallback["default"](() => {
    if (scrollable && scrollButtons !== false) {
      ...
      if (vertical) {
        ...
        const scrollLeft$1 = scrollLeft.getNormalizedScrollLeft(tabsRef.current, theme.direction);
        // use 1 for the potential rounding error with browser zooms.
        showStartScroll = isRtl ? scrollLeft$1 < scrollWidth - clientWidth - 1 : scrollLeft$1 > 1;
        showEndScroll = !isRtl ? scrollLeft$1 < scrollWidth - clientWidth - 1 : scrollLeft$1 > 1;
      }
  ...
  React__namespace.useEffect(() => {
    ...
    const win = ownerWindow["default"](tabsRef.current);
  ...
  const handleTabsScroll = React__namespace.useMemo(() => debounce["default"](() => {
    updateScrollButtonState();
  }), [updateScrollButtonState]);
  React__namespace.useEffect(() => {
    return () => {
  ...
  const indicator = /*#__PURE__*/jsxRuntime.jsx(TabsIndicator, _extends["default"]({}, TabIndicatorProps, {
    className: clsx_m.clsx(classes.indicator, TabIndicatorProps.className),
    ownerState: ownerState,
    style: _extends["default"]({}, indicatorStyle, TabIndicatorProps.style)
  }));
  let childIndex = 0;
  const children = React__namespace.Children.map(childrenProp, child => {
    ...
    childIndex += 1;
    return /*#__PURE__*/React__namespace.cloneElement(child, _extends["default"]({
  ...
  const handleKeyDown = event => {
    ...
    const currentFocus = ownerDocument["default"](list).activeElement;
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(TabsRoot, _extends["default"]({
...
process.env.NODE_ENV !== "production" ? Tabs.propTypes /* remove-proptypes */ = {
   ...
   * @default false
   */
  allowScrollButtonsMobile: PropTypes__default["default"].bool,
  /**
   ...
   * @default 'primary'
   */
  indicatorColor: PropTypes__default["default"] /* @typescript-to-proptypes-ignore */.oneOfType([PropTypes__default["default"].oneOf(['primary', 'secondary']), PropTypes__default["default"].string]),
  /**
   ...
   */
  ScrollButtonComponent: PropTypes__default["default"].elementType,
  /**
   ...
   * @default 'auto'
   */
  scrollButtons: PropTypes__default["default"] /* @typescript-to-proptypes-ignore */.oneOf(['auto', false, true]),
  /**
   ...
   * @default  {}
   */
  TabIndicatorProps: PropTypes__default["default"].object,
  /**
   * Props applied to the [`TabScrollButton`](/material-ui/api/tab-scroll-button/) element.
   * @default {}
   */
  TabScrollButtonProps: PropTypes__default["default"].object,
  /**
   * Determines the color of the `Tab`.
   * @default 'primary'
   */
  textColor: PropTypes__default["default"].oneOf(['inherit', 'primary', 'secondary']),
  /**
   ...
   * @default 'standard'
   */
  variant: PropTypes__default["default"].oneOf(['fullWidth', 'scrollable', 'standard']),
  /**
   * If `true`, the scrollbar is visible. It can be useful when displaying
   * a long vertical list of tabs.
   * @default false
   */
  visibleScrollbar: PropTypes__default["default"].bool
} : void 0;
