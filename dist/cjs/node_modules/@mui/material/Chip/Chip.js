...
var unsupportedProp = require('../../utils/esm/unsupportedProp.js');
...
var Cancel = require('../internal/svg-icons/Cancel.js');
...
var chipClasses = require('./chipClasses.js');
...
const useUtilityClasses = ownerState => {
  ...
  const slots = {
    root: ['root', variant, disabled && 'disabled', `size${capitalize["default"](size)}`, `color${capitalize["default"](color)}`, clickable && 'clickable', clickable && `clickableColor${capitalize["default"](color)}`, onDelete && 'deletable', onDelete && `deletableColor${capitalize["default"](color)}`, `${variant}${capitalize["default"](color)}`],
    label: ['label', `label${capitalize["default"](size)}`],
    avatar: ['avatar', `avatar${capitalize["default"](size)}`, `avatarColor${capitalize["default"](color)}`],
    icon: ['icon', `icon${capitalize["default"](size)}`, `iconColor${capitalize["default"](iconColor)}`],
    deleteIcon: ['deleteIcon', `deleteIcon${capitalize["default"](size)}`, `deleteIconColor${capitalize["default"](color)}`, `deleteIcon${capitalize["default"](variant)}Color${capitalize["default"](color)}`]
  };
  return composeClasses["default"](slots, chipClasses.getChipUtilityClass, classes);
};
const ChipRoot = styled["default"]('div', {
  name: 'MuiChip',
  slot: 'Root',
  overridesResolver: (props, styles) => {
    ...
    return [{
      [`& .${chipClasses["default"].avatar}`]: styles.avatar
    }, {
      [`& .${chipClasses["default"].avatar}`]: styles[`avatar${capitalize["default"](size)}`]
    }, {
      [`& .${chipClasses["default"].avatar}`]: styles[`avatarColor${capitalize["default"](color)}`]
    }, {
      [`& .${chipClasses["default"].icon}`]: styles.icon
    }, {
      [`& .${chipClasses["default"].icon}`]: styles[`icon${capitalize["default"](size)}`]
    }, {
      [`& .${chipClasses["default"].icon}`]: styles[`iconColor${capitalize["default"](iconColor)}`]
    }, {
      [`& .${chipClasses["default"].deleteIcon}`]: styles.deleteIcon
    }, {
      [`& .${chipClasses["default"].deleteIcon}`]: styles[`deleteIcon${capitalize["default"](size)}`]
    }, {
      [`& .${chipClasses["default"].deleteIcon}`]: styles[`deleteIconColor${capitalize["default"](color)}`]
    }, {
      [`& .${chipClasses["default"].deleteIcon}`]: styles[`deleteIcon${capitalize["default"](variant)}Color${capitalize["default"](color)}`]
    }, styles.root, styles[`size${capitalize["default"](size)}`], styles[`color${capitalize["default"](color)}`], clickable && styles.clickable, clickable && color !== 'default' && styles[`clickableColor${capitalize["default"](color)})`], onDelete && styles.deletable, onDelete && color !== 'default' && styles[`deletableColor${capitalize["default"](color)}`], styles[variant], styles[`${variant}${capitalize["default"](color)}`]];
  }
})(({
  theme,
  ownerState
}) => {
  const deleteIconColor = colorManipulator.alpha(theme.palette.text.primary, 0.26);
  ...
  return _extends["default"]({
    ...
    [`&.${chipClasses["default"].disabled}`]: {
      opacity: (theme.vars || theme).palette.action.disabledOpacity,
      pointerEvents: 'none'
    },
    [`& .${chipClasses["default"].avatar}`]: {
      marginLeft: 5,
      marginRight: -6,
      width: 24,
      height: 24,
    ...
    [`& .${chipClasses["default"].avatarColorPrimary}`]: {
      color: (theme.vars || theme).palette.primary.contrastText,
      backgroundColor: (theme.vars || theme).palette.primary.dark
    },
    [`& .${chipClasses["default"].avatarColorSecondary}`]: {
      color: (theme.vars || theme).palette.secondary.contrastText,
      backgroundColor: (theme.vars || theme).palette.secondary.dark
    },
    [`& .${chipClasses["default"].avatarSmall}`]: {
      marginLeft: 4,
      marginRight: -4,
      width: 18,
      height: 18,
    ...
    [`& .${chipClasses["default"].icon}`]: _extends["default"]({
      marginLeft: 5,
      marginRight: -6
      ...
      marginLeft: 4,
      marginRight: -4
    }, ownerState.iconColor === ownerState.color && _extends["default"]({
      color: theme.vars ? theme.vars.palette.Chip.defaultIconColor : textColor
    }, ownerState.color !== 'default' && {
      color: 'inherit'
    })),
    [`& .${chipClasses["default"].deleteIcon}`]: _extends["default"]({
      ...
      margin: '0 5px 0 -6px',
      '&:hover': {
        color: theme.vars ? `rgba(${theme.vars.palette.text.primaryChannel} / 0.4)` : colorManipulator.alpha(deleteIconColor, 0.4)
      }
    }, ownerState.size === 'small' && {
      fontSize: 16,
      marginRight: 4,
      ...
      color: theme.vars ? `rgba(${theme.vars.palette[ownerState.color].contrastTextChannel} / 0.7)` : colorManipulator.alpha(theme.palette[ownerState.color].contrastText, 0.7),
      '&:hover, &:active': {
    ...
    [`&.${chipClasses["default"].focusVisible}`]: {
      backgroundColor: theme.vars ? `rgba(${theme.vars.palette.action.selectedChannel} / calc(${theme.vars.palette.action.selectedOpacity} + ${theme.vars.palette.action.focusOpacity}))` : colorManipulator.alpha(theme.palette.action.selected, theme.palette.action.selectedOpacity + theme.palette.action.focusOpacity)
    }
  ...
  theme,
  ownerState
}) => _extends["default"]({}, ownerState.clickable && {
  userSelect: 'none',
  WebkitTapHighlightColor: 'transparent',
  cursor: 'pointer',
  '&:hover': {
    backgroundColor: theme.vars ? `rgba(${theme.vars.palette.action.selectedChannel} / calc(${theme.vars.palette.action.selectedOpacity} + ${theme.vars.palette.action.hoverOpacity}))` : colorManipulator.alpha(theme.palette.action.selected, theme.palette.action.selectedOpacity + theme.palette.action.hoverOpacity)
  },
  [`&.${chipClasses["default"].focusVisible}`]: {
    backgroundColor: theme.vars ? `rgba(${theme.vars.palette.action.selectedChannel} / calc(${theme.vars.palette.action.selectedOpacity} + ${theme.vars.palette.action.focusOpacity}))` : colorManipulator.alpha(theme.palette.action.selected, theme.palette.action.selectedOpacity + theme.palette.action.focusOpacity)
  },
  ...
  [`&:hover, &.${chipClasses["default"].focusVisible}`]: {
    backgroundColor: (theme.vars || theme).palette[ownerState.color].dark
  }
}), ({
  theme,
  ownerState
}) => _extends["default"]({}, ownerState.variant === 'outlined' && {
  backgroundColor: 'transparent',
  border: theme.vars ? `1px solid ${theme.vars.palette.Chip.defaultBorder}` : `1px solid ${theme.palette.mode === 'light' ? theme.palette.grey[400] : theme.palette.grey[700]}`,
  [`&.${chipClasses["default"].clickable}:hover`]: {
  ...
  [`& .${chipClasses["default"].icon}`]: {
    marginLeft: 4
  },
  [`& .${chipClasses["default"].iconSmall}`]: {
    marginLeft: 2
  },
  [`& .${chipClasses["default"].deleteIcon}`]: {
    marginRight: 5
  },
  [`& .${chipClasses["default"].deleteIconSmall}`]: {
    marginRight: 3
  }
}, ownerState.variant === 'outlined' && ownerState.color !== 'default' && {
  color: (theme.vars || theme).palette[ownerState.color].main,
  border: `1px solid ${theme.vars ? `rgba(${theme.vars.palette[ownerState.color].mainChannel} / 0.7)` : colorManipulator.alpha(theme.palette[ownerState.color].main, 0.7)}`,
  [`&.${chipClasses["default"].clickable}:hover`]: {
    backgroundColor: theme.vars ? `rgba(${theme.vars.palette[ownerState.color].mainChannel} / ${theme.vars.palette.action.hoverOpacity})` : colorManipulator.alpha(theme.palette[ownerState.color].main, theme.palette.action.hoverOpacity)
  },
  [`&.${chipClasses["default"].focusVisible}`]: {
    backgroundColor: theme.vars ? `rgba(${theme.vars.palette[ownerState.color].mainChannel} / ${theme.vars.palette.action.focusOpacity})` : colorManipulator.alpha(theme.palette[ownerState.color].main, theme.palette.action.focusOpacity)
  },
  [`& .${chipClasses["default"].deleteIcon}`]: {
    color: theme.vars ? `rgba(${theme.vars.palette[ownerState.color].mainChannel} / 0.7)` : colorManipulator.alpha(theme.palette[ownerState.color].main, 0.7),
    '&:hover, &:active': {
      color: (theme.vars || theme).palette[ownerState.color].main
    }
  }
}));
const ChipLabel = styled["default"]('span', {
  name: 'MuiChip',
  slot: 'Label',
  overridesResolver: (props, styles) => {
    const {
    ...
    return [styles.label, styles[`label${capitalize["default"](size)}`]];
  }
})(({
  ownerState
}) => _extends["default"]({
...
const Chip = /*#__PURE__*/React__namespace.forwardRef(function Chip(inProps, ref) {
  ...
  const handleRef = useForkRef["default"](chipRef, ref);
  ...
  const moreProps = component === ButtonBase["default"] ? _extends["default"]({
  ...
  if (onDelete) {
    deleteIcon = deleteIconProp && /*#__PURE__*/React__namespace.isValidElement(deleteIconProp) ? /*#__PURE__*/React__namespace.cloneElement(deleteIconProp, {
      className: clsx_m.clsx(deleteIconProp.props.className, classes.deleteIcon),
      onClick: handleDeleteIconClick
    }) : /*#__PURE__*/jsxRuntime.jsx(Cancel["default"], {
      className: clsx_m.clsx(classes.deleteIcon),
      onClick: handleDeleteIconClick
    });
  }
  let avatar = null;
  if (avatarProp && /*#__PURE__*/React__namespace.isValidElement(avatarProp)) {
    avatar = /*#__PURE__*/React__namespace.cloneElement(avatarProp, {
      className: clsx_m.clsx(classes.avatar, avatarProp.props.className)
    });
  }
  let icon = null;
  if (iconProp && /*#__PURE__*/React__namespace.isValidElement(iconProp)) {
    icon = /*#__PURE__*/React__namespace.cloneElement(iconProp, {
      className: clsx_m.clsx(classes.icon, iconProp.props.className)
    });
  }
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(ChipRoot, _extends["default"]({
    as: component,
    ...
    children: [avatar || icon, /*#__PURE__*/jsxRuntime.jsx(ChipLabel, {
      className: clsx_m.clsx(classes.label),
      ownerState: ownerState,
      children: label
    }), deleteIcon]
  }));
...
process.env.NODE_ENV !== "production" ? Chip.propTypes /* remove-proptypes */ = {
   ...
   * @default 'default'
   */
  color: PropTypes__default["default"] /* @typescript-to-proptypes-ignore */.oneOfType([PropTypes__default["default"].oneOf(['default', 'primary', 'secondary', 'error', 'info', 'success', 'warning']), PropTypes__default["default"].string]),
  /**
   ...
   */
  deleteIcon: PropTypes__default["default"].element,
  /**
   ...
   * @default false
   */
  skipFocusWhenDisabled: PropTypes__default["default"].bool,
  /**
   ...
   * @default 'filled'
   */
  variant: PropTypes__default["default"] /* @typescript-to-proptypes-ignore */.oneOfType([PropTypes__default["default"].oneOf(['filled', 'outlined']), PropTypes__default["default"].string])
} : void 0;
