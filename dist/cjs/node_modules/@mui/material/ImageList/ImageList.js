...
var imageListClasses = require('./imageListClasses.js');
var ImageListContext = require('./ImageListContext.js');
...
const useUtilityClasses = ownerState => {
  ...
  return composeClasses["default"](slots, imageListClasses.getImageListUtilityClass, classes);
};
const ImageListRoot = styled["default"]('ul', {
  name: 'MuiImageList',
  slot: 'Root',
...
const ImageList = /*#__PURE__*/React__namespace.forwardRef(function ImageList(inProps, ref) {
  ...
  const style = variant === 'masonry' ? _extends["default"]({
    columnCount: cols,
    columnGap: gap
  }, styleProp) : _extends["default"]({
  ...
  return /*#__PURE__*/jsxRuntime.jsx(ImageListRoot, _extends["default"]({
    as: component,
    className: clsx_m.clsx(classes.root, classes[variant], className),
    ref: ref,
    style: style,
    ownerState: ownerState
  }, other, {
    children: /*#__PURE__*/jsxRuntime.jsx(ImageListContext["default"].Provider, {
      value: contextValue,
      children: children
    })
  }));
...
process.env.NODE_ENV !== "production" ? ImageList.propTypes /* remove-proptypes */ = {
   ...
   */
  children: PropTypes__default["default"] /* @typescript-to-proptypes-ignore */.node.isRequired,
  /**
   ...
   * @default 4
   */
  gap: PropTypes__default["default"].number,
  /**
   * The height of one row in px.
   * @default 'auto'
   */
  rowHeight: PropTypes__default["default"].oneOfType([PropTypes__default["default"].oneOf(['auto']), PropTypes__default["default"].number]),
  /**
   * @ignore
   */
   ...
   * @default 'standard'
   */
  variant: PropTypes__default["default"] /* @typescript-to-proptypes-ignore */.oneOfType([PropTypes__default["default"].oneOf(['masonry', 'quilted', 'standard', 'woven']), PropTypes__default["default"].string])
} : void 0;
