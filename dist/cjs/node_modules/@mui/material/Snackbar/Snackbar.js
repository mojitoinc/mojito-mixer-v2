...
var ClickAwayListener = require('../../base/ClickAwayListener/ClickAwayListener.js');
...
var SnackbarContent = require('../SnackbarContent/SnackbarContent.js');
require('../SnackbarContent/snackbarContentClasses.js');
var snackbarClasses = require('./snackbarClasses.js');
...
const useUtilityClasses = ownerState => {
  ...
  const slots = {
    root: ['root', `anchorOrigin${capitalize["default"](anchorOrigin.vertical)}${capitalize["default"](anchorOrigin.horizontal)}`]
  };
  return composeClasses["default"](slots, snackbarClasses.getSnackbarUtilityClass, classes);
};
const SnackbarRoot = styled["default"]('div', {
  name: 'MuiSnackbar',
  slot: 'Root',
  overridesResolver: (props, styles) => {
    ...
    return [styles.root, styles[`anchorOrigin${capitalize["default"](ownerState.anchorOrigin.vertical)}${capitalize["default"](ownerState.anchorOrigin.horizontal)}`]];
  }
})(({
  theme,
  ownerState
  ...
  return _extends["default"]({
    ...
    [theme.breakpoints.up('sm')]: _extends["default"]({}, ownerState.anchorOrigin.vertical === 'top' ? {
      top: 24
    } : {
      bottom: 24
...
const Snackbar = /*#__PURE__*/React__namespace.forwardRef(function Snackbar(inProps, ref) {
  ...
  const handleClose = useEventCallback["default"]((...args) => {
    if (onClose) {
      onClose(...args);
    }
  });
  const setAutoHideTimer = useEventCallback["default"](autoHideDurationParam => {
  ...
  return /*#__PURE__*/jsxRuntime.jsx(ClickAwayListener["default"], _extends["default"]({
    onClickAway: handleClickAway
  }, ClickAwayListenerProps, {
    children: /*#__PURE__*/jsxRuntime.jsx(SnackbarRoot, _extends["default"]({
      ...
      children: /*#__PURE__*/jsxRuntime.jsx(TransitionComponent, _extends["default"]({
        ...
        children: children || /*#__PURE__*/jsxRuntime.jsx(SnackbarContent["default"], _extends["default"]({
          message: message,
          action: action
        }, ContentProps))
      }))
...
process.env.NODE_ENV !== "production" ? Snackbar.propTypes /* remove-proptypes */ = {
  ...
  anchorOrigin: PropTypes__default["default"].shape({
    horizontal: PropTypes__default["default"].oneOf(['center', 'left', 'right']).isRequired,
   ...
   */
  ClickAwayListenerProps: PropTypes__default["default"].object,
  /**
   * Props applied to the [`SnackbarContent`](/material-ui/api/snackbar-content/) element.
   */
  ContentProps: PropTypes__default["default"].object,
  /**
