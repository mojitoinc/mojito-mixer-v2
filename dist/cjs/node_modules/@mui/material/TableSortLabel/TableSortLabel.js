...
var ArrowDownward = require('../internal/svg-icons/ArrowDownward.js');
var styled = require('../styles/styled.js');
var useThemeProps = require('../styles/useThemeProps.js');
var tableSortLabelClasses = require('./tableSortLabelClasses.js');
...
const useUtilityClasses = ownerState => {
  ...
  const slots = {
    ...
    icon: ['icon', `iconDirection${capitalize["default"](direction)}`]
  };
  return composeClasses["default"](slots, tableSortLabelClasses.getTableSortLabelUtilityClass, classes);
};
const TableSortLabelRoot = styled["default"](ButtonBase["default"], {
  ...
  '&:hover': {
    color: (theme.vars || theme).palette.text.secondary,
    [`& .${tableSortLabelClasses["default"].icon}`]: {
      opacity: 0.5
    }
  },
  [`&.${tableSortLabelClasses["default"].active}`]: {
...
const TableSortLabelIcon = styled["default"]('span', {
  name: 'MuiTableSortLabel',
  slot: 'Icon',
  overridesResolver: (props, styles) => {
    const {
    ...
    return [styles.icon, styles[`iconDirection${capitalize["default"](ownerState.direction)}`]];
  }
})(({
  theme,
  ownerState
...
const TableSortLabel = /*#__PURE__*/React__namespace.forwardRef(function TableSortLabel(inProps, ref) {
  ...
  const {
      ...
      direction = 'asc',
      hideSortIcon = false,
      IconComponent = ArrowDownward["default"]
    } = props,
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(TableSortLabelRoot, _extends["default"]({
    ...
    children: [children, hideSortIcon && !active ? null : /*#__PURE__*/jsxRuntime.jsx(TableSortLabelIcon, {
      as: IconComponent,
      className: clsx_m.clsx(classes.icon),
      ownerState: ownerState
    })]
  }));
});
process.env.NODE_ENV !== "production" ? TableSortLabel.propTypes /* remove-proptypes */ = {
   ...
   * @default false
   */
  hideSortIcon: PropTypes__default["default"].bool,
  /**
   * Sort icon to use.
