...
const useUtilityClasses = ownerState => {
  ...
  return composeClasses["default"](slots, stepContentClasses.getStepContentUtilityClass, classes);
};
const StepContentRoot = styled["default"]('div', {
  name: 'MuiStepContent',
  slot: 'Root',
...
const StepContentTransition = styled["default"](Collapse["default"], {
  name: 'MuiStepContent',
  slot: 'Transition',
...
const StepContent = /*#__PURE__*/React__namespace.forwardRef(function StepContent(inProps, ref) {
  ...
  const {
      children,
      className,
      TransitionComponent = Collapse["default"],
  ...
  return /*#__PURE__*/jsxRuntime.jsx(StepContentRoot, _extends["default"]({
    className: clsx_m.clsx(classes.root, className),
    ref: ref,
    ownerState: ownerState
  }, other, {
    children: /*#__PURE__*/jsxRuntime.jsx(StepContentTransition, _extends["default"]({
