...
var useThemeProps = require('../../system/esm/useThemeProps/useThemeProps.js');
...
var NoSsr = require('../../base/NoSsr/NoSsr.js');
...
var SwipeArea = require('./SwipeArea.js');
...
function getDomTreeShapes(element, rootNode) {
  ...
  while (element && element !== rootNode.parentElement) {
    const style = ownerWindow["default"](rootNode).getComputedStyle(element);
    if (
...
const SwipeableDrawer = /*#__PURE__*/React__namespace.forwardRef(function SwipeableDrawer(inProps, ref) {
  ...
  const {
    ...
    ModalPropsProp = objectWithoutPropertiesLoose["default"](props.ModalProps, _excluded),
  ...
  const handleRef = useForkRef["default"](PaperProps.ref, paperRef);
  const touchDetected = React__namespace.useRef(false);

  // Ref for transition duration based on / to match swipe speed
  const calculatedDurationRef = React__namespace.useRef();
  ...
  const setPosition = React__namespace.useCallback((translate, options = {}) => {
    ...
    const anchorRtl = Drawer.getAnchor(theme, anchor);
    const rtlTranslateMultiplier = ['right', 'bottom'].indexOf(anchorRtl) !== -1 ? 1 : -1;
    const horizontalSwipe = Drawer.isHorizontal(anchor);
    ...
    let transition = '';
    if (mode) {
      transition = theme.transitions.create('all', utils.getTransitionProps({
        easing: undefined,
        style: undefined,
  ...
  const handleBodyTouchEnd = useEventCallback["default"](nativeEvent => {
    ...
    swipeInstance.current.isSwiping = null;
    const anchorRtl = Drawer.getAnchor(theme, anchor);
    const horizontal = Drawer.isHorizontal(anchor);
    let current;
    if (horizontal) {
      current = calculateCurrentX(anchorRtl, nativeEvent.changedTouches, ownerDocument["default"](nativeEvent.currentTarget));
    } else {
      current = calculateCurrentY(anchorRtl, nativeEvent.changedTouches, ownerWindow["default"](nativeEvent.currentTarget));
    }
  ...
  const handleBodyTouchMove = useEventCallback["default"](nativeEvent => {
    // the ref may be null when a parent component updates while swiping
    ...
    const anchorRtl = Drawer.getAnchor(theme, anchor);
    const horizontalSwipe = Drawer.isHorizontal(anchor);
    const currentX = calculateCurrentX(anchorRtl, nativeEvent.touches, ownerDocument["default"](nativeEvent.currentTarget));
    const currentY = calculateCurrentY(anchorRtl, nativeEvent.touches, ownerWindow["default"](nativeEvent.currentTarget));
  ...
  const handleBodyTouchStart = useEventCallback["default"](nativeEvent => {
  ...
  React__namespace.useEffect(() => {
    if (variant === 'temporary') {
      const doc = ownerDocument["default"](paperRef.current);
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(React__namespace.Fragment, {
    children: [/*#__PURE__*/jsxRuntime.jsx(Drawer["default"], _extends["default"]({
      open: variant === 'temporary' && maybeSwiping ? true : open,
      variant: variant,
      ModalProps: _extends["default"]({
        BackdropProps: _extends["default"]({}, BackdropProps, {
          ref: backdropRef
        })
      }, variant === 'temporary' && {
        keepMounted: true
      ...
      PaperProps: _extends["default"]({}, PaperProps, {
      ...
      onClose: onClose,
      ref: ref
    }, other)), !disableSwipeToOpen && variant === 'temporary' && /*#__PURE__*/jsxRuntime.jsx(NoSsr["default"], {
      children: /*#__PURE__*/jsxRuntime.jsx(SwipeArea["default"], _extends["default"]({
        anchor: anchor,
        ref: swipeAreaRef,
...
process.env.NODE_ENV !== "production" ? SwipeableDrawer.propTypes /* remove-proptypes */ = {
   ...
   * @default false
   */
  allowSwipeInChildren: PropTypes__default["default"].oneOfType([PropTypes__default["default"].bool, PropTypes__default["default"].func]),
  /**
   * @ignore
   */
  anchor: PropTypes__default["default"].oneOf(['bottom', 'left', 'right', 'top']),
  /**
   ...
   * @default false
   */
  disableBackdropTransition: PropTypes__default["default"].bool,
  /**
   * If `true`, touching the screen near the edge of the drawer will not slide in the drawer a bit
   * to promote accidental discovery of the swipe gesture.
   * @default false
   */
  disableDiscovery: PropTypes__default["default"].bool,
  /**
   * If `true`, swipe to open is disabled. This is useful in browsers where swiping triggers
   * navigation actions. Swipe to open is disabled on iOS browsers by default.
   * @default typeof navigator !== 'undefined' && /iPad|iPhone|iPod/.test(navigator.userAgent)
   */
  disableSwipeToOpen: PropTypes__default["default"].bool,
  /**
   * @ignore
   */
   ...
   * @default 450
   */
  minFlingVelocity: PropTypes__default["default"].number,
  /**
   * @ignore
   */
  ModalProps: PropTypes__default["default"] /* @typescript-to-proptypes-ignore */.shape({
    BackdropProps: PropTypes__default["default"].shape({
   ...
   * @param {object} event The event source of the callback.
   */
  onOpen: PropTypes__default["default"].func.isRequired,
  /**
   ...
   * @ignore
   */
  PaperProps: PropTypes__default["default"] /* @typescript-to-proptypes-ignore */.shape({
    component: elementTypeAcceptingRef["default"],
   ...
   */
  SwipeAreaProps: PropTypes__default["default"].object,
  /**
   * The width of the left most (or right most) area in `px` that
   * the drawer can be swiped open from.
   * @default 20
   */
  swipeAreaWidth: PropTypes__default["default"].number,
  /**
   ...
   * }
   */
  transitionDuration: PropTypes__default["default"].oneOfType([PropTypes__default["default"].number, PropTypes__default["default"].shape({
   ...
   * @ignore
   */
  variant: PropTypes__default["default"].oneOf(['permanent', 'persistent', 'temporary'])
} : void 0;
