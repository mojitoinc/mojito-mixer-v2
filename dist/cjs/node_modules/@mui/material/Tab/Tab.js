...
var tabClasses = require('./tabClasses.js');
...
const useUtilityClasses = ownerState => {
  ...
  const slots = {
    root: ['root', icon && label && 'labelIcon', `textColor${capitalize["default"](textColor)}`, fullWidth && 'fullWidth', wrapped && 'wrapped', selected && 'selected', disabled && 'disabled'],
    iconWrapper: ['iconWrapper']
  };
  return composeClasses["default"](slots, tabClasses.getTabUtilityClass, classes);
};
const TabRoot = styled["default"](ButtonBase["default"], {
  name: 'MuiTab',
  slot: 'Root',
  overridesResolver: (props, styles) => {
    ...
    return [styles.root, ownerState.label && ownerState.icon && styles.labelIcon, styles[`textColor${capitalize["default"](ownerState.textColor)}`], ownerState.fullWidth && styles.fullWidth, ownerState.wrapped && styles.wrapped];
  }
})(({
  theme,
  ownerState
}) => _extends["default"]({}, theme.typography.button, {
  maxWidth: 360,
  minWidth: 90,
  position: 'relative',
  minHeight: 48,
  ...
  paddingTop: 9,
  paddingBottom: 9,
  [`& > .${tabClasses["default"].iconWrapper}`]: _extends["default"]({}, ownerState.iconPosition === 'top' && {
    marginBottom: 6
  ...
  [`&.${tabClasses["default"].selected}`]: {
    opacity: 1
  },
  [`&.${tabClasses["default"].disabled}`]: {
...
const Tab = /*#__PURE__*/React__namespace.forwardRef(function Tab(inProps, ref) {
  ...
  const icon = iconProp && label && /*#__PURE__*/React__namespace.isValidElement(iconProp) ? /*#__PURE__*/React__namespace.cloneElement(iconProp, {
    className: clsx_m.clsx(classes.iconWrapper, iconProp.props.className)
  }) : iconProp;
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(TabRoot, _extends["default"]({
...
process.env.NODE_ENV !== "production" ? Tab.propTypes /* remove-proptypes */ = {
   ...
   * The icon to display.
   */
  icon: PropTypes__default["default"].oneOfType([PropTypes__default["default"].element, PropTypes__default["default"].string]),
  /**
   * The position of the icon relative to the label.
   * @default 'top'
   */
  iconPosition: PropTypes__default["default"].oneOf(['bottom', 'end', 'start', 'top']),
  /**
   * The label element.
   */
   ...
   * @default false
   */
  wrapped: PropTypes__default["default"].bool
} : void 0;
