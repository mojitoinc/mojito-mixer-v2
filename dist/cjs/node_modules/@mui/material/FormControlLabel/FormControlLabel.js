...
const FormControlLabel = /*#__PURE__*/React__namespace.forwardRef(function FormControlLabel(inProps, ref) {
  ...
  let label = labelProp;
  if (label != null && label.type !== Typography["default"] && !disableTypography) {
    label = /*#__PURE__*/jsxRuntime.jsx(Typography["default"], _extends["default"]({
      component: "span"
    }, typographySlotProps, {
      className: clsx_m.clsx(classes.label, typographySlotProps == null ? void 0 : typographySlotProps.className),
      children: label
    }));
  }
  return /*#__PURE__*/jsxRuntime.jsxs(FormControlLabelRoot, _extends["default"]({
...
process.env.NODE_ENV !== "production" ? FormControlLabel.propTypes /* remove-proptypes */ = {
  ...
  componentsProps: PropTypes__default["default"].shape({
    typography: PropTypes__default["default"].object
  }),
  /**
   * A control element. For instance, it can be a `Radio`, a `Switch` or a `Checkbox`.
   */
  control: PropTypes__default["default"].element.isRequired,
  /**
   ...
   * @default 'end'
   */
  labelPlacement: PropTypes__default["default"].oneOf(['bottom', 'end', 'start', 'top']),
  /**
   * @ignore
   */
