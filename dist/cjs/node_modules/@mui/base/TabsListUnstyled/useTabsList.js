...
const useTabsList = parameters => {
  ...
  const handleRef = useForkRef["default"](tabsListRef, ref);
  ...
  const getRootProps = (otherHandlers = {}) => {
    const propsEventHandlers = extractEventHandlers["default"](parameters);
    const externalEventHandlers = _extends["default"]({}, propsEventHandlers, otherHandlers);
    const ownEventHandlers = {
      onKeyDown: createHandleKeyDown(externalEventHandlers)
    };
    const mergedEventHandlers = _extends["default"]({}, externalEventHandlers, ownEventHandlers);
