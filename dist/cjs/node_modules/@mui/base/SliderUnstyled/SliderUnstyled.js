...
var SliderValueLabelUnstyled = require('./SliderValueLabelUnstyled.js');
...
const SliderUnstyled = /*#__PURE__*/React__namespace.forwardRef(function SliderUnstyled(props, ref) {
  ...
  const {
    ...
    trackOffset,
    trackLeap
  } = useSlider["default"](_extends["default"]({}, ownerState, {
    ref
  }));
  ...
  const ValueLabel = (_slots$valueLabel = slots.valueLabel) != null ? _slots$valueLabel : SliderValueLabelUnstyled["default"];
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(Root, _extends["default"]({}, rootProps, {
    children: [/*#__PURE__*/jsxRuntime.jsx(Rail, _extends["default"]({}, railProps)), /*#__PURE__*/jsxRuntime.jsx(Track, _extends["default"]({}, trackProps)), marks.filter(mark => mark.value >= min && mark.value <= max).map((mark, index) => {
      ...
      return /*#__PURE__*/jsxRuntime.jsx(React__namespace.Fragment, {
        children: /*#__PURE__*/jsxRuntime.jsx(ValueLabelComponent, _extends["default"]({}, !isHostComponent["default"](ValueLabelComponent) && {
          valueLabelFormat,
          valueLabelDisplay,
          ...
          className: clsx_m.clsx(classes.valueLabel, valueLabelProps.className),
          children: /*#__PURE__*/jsxRuntime.jsx(Thumb, _extends["default"]({
            "data-index": index,
