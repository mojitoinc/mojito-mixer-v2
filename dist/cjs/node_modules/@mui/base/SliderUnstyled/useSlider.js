...
function focusThumb({
  ...
  const doc = ownerDocument["default"](sliderRef.current);
...
function useSlider(parameters) {
  ...
  const handleFocusRef = useForkRef["default"](focusVisibleRef, sliderRef);
  const handleRef = useForkRef["default"](ref, handleFocusRef);
  ...
  const handleTouchMove = useEventCallback["default"](nativeEvent => {
  ...
  const handleTouchEnd = useEventCallback["default"](nativeEvent => {
    const finger = trackFinger(nativeEvent, touchId);
    setDragging(false);
    if (!finger) {
      return;
  ...
  const handleTouchStart = useEventCallback["default"](nativeEvent => {
    if (disabled) {
      return;
    }
  ...
  const getRootProps = (otherHandlers = {}) => {
    ...
    const mergedEventHandlers = _extends["default"]({}, otherHandlers, ownEventHandlers);
  ...
  const getThumbProps = (otherHandlers = {}) => {
    ...
    return _extends["default"]({}, otherHandlers, ownEventHandlers);
  };
  const getHiddenInputProps = (otherHandlers = {}) => {
    ...
    return _extends["default"]({
      ...
      style: _extends["default"]({}, visuallyHidden["default"], {
