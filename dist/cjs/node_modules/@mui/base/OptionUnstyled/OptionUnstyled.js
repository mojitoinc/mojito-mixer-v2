 ...
 */
const OptionUnstyled = /*#__PURE__*/React__namespace.forwardRef(function OptionUnstyled(props, ref) {
  const {
      children,
      component,
      disabled = false,
  ...
  const selectContext = React__namespace.useContext(SelectUnstyledContext.SelectUnstyledContext);
  if (!selectContext) {
