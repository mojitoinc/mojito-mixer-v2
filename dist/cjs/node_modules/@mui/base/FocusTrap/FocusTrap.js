...
function FocusTrap(props) {
  ...
  const handleRef = useForkRef["default"](children.ref, rootRef);
  ...
  React__namespace.useEffect(() => {
    ...
    const doc = ownerDocument["default"](rootRef.current);
...
process.env.NODE_ENV !== "production" ? FocusTrap.propTypes /* remove-proptypes */ = {
   ...
   */
  getTabbable: PropTypes__default["default"].func,
  /**
   ...
   * }
   */
  isEnabled: PropTypes__default["default"].func,
  /**
...
if (process.env.NODE_ENV !== 'production') {
  ...
  FocusTrap['propTypes' + ''] = exactProp["default"](FocusTrap.propTypes);
}
