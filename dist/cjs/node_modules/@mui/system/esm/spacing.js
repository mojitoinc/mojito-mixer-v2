...
// To 350,000 ops/sec
const getCssProperties = memoize["default"](prop => {
...
function createUnaryUnit(theme, themeKey, defaultValue, propName) {
  var _getPath;
  const themeSpacing = (_getPath = style$1.getPath(theme, themeKey, false)) != null ? _getPath : defaultValue;
...
function style(props, keys) {
  ...
  return Object.keys(props).map(prop => resolveCssProperty(props, keys, prop, transformer)).reduce(merge["default"], {});
}
function margin(props) {
  return style(props, marginKeys);
}
margin.propTypes = process.env.NODE_ENV !== 'production' ? marginKeys.reduce((obj, key) => {
  obj[key] = responsivePropType["default"];
  return obj;
}, {}) : {};
