...
var es = require('../../deepmerge/dist/es.js');
var isPlainObject = require('../../lodash-es/isPlainObject.js');
var clone = require('../../lodash-es/clone.js');
var toPath = require('../../lodash-es/toPath.js');
...
function setIn(obj, path, value) {
  var res = clone["default"](obj); // this keeps inheritance when obj is a class

  var resVal = res;
  var i = 0;
  var pathArray = toPath["default"](path);
  ...
  for (; i < pathArray.length - 1; i++) {
    ...
    if (currentObj && (isObject(currentObj) || Array.isArray(currentObj))) {
      resVal = resVal[currentPath] = clone["default"](currentObj);
    } else {
...
function useFormikContext() {
  ...
  !!!formik ? process.env.NODE_ENV !== "production" ? tinyWarning_esm["default"](false, "Formik context is undefined, please verify you are calling useFormikContext() as child of a <Formik> component.") : tinyWarning_esm["default"](false) : void 0;
  return formik;
}
...
function formikReducer(state, msg) {
  switch (msg.type) {
    ...
    case 'SET_ERRORS':
      if (isEqual__default["default"](state.errors, msg.payload)) {
        return state;
      }
...
function useFormik(_ref) {
  ...
  if (process.env.NODE_ENV !== "production") {
    ...
    React.useEffect(function () {
      !(typeof isInitialValid === 'undefined') ? process.env.NODE_ENV !== "production" ? tinyWarning_esm["default"](false, 'isInitialValid has been deprecated and will be removed in future versions of Formik. Please use initialErrors or validateOnMount instead.') : tinyWarning_esm["default"](false) : void 0; // eslint-disable-next-line
    }, []);
  }
  ...
  var runAllValidations = React.useCallback(function (values) {
    return Promise.all([runFieldLevelValidations(values), props.validationSchema ? runValidationSchema(values) : {}, props.validate ? runValidateHandler(values) : {}]).then(function (_ref2) {
      ...
      var combinedErrors = es["default"].all([fieldErrors, schemaErrors, validateErrors], {
  ...
  React.useEffect(function () {
    if (validateOnMount && isMounted.current === true && isEqual__default["default"](initialValues.current, props.initialValues)) {
  ...
  React.useEffect(function () {
    if (isMounted.current === true && !isEqual__default["default"](initialValues.current, props.initialValues)) {
  ...
  React.useEffect(function () {
    if (enableReinitialize && isMounted.current === true && !isEqual__default["default"](initialErrors.current, props.initialErrors)) {
  ...
  React.useEffect(function () {
    if (enableReinitialize && isMounted.current === true && !isEqual__default["default"](initialTouched.current, props.initialTouched)) {
  ...
  React.useEffect(function () {
    if (enableReinitialize && isMounted.current === true && !isEqual__default["default"](initialStatus.current, props.initialStatus)) {
  ...
  var handleSubmit = useEventCallback(function (e) {
    ...
    if (process.env.NODE_ENV !== "production" && typeof document !== 'undefined') {
      ...
      if (activeElement !== null && activeElement instanceof HTMLButtonElement) {
        !(activeElement.attributes && activeElement.attributes.getNamedItem('type')) ? process.env.NODE_ENV !== "production" ? tinyWarning_esm["default"](false, 'You submitted a Formik form using a button with an unspecified `type` attribute.  Most browsers default button elements to `type="submit"`. If this is not a submit button, please add `type="button"`.') : tinyWarning_esm["default"](false) : void 0;
      }
    }
  ...
  var dirty = React.useMemo(function () {
    return !isEqual__default["default"](initialValues.current, state.values);
    ...
    if (Object.prototype.hasOwnProperty.call(values, k)) {
      ...
      if (Array.isArray(values[key]) === true) {
        data[key] = values[key].map(function (value) {
          if (Array.isArray(value) === true || isPlainObject["default"](value)) {
            return prepareDataForValidation(value);
          } else {
            return value !== '' ? value : undefined;
          }
        });
      } else if (isPlainObject["default"](values[key])) {
...
function arrayMerge(target, source, options) {
  ...
  source.forEach(function merge(e, i) {
    if (typeof destination[i] === 'undefined') {
      ...
      destination[i] = shouldClone ? es["default"](Array.isArray(e) ? [] : {}, e, options) : e;
    } else if (options.isMergeableObject(e)) {
      destination[i] = es["default"](target[i], e, options);
...
var FieldArrayInner = /*#__PURE__*/function (_React$Component) {
  ...
  function FieldArrayInner(props) {
    ...
    _this.push = function (value) {
      return _this.updateArrayField(function (arrayLike) {
        return [].concat(copyArrayLike(arrayLike), [cloneDeep["default"](value)]);
      }, false, false);
    };
  ...
  _proto.componentDidUpdate = function componentDidUpdate(prevProps) {
    if (this.props.validateOnChange && this.props.formik.validateOnChange && !isEqual__default["default"](getIn(prevProps.formik.values, prevProps.name), getIn(this.props.formik.values, this.props.name))) {
