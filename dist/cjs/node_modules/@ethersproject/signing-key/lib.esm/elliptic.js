...
function BaseCurve(type, conf) {
  this.type = type;
  this.p = new BN__default["default"](conf.p, 16);

  // Use Montgomery, when there is no fast reduction for the prime
  this.red = conf.prime ? BN__default["default"].red(conf.prime) : BN__default["default"].mont(this.p);

  // Useful for many curves
  this.zero = new BN__default["default"](0).toRed(this.red);
  this.one = new BN__default["default"](1).toRed(this.red);
  this.two = new BN__default["default"](2).toRed(this.red);
...
ShortCurve.prototype._getEndoBasis = function _getEndoBasis(lambda) {
  ...
  var y2 = new BN__default["default"](1);
...
KeyPair.prototype._importPrivate = function _importPrivate(key, enc) {
  this.priv = new BN__default["default"](key, enc || 16);
...
EC.prototype.sign = function sign(msg, key, enc, options) {
  ...
  for (var iter = 0; ; iter++) {
    var k = options.k ?
      options.k(iter) :
      new BN__default["default"](drbg.generate(this.n.byteLength()));
