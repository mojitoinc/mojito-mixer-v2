...
const Stepper = ({ currentState }) => {
    ...
    return (React__default.createElement(Box, { sx: {
        ...
        return (React__default.createElement(Box, { display: "flex", flexDirection: "row", alignItems: "center", key: item.value },
            React__default.createElement(Typography, { fontWeight: "700", fontSize: "12px", color: item.value === currentState
            ...
            index !== steps.length - 1 && (React__default.createElement("img", { src: Icons.rightArrow, width: "14px", height: "14px", style: {
                    margin: '0px 10px',
