...
const LinedText = ({ text, capitalize = true }) => {
    ...
    return (React__default.createElement(Box, { sx: {
        ...
        React__default.createElement(Typography, { color: (_b = theme === null || theme === void 0 ? void 0 : theme.global) === null || _b === void 0 ? void 0 : _b.unHighlightedText, fontWeight: "700", fontSize: "12px", margin: "0px 10px", minWidth: `${text.length * 8}px`, textAlign: "center" }, capitalize ? text.toUpperCase() : text),
        React__default.createElement(Box, { sx: {
                width: '100%',
