...
`;
const completeOnChainPaymentQuery = gql `
...
export { addressScreeningQuery, completeOnChainPaymentQuery, createPaymentMethodQuery, createPaymentQuery, getPaymentMethodStatus };
