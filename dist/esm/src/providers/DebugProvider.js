...
const useDebug = (tag) => {
    ...
    return useMemo(() => ({ debug: state.debug, success: handleSuccess, info: handleInfo, error: handleError, warn: handleWarn }), [state, handleSuccess, handleInfo, handleError, handleWarn]);
};
