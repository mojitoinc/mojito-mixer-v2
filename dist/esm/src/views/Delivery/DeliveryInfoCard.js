...
const DeliveryInfoCard = ({ billingInfo, paymentInfo, }) => {
    ...
    return (React__default.createElement(Card, { sx: {
        ...
        React__default.createElement(Box, { sx: { padding: '16px 24px' }, display: "flex", flexDirection: "row", alignItems: "flex-start" },
            React__default.createElement(Box, { width: "50%", display: "flex" },
                React__default.createElement(Typography, { variant: "body2", sx: { color: (_d = theme.global) === null || _d === void 0 ? void 0 : _d.cardGrayedText, width: '135px', marginRight: '32px' } }, "Contact info"),
        ...
        React__default.createElement(Box, { sx: { padding: '16px 24px' }, display: "flex", flexDirection: "row", justifyContent: "space-between", alignItems: "flex-start" },
            React__default.createElement(Box, { width: "50%", display: "flex" },
                React__default.createElement(Typography, { variant: "body2", sx: { color: (_e = theme.global) === null || _e === void 0 ? void 0 : _e.cardGrayedText, width: '135px' } }, "Billing info"),
        ...
        React__default.createElement(Box, { sx: { padding: '16px 24px' }, display: "flex", flexDirection: "row", justifyContent: "space-between", alignItems: "flex-start" },
            React__default.createElement(Box, { width: "50%", display: "flex" },
                React__default.createElement(Typography, { variant: "body2", sx: { color: (_g = theme.global) === null || _g === void 0 ? void 0 : _g.cardGrayedText, marginRight: 3 } }, "Payment Method"),
                (paymentInfo === null || paymentInfo === void 0 ? void 0 : paymentInfo.paymentType) === PaymentTypes.WIRE_TRANSFER && (React__default.createElement(Box, null,
                    React__default.createElement(Typography, { variant: "body2" }, "Wire Transfer"),
                    React__default.createElement(Stack, { flexDirection: "row", alignItems: "center" },
                        ...
                        React__default.createElement(CopyButton, { copyValue: (_p = (_o = paymentInfo === null || paymentInfo === void 0 ? void 0 : paymentInfo.wireData) === null || _o === void 0 ? void 0 : _o.accountNumber) !== null && _p !== void 0 ? _p : '' })))),
                (paymentInfo === null || paymentInfo === void 0 ? void 0 : paymentInfo.paymentType) === PaymentTypes.CREDIT_CARD && (React__default.createElement(Box, null,
                    ...
                    React__default.createElement(Stack, { flexDirection: "row" },
                        React__default.createElement("img", { src: getCreditCardType((_s = (_r = (_q = paymentInfo === null || paymentInfo === void 0 ? void 0 : paymentInfo.creditCardData) === null || _q === void 0 ? void 0 : _q.cardData) === null || _r === void 0 ? void 0 : _r.network) !== null && _s !== void 0 ? _s : ''), width: 40, height: 24, alt: "credit card" }),
