...
const CreditCardForm = ({ creditCardList, values, setFieldValue, errors, screeningError, }) => {
    ...
    const formatExpiry = useCallback((value) => __awaiter(void 0, void 0, void 0, function* () {
        var _f;
    ...
    const formatCVV = useCallback((value) => __awaiter(void 0, void 0, void 0, function* () {
        const isValid = value.match(/^[\d\s]+$/);
        if (isValid || value === '') {
    ...
    return (React__default.createElement(React__default.Fragment, null,
        screeningError && (React__default.createElement(Box, { display: "flex", flexDirection: "row", alignItems: "center", marginTop: "16px", sx: {
            ...
            React__default.createElement(Typography, { fontWeight: "400", fontSize: "16px" }, screeningError))),
        React__default.createElement(CreditCardDropdown, { value: (values === null || values === void 0 ? void 0 : values.isNew) ? 'true' : values === null || values === void 0 ? void 0 : values.cardId, onChange: handleCardChange, error: errors === null || errors === void 0 ? void 0 : errors.cardId, title: "Card info", sx: { marginRight: '8px', marginTop: 2 }, options: creditCardList }),
        ...
        React__default.createElement(Box, { display: "flex", justifyContent: "space-between" },
            React__default.createElement(TextInput, { value: values === null || values === void 0 ? void 0 : values.expiry, onChange: formatExpiry, error: errors === null || errors === void 0 ? void 0 : errors.expiry, sx: {
                    marginTop: '16px',
                    width: '48%',
                }, inputProps: {
                    maxLength: 5,
                }, type: "text", placeholder: "MM/YY" }),
            React__default.createElement(TextInput, { value: values === null || values === void 0 ? void 0 : values.cvv, onChange: formatCVV, error: errors === null || errors === void 0 ? void 0 : errors.cvv, inputProps: {
                    maxLength: 3,
                }, type: "text", sx: {
                    marginTop: '16px',
                    width: '48%',
        ...
        React__default.createElement(Box, { display: "flex", flexDirection: "row", alignItems: "center", justifyContent: "center", margin: "20px 0px" },
            ...
            React__default.createElement("a", { href: "https://www.circle.com/en/", target: "_blank", rel: "noreferrer" },
                React__default.createElement("img", { src: Icons.circle, alt: "circle", style: {
                        width: 100,
                        height: 20,
                        marginLeft: '8px',
                    } })))));
