...
const CreditCardForm = ({ creditCardList, values, setFieldValue, errors, handleChange, }) => {
    ...
    return (React__default.createElement(React__default.Fragment, null,
        ...
        (values === null || values === void 0 ? void 0 : values.isNew) && (React__default.createElement(Box, { display: "flex", justifyContent: "space-between" },
            ...
            React__default.createElement(TextInput, { value: values === null || values === void 0 ? void 0 : values.lastName, onChange: handleChange('lastName'), error: errors === null || errors === void 0 ? void 0 : errors.lastName, title: "Last name", sx: {
                    marginTop: '16px',
                    width: '48%',
        ...
        React__default.createElement(Box, { display: "flex", justifyContent: "space-between" },
            ...
            React__default.createElement(TextInput, { value: values === null || values === void 0 ? void 0 : values.cvv, onChange: handleChange('cvv'), error: errors === null || errors === void 0 ? void 0 : errors.cvv, inputProps: {
                    maxLength: 3,
                }, type: "number", sx: {
                    marginTop: '16px',
                    width: '48%',
