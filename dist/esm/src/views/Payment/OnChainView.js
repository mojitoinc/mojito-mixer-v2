...
const OnChainView = ({ values, setFieldValue, errors }) => {
    ...
    return (React__default.createElement(React__default.Fragment, null, !(values === null || values === void 0 ? void 0 : values.walletAddress) ? (React__default.createElement(Box, { display: "flex", flexDirection: "column" },
        React__default.createElement(Button, { backgroundColor: (_a = theme.global) === null || _a === void 0 ? void 0 : _a.black, onClick: onClickMetaMask, sx: {
                width: { xs: '100%', md: '180px' },
                margin: '16px 0px',
                border: `1px solid ${(_b = theme.global) === null || _b === void 0 ? void 0 : _b.black}`,
                alignSelf: 'center',
            }, title: "Walletconnect" },
            React__default.createElement("img", { src: Icons.walletConnect, alt: "wallet connect", style: {
                    width: '20px',
                    height: '20px',
                    marginRight: '8px',
                } })),
        (errors === null || errors === void 0 ? void 0 : errors.walletAddress) &&
            React__default.createElement(FormHelperText, { error: true }, errors === null || errors === void 0 ? void 0 : errors.walletAddress))) : (React__default.createElement(React__default.Fragment, null,
        React__default.createElement(Box, { display: "flex", flexDirection: "row", alignItems: "center", justifyContent: "space-between", border: `1px solid ${(_c = theme.global) === null || _c === void 0 ? void 0 : _c.cardBorder}`, padding: "16px", sx: {
            ...
            React__default.createElement(Box, { display: "flex", flexDirection: "row", alignItems: "center" },
                ...
                React__default.createElement(CopyButton, { copyValue: values === null || values === void 0 ? void 0 : values.walletAddress, sx: {
                        alignSelf: 'center',
                    } })),
            React__default.createElement(Button, { title: "Change", textColor: (_e = theme.global) === null || _e === void 0 ? void 0 : _e.highlightedText, backgroundColor: (_f = theme.global) === null || _f === void 0 ? void 0 : _f.white, variant: "outlined", sx: {
                    justifySelf: 'flex-end',
                }, onClick: onClickMetaMask })),
        React__default.createElement(Typography, { fontSize: 16 }, "NFT will be delivered to same address")))));
};

export { OnChainView as default };
