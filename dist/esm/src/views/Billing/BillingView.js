...
const schema = create().shape({
    ...
    postalCode: create$1().min(5, 'Invalid zipcode').required('Please enter zipcode'),
    email: create$1()
        .email('Please enter valid email')
        .required('Please enter email'),
    phoneNumber: create$1().required('Please enter a mobile number'),
    street1: create$1().required('Please enter your address'),
    firstName: create$1().min(2, 'Invalid first name').required('Please enter first name'),
...
const BillingView = ({ isEditing, onClickEdit, onClickContinue, pincodeError, billingInfo, paymentItem, onChangeValues, }) => {
    ...
    return (React__default.createElement(Box, { width: "100%" },
        !((_0 = uiConfiguration === null || uiConfiguration === void 0 ? void 0 : uiConfiguration.billing) === null || _0 === void 0 ? void 0 : _0.isEnableExpressCheckout) && (React__default.createElement(ExpressCheckoutView, { config: uiConfiguration === null || uiConfiguration === void 0 ? void 0 : uiConfiguration.billing })),
        React__default.createElement(Card, { sx: {
            ...
            React__default.createElement(Typography, { color: (_5 = (_4 = theme.palette) === null || _4 === void 0 ? void 0 : _4.text) === null || _5 === void 0 ? void 0 : _5.primary, fontWeight: "500", fontSize: "20px" }, "Contact info"),
        ...
        React__default.createElement(Box, { display: "flex", justifyContent: "flex-end" },
            React__default.createElement(Button, { title: "Continue to Payment", backgroundColor: (_7 = (_6 = theme.global) === null || _6 === void 0 ? void 0 : _6.checkout) === null || _7 === void 0 ? void 0 : _7.continueButtonBackground, textColor: (_9 = (_8 = theme.global) === null || _8 === void 0 ? void 0 : _8.checkout) === null || _9 === void 0 ? void 0 : _9.continueButtonTextColor, onClick: handleSubmit, sx: {
                    margin: '24px 0px',
                    '&: hover': {
