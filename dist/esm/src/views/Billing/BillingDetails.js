...
const BillingDetails = ({ values, onClickEdit }) => {
    ...
    return (React__default.createElement(Card, { sx: {
        ...
        React__default.createElement(Box, { padding: "14px", display: "flex", flexDirection: "row", justifyContent: "space-between", alignItems: "center" },
            ...
            React__default.createElement(Box, { padding: "5px", sx: {
                ...
                React__default.createElement(Typography, { color: (_h = theme.global) === null || _h === void 0 ? void 0 : _h.linksText, fontWeight: "700" }, "Edit")))));
};

export { BillingDetails as default };
