...
import { getSliderUtilityClass } from './sliderUnstyledClasses.js';
import SliderValueLabelUnstyled from './SliderValueLabelUnstyled.js';
...
const SliderUnstyled = /*#__PURE__*/React.forwardRef(function SliderUnstyled(props, ref) {
  ...
  return /*#__PURE__*/jsxs(Root, _extends({}, rootProps, {
    children: [/*#__PURE__*/jsx(Rail, _extends({}, railProps)), /*#__PURE__*/jsx(Track, _extends({}, trackProps)), marks.filter(mark => mark.value >= min && mark.value <= max).map((mark, index) => {
...
export { SliderUnstyled as default };
